...
(function() {
  ...
  grammar = {
    ...
    Array: [
      ...
      o('[ ArgElisionList OptComma ]',
      function() {
        return new Arr($2);
      }),
      o('[ ArgElisionList , Elisions ]',
      function() {
    ...
    ArgElisionList: [
      ...
      o('ArgElisionList TERMINATOR Arg',
      function() {
        return $1.concat($3);
      }),
      o('ArgElisionList , TERMINATOR ArgElision',
      function() {
        return $1.concat($4);
      }),
      o('INDENT ArgElisionList OptComma OUTDENT',
      function() {
        return $2;
      }),
      o('INDENT ArgElisionList , Elisions OUTDENT',
      function() {
        return $2.concat($4);
      }),
      o('ArgElisionList OptComma INDENT ArgElisionList OptComma OUTDENT',
      function() {
        return $1.concat($4);
      }),
      o('ArgElisionList , Elisions INDENT ArgElisionList OptComma OUTDENT',
      function() {
        return $1.concat($3,
      $5);
      }),
      o('ArgElisionList OptComma INDENT ArgElisionList , Elisions OUTDENT',
      function() {
        return $1.concat($4,
      $6);
      })

...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield'), o('Comment')],
    Yield: [
      o('YIELD', function() {
    ...
    Array: [
      o('[ ElementList OptComma ]', function() {
        return new Arr($2);
      })
    ],
    RangeDots: [
    ...
    ElementList: [
      o('', function() {
        ...
        return [$1];
      }), o('ElementList , Arg', function() {
        return $1.concat($3);
      }), o('ElementList OptComma TERMINATOR Arg', function() {
        return $1.concat($4);
      }), o('ElementList OptComma INDENT ElementList OptComma OUTDENT', function() {
        return $1.concat($4);
      })
    ],
    ArgList: [

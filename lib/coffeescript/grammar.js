...
(function() {
  ...
  grammar = {
    ...
    Operation: [
      ...
      o('Expression LEADING_&& Expression',
      function() {
        return new Op($2.toString(),
      $1,
      $3,

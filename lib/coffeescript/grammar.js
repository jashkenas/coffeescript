  ...
  grammar = {
    ...
    AssignObj: [
      o('ObjAssignable', function() {
        return new Value($1);
      }), o('ObjDestructAssignable', function() {
        return new Splat($1);
    ...
    SimpleObjAssignable: [o('Identifier'), o('Property'), o('ThisProperty'), o('ObjDestructIdentifier')],
    ...
    ObjDestructAssignable: [
      o('Object ...', function() {
        ...
        return new Value($1);
      }), o('Parenthetical Arguments', function() {
        return new Call($1, $2, false);
      }), o('Parenthetical Arguments ...', function() {
        return new Call($1, $2, false);

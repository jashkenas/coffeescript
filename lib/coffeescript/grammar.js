...
(function() {
  ...
  grammar = {
    ...
    Expression: [
      ...
      o('Throw'),
      o('Yield'),
      o('SubStructAssignable',
      function() {
        return new Value(new SubStructAssign($1));
      })
    ],
    ...
    Assign: [
      o('Assignable AssignValue',
      function() {
        return new Assign($1,
      $2);
      }),
      o('SubStructAssignable AssignValue',
      function() {
        return new Assign($1[0],
      new SubStructAssign([$2,
      $1[1]],
      $1[0],
      true));
      })
    ...
    AssignValue: [
      ...
      o('= TERMINATOR Expression',
      function() {
        return $3;
      }),
      o('= INDENT Expression OUTDENT',
      function() {
        return $3;
      })
    ],

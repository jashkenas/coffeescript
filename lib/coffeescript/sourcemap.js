...
(function() {
  ...
  var LineMap, SourceMap, getSourceMap, registerCompiled, sourceMaps;
  ...
  registerCompiled = function(filename, source, sourcemap) {
    console.log(`registerCompiled ${filename} ${!!sourcemap}`);
    if (sourcemap != null) {
      return sourceMaps[filename] = sourcemap;
    }
  };
  ...
  module.exports = Object.assign(SourceMap, {getSourceMap, registerCompiled});

...
(function() {
  ...
  outputPath = function(source, base, extension) {
    ...
    if (extension == null) {
      extension = helpers.isESModule(source) ? '.mjs' : '.js';
    }

...
// (such as 'colors' and 'sugar') work as expected.
  ...
  findDirectoryIndex = function(source) {
    ...
    return process.exit(1);// Compile a single source script, containing the given code, according to the
  ...
  compileScript = function(file, input, base = null) {
    ...
    try {
      ...
      if (o.watch) {
        ...
        printWarn(message);
        return process.exit(1);// Attach the appropriate listeners to compile scripts incoming over **stdin**,

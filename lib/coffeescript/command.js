...
(function() {
  ...
  compileOptions = function(filename, base) {
    var answer, babel, babelOptions, checkPath, cwd, exception, jsDir, jsPath, ref;
    if (opts.transpile && ((ref = opts.transpile) !== false && ref !== 0 && ref !== 'false' && ref !== 'off' && ref !== 'no' && ref !== '0')) {
      try {
      ...
      if (typeof opts.transpile === 'object') {
        ...
        if (typeof opts.transpile === 'string') {
          try {
          ...
          if (opts.transpile.babel) {
            opts.transpile = opts.transpile.babel;
          }
        } else {
      ...
      if (opts.transpile.sourceMaps == null) {
        if (opts.map && opts['inline-map']) {
          opts.transpile.sourceMaps = 'both';
        } else if (opts.map) {
          opts.transpile.sourceMaps = true;

...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    lineToken(chunk = this.chunk) {
      var backslash, diff, indent, match, minLiteralLength, newIndentLiteral, noIndents, noNewlines, prev, size;
      ...
      noIndents = this.shouldSuppressIndents();
    ...
    shouldSuppressIndents() {
      return INDENT_SUPPRESSOR.test(this.chunk);
    }

...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    regexToken() {
      var body, closed, comment, commentTokens, comments, delimiter, end, flags, index, match, origin, prev, ref, ref1, regex, tokens;
      switch (false) {
          ...
          if (comments) {
            commentTokens = flatten((function() {
              ...
              for (j = 0, len = comments.length; j < len; j++) {
                comment = comments[j];
                results.push(this.commentToken(comment, {
                  heregex: true,

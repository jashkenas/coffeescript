...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    jsxToken() {
      var afterTag, end, endToken, firstChar, fullId, fullTagName, i, id, input, jsxTag, len, match, offset, openingTagToken, prev, prevChar, properties, property, ref, tagToken, token, tokens;

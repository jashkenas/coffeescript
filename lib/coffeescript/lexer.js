...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken() {
      var chunk, comment, commentAttachments, content, contents, here, i, j, len, match, matchIllegal, newLine, placeholderToken, prev;
    ...
    suppressNewlines() {
      ...
      if (prev[1] === '\\') {
        if (prev.comments) {
          ...
          attachCommentsToNode(this.tokens[this.tokens.length - 2], prev.comments);
        }
        this.tokens.pop();
      }
      return this;

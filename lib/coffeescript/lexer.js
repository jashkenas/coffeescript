...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    csxToken() {
      var afterTag, colon, csxTag, end, firstChar, id, input, match, origin, token, tokens;

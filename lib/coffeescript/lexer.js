...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    lineToken({chunk = this.chunk, offset = 0} = {}) {
      var backslash, diff, endsContinuationLineIndentation, indent, match, minLiteralLength, newIndentLiteral, noIndents, noNewlines, prev, ref, size;

...
(function() {
  ...
  ({count, starts, compact, repeat, invertLiterate, merge, attachCommentsToNode, locationDataToString, throwSyntaxError, dump, makeDelimitedLiteral, normalizeStringObject} = require('./helpers'));
  ...
  exports.Lexer = Lexer = (function() {
    class Lexer {
      ...
      identifierToken() {
        var alias, colon, colonOffset, colonToken, id, idLength, inCSXTag, input, match, normalized, poppedToken, prev, prevprev, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, regExSuper, regex, sup, tag, tagToken;
        ...
        if (!(tag === 'PROPERTY' || this.exportSpecifierList)) {
          ...
          tag = (function() {
            switch ((normalized = normalizeStringObject(id))) {
              case '!':
                return 'UNARY';
              case '==':
              case '!=':
      ...
      stringToken() {
        ...
        this.mergeInterpolationTokens(tokens, {delimiter, quote, indent}, (value, i) => {
      ...
      literalToken() {
        ...
        if (prev && indexOf.call(['=', ...COMPOUND_ASSIGN], value) >= 0) {
          skipToken = false;
          if (value === '=' && ((ref = normalizeStringObject(prev[1])) === '||' || ref === '&&') && !prev.spaced) {
      ...
      mergeInterpolationTokens(tokens, options, fn) {
        var $, converted, double, firstEmptyStringIndex, firstIndex, i, indent, j, k, lastToken, len, len1, locationToken, lparen, placeholderToken, plusToken, quote, rparen, tag, token, tokensToPush, val, value;
      ...
      token(tag, value, {offset, length, origin, data} = {}) {
        var token;
        token = this.makeToken(tag, value, {offset, length});
        if (origin) {
          token.origin = origin;
        }
        if (data) {
      ...
      value(useOrigin = false) {
        var ref, token, useToken;
        ref = this.tokens, [token] = slice.call(ref, -1);
        useToken = useOrigin && ((token != null ? token.origin : void 0) != null) ? token.origin : token;
        ...
        // to eg ';'
        if ((useToken != null ? useToken[0] : void 0) === 'STRING') {
          return useToken[1];
        } else {
          return normalizeStringObject(useToken != null ? useToken[1] : void 0);
        }
      }
    ...
    Lexer.prototype.makeDelimitedLiteral = makeDelimitedLiteral;

...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    csxToken() {
      var afterTag, colon, csxStart, csxTag, end, firstChar, id, input, match, origin, prev, prevChar, ref, token, tokens;

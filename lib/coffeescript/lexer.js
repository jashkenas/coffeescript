...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    identifierToken() {
      var alias, colon, colonOffset, colonToken, id, idLength, inJSXTag, input, match, poppedToken, prev, prevprev, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, regExSuper, regex, sup, tag, tagToken, tokenData;
      ...
      idLength = id.length;
      poppedToken = void 0;
      if (id === 'own' && ((ref = this.tag()) === 'FOR' || ref === 'FORITER')) {
        this.token('OWN', id);
        return id.length;
      }
      ...
      if (id === 'as' && this.seenImport) {
        ...
        } else if (ref1 = this.value(true), indexOf.call(COFFEE_KEYWORDS, ref1) >= 0) {
          prev = this.prev();
      ...
      if (id === 'as' && this.seenExport) {
        if ((ref3 = this.tag()) === 'IDENTIFIER' || ref3 === 'DEFAULT') {
          this.token('AS', id);
          return id.length;
        }
        if (ref4 = this.value(true), indexOf.call(COFFEE_KEYWORDS, ref4) >= 0) {
          prev = this.prev();
          [prev[0], prev[1]] = ['IDENTIFIER', this.value(true)];
          this.token('AS', id);
          return id.length;
      ...
      if (tag === 'IDENTIFIER' && (indexOf.call(JS_KEYWORDS, id) >= 0 || indexOf.call(COFFEE_KEYWORDS, id) >= 0) && !(this.exportSpecifierList && indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
        ...
        if (tag === 'WHEN' && (ref7 = this.tag(), indexOf.call(LINE_BREAK, ref7) >= 0)) {
          ...
          if (tag !== 'INSTANCEOF' && this.seenFor) {
            ...
            if (this.value() === '!') {
              ...
              tokenData.invert = (ref8 = (ref9 = poppedToken.data) != null ? ref9.original : void 0) != null ? ref8 : poppedToken[1];
            }
          }
        }
        ...
        tag = 'FORFROM';
        this.seenFor = false;
      } else if (tag === 'IDENTIFIER' && this.seenFor && id === 'each' && this.tag() === 'FOR') {
        tag = 'FORITER';
      // Throw an error on attempts to use `get` or `set` as keywords, or
      // what CoffeeScript would normally interpret as calls to functions named
      // `get` or `set`, i.e. `get({foo: function () {}})`.
      } else if (tag === 'PROPERTY' && prev) {
        if (prev.spaced && (ref10 = prev[0], indexOf.call(CALLABLE, ref10) >= 0) && /^[gs]et$/.test(prev[1]) && this.tokens.length > 1 && ((ref11 = this.tokens[this.tokens.length - 2][0]) !== '.' && ref11 !== '?.' && ref11 !== '@')) {
          ...
          if (((ref12 = prev[0]) === '@' || ref12 === 'THIS') && prevprev && prevprev.spaced && /^[gs]et$/.test(prevprev[1]) && ((ref13 = this.tokens[this.tokens.length - 3][0]) !== '.' && ref13 !== '?.' && ref13 !== '@')) {

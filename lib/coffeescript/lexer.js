...
(function() {
  ...
  ({count, starts, compact, repeat, invertLiterate, merge, attachCommentsToNode, locationDataToString, throwSyntaxError, makeDelimitedLiteral, replaceUnicodeCodePointEscapes} = require('./helpers'));
  ...
  exports.Lexer = Lexer = (function() {
    class Lexer {
      ...
      stringToken() {
        ...
        this.mergeInterpolationTokens(tokens, {delimiter, quote, indent}, (value) => {
      ...
      formatRegex(str, options) {
        return this.validateUnicodeCodePointEscapes(str, options);
      }

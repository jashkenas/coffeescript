...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    regexToken() {
      var body, closed, comment, comments, delimiter, end, flags, index, j, len, match, origin, prev, ref, ref1, regex, tokens;
      switch (false) {
    ...
    mergeInterpolationTokens(tokens, options, fn) {
      var $, converted, double, firstEmptyStringIndex, firstIndex, heregex, i, indent, j, k, lastToken, len, len1, locationToken, lparen, placeholderToken, plusToken, quote, rparen, tag, token, tokensToPush, val, value;

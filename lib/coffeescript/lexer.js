...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    csxToken() {
      ...
      if (firstChar === '<') {
        if (!((match = CSX_IDENTIFIER.exec(this.chunk.slice(1))) && (this.includesCSX || !(prev = this.prev()) || prev.spaced || (ref = prev[0], indexOf.call(COMPARABLE, ref) < 0)))) {
          return 0;
        }
        [input, id, colon] = match;

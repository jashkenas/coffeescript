...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk) {
      var comment, commentAttachments, content, contents, here, here2, i, match, matchIllegal, newLine, placeholderToken, prev;

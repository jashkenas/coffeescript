...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    regexToken() {
      var body, closed, comment, commentIndex, commentTokens, comments, delimiter, end, flags, fullMatch, index, leadingWhitespace, match, matchedComment, opts, origin, prev, ref, ref1, regex, tokens;
      switch (false) {
        ...
        case !(match = this.matchWithInterpolations(HEREGEX, '///')):
          ...
          commentTokens = flatten((function() {
            ...
            for (j = 0, len = comments.length; j < len; j++) {
              ({comment, ...opts} = comments[j]);
              results.push(this.commentToken(comment, Object.assign(opts, {
                heregex: true,

...
(function() {
  ...
  CoffeeScript.eval = function(code, options = {}) {
    var Module, _module, _require, createContext, i, isContext, js, k, len, o, r, ref, ref1, ref2, ref3, sandbox, streaming, v;
    if (!(code = code.trim())) {
      return;
    }
    ...
    if (sandbox === global) {
      if (streaming) {
        global.line = options['current-line'];
      }
      return vm.runInThisContext(js);
    } else {
      if (streaming) {
        sandbox.line = options['current-line'];
      }

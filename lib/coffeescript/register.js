...
(function() {
  var CoffeeScript, Module, binary, cacheSourceMaps, child_process, ext, findExtension, fork, formatSourcePosition, getRootModule, getSourceMap, helpers, i, len, loadFile, nodeSourceMapsSupportEnabled, path, ref, registerCompiled;
  ...
  nodeSourceMapsSupportEnabled = typeof process !== "undefined" && process !== null ? process.execArgv.includes('--enable-source-maps') : void 0;
...
${sourceMap}
${line}:${column} -> ${(answer != null ? answer[0] : void 0) + 1}:${(answer != null ? answer[1] : void 0) + 1}`);
        if (answer != null) {

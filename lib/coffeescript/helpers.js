...
(function() {
  ...
  exports.baseFileName = function(file, stripExt = false, useWinPathSep = false) {
    ...
    parts = file.split('.');
    parts.pop();
    if (parts.length > 1 && ((ref1 = parts[parts.length - 1]) === 'coffee' || ref1 === 'mcoffee')) {
      parts.pop();
    }
    return parts.join('.');
  };
  ...
  exports.isCoffee = function(file) {
    return /\.((lit)?m?coffee|m?coffee\.md)$/.test(file);
  };

  // Determine if a filename represents a Literate CoffeeScript file.
  exports.isLiterate = function(file) {
    return /\.(litcoffee|litmcoffee|coffee\.md)$/.test(file);
  };

  // Determine if a filename represents a CoffeeScript file compiling to an ES module.
  exports.isESModule = function(file) {
    return /\.((lit)?mcoffee|mcoffee\.md)$/.test(file);
  };

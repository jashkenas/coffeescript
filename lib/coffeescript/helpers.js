...
(function() {
  ...
  exports.invertLiterate = function(code) {
    var blankLine, i, indented, insideComment, len, line, listItemStart, out, ref1;
    out = [];
    blankLine = /^\s*$/;
    indented = /^[\t ]/;
  ...
  exports.extractAllCommentTokens = function(tokens) {
    var allCommentsObj, comment, commentKey, i, j, k, key, len, len1, len2, ref1, results, sortedKeys, token;
    allCommentsObj = {};
    ...
    results = [];
    for (k = 0, len2 = sortedKeys.length; k < len2; k++) {
      key = sortedKeys[k];
  ...
  exports.buildTokenDataDictionary = buildTokenDataDictionary = function(tokens) {
    var base, i, len, token, tokenData, tokenHash;
    tokenData = {};
    for (i = 0, len = tokens.length; i < len; i++) {
      token = tokens[i];
      if (!token.comments) {

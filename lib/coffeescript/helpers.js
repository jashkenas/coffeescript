...
(function() {
  ...
  exports.extractAllCommentTokens = function(tokens) {
    var allCommentsObj, comment, commentKey, i, j, k, key, len1, len2, len3, ref1, ref2, ref3, ref4, ref5, results, sortedKeys, token;
    allCommentsObj = {};
    for (i = 0, len1 = tokens.length; i < len1; i++) {
      token = tokens[i];
      if (token.comments || ((ref1 = token.prevToken) != null ? ref1.comments : void 0)) {
        ref5 = [...((ref2 = (ref3 = token.prevToken) != null ? ref3.comments : void 0) != null ? ref2 : []), ...((ref4 = token.comments) != null ? ref4 : [])];
        for (j = 0, len2 = ref5.length; j < len2; j++) {
          comment = ref5[j];

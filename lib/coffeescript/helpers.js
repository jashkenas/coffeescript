...
(function() {
  ...
  var attachCommentsToNode, buildLocationData, extend, flatten, ref, repeat, syntaxErrorToString;
  ...
  exports.attachCommentsToNode = attachCommentsToNode = function(node, comments) {
    if ((comments != null ? comments.length : void 0) === 0) {
      return;
    }
    return node.comments = node.comments ? node.comments.concat(comments) : comments;
  };

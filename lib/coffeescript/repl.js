...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, getCommandId, greeting, hint, merge, nodeREPL, path, process, replDefaults, runInContext, sawSIGINT, transpile, updateSyntaxError, vm;

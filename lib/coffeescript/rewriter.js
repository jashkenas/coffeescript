      ...
      rescueStowawayComments() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          ...
          if (ref = token[0], indexOf.call(DISCARDED, ref) >= 0) {
            ...
            while (j !== -1) {
              if (token.comments[j].newLine && ((token.comments[j].unshift === true && i !== tokens.length - 1 && (ref1 = tokens[i + 1][0], indexOf.call(LINEBREAKS, ref1) < 0)) || (token.comments[j].unshift !== true && i !== 0 && (ref2 = tokens[i - 1][0], indexOf.call(LINEBREAKS, ref2) < 0)))) {

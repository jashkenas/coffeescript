        ...
        return this.scanTokens(function(token, i, tokens) {
          ...
          if (tag === ':') {
            ...
            if (stackTop()) {
              ...
              if ((stackTag === '{' || stackTag === 'INDENT' && ((ref4 = stackTop2()) != null ? ref4[0] : void 0) === '{' && !isImplicit(stackTop2()) && this.findTagsBackwards(stackIdx - 1, ['{'])) && (startsLine || this.tag(s - 1) === ',' || this.tag(s - 1) === '{') && (ref5 = this.tag(s - 1), indexOf.call(UNFINISHED, ref5) < 0)) {
                return forward(1);
              }
            }
          ...
          if (tag === ',' && !this.looksObjectish(i + 1) && inImplicitObject() && !((ref6 = this.tag(i + 2)) === 'FOROF' || ref6 === 'FORIN') && (nextTag !== 'TERMINATOR' || !this.looksObjectish(i + 2))) {

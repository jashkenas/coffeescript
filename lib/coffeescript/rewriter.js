  ...
  exports.Rewriter = Rewriter = (function() {
    class Rewriter {
      ...
      addLocationDataToGeneratedTokens() {
        return this.scanTokens(function(token, i, tokens) {
          var column, line, nextLocation, prevLocation, range, ref, ref1;
          if (token[2]) {
            return 1;
          }
      ...
      exposeTokenDataToGrammar() {
        return this.scanTokens(function(token, i) {
          ...
          if (token.data && Object.keys(token.data).length || ((ref = token[0]) === 'JS' || ref === 'CALL_START') && token.generated) {
            token[1] = new String(token[1]);
            ref2 = (ref1 = token.data) != null ? ref1 : {};
            for (key in ref2) {

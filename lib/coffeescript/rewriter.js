    ...
    class Rewriter {
      ...
      fixIndentationLocationData() {
        ...
        findPrecedingComment = (token, {afterPosition, indentSize}) => {
          var comment, k, matches, ref, tokenStart;
        ...
        return this.scanTokens(function(token, i, tokens) {
          var precedingComment, prevLocationData, prevToken, ref;
          ...
          token[2] = {
            ...
            first_column: precedingComment != null ? prevLocationData.first_column : prevLocationData.last_column,

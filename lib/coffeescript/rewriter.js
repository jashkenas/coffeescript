    ...
    class Rewriter {
      ...
      addImplicitBracesAndParens() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          var endImplicitCall, endImplicitObject, forward, inImplicit, inImplicitCall, inImplicitControl, inImplicitObject, newLine, nextTag, offset, prevTag, prevToken, ref, ref1, ref2, ref3, ref4, s, sameLine, stackIdx, stackTag, stackTop, startIdx, startImplicitCall, startImplicitObject, startsLine, tag;
          [tag] = token;
          ...
          if (indexOf.call(IMPLICIT_END, tag) >= 0 || indexOf.call(CALL_CLOSERS, tag) >= 0 && newLine) {
            while (inImplicit()) {
              ref3 = stackTop(), stackTag = ref3[0], stackIdx = ref3[1], (ref4 = ref3[2], sameLine = ref4.sameLine, startsLine = ref4.startsLine);

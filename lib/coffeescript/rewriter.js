  ...
  exports.Rewriter = Rewriter = (function() {
    class Rewriter {
      ...
      tagPostfixConditionals() {
        ...
        original = null;
        condition = function(token, i) {
          var nextTag, prevTag, tag;
          [tag] = token;
          [prevTag] = this.tokens[i - 1];
          if (i !== this.tokens.length - 1) {
            [nextTag] = this.tokens[i + 1];
          }
          return tag === 'TERMINATOR' && indexOf.call(LEADING_LOGICAL, nextTag) < 0 || (tag === 'INDENT' && indexOf.call(SINGLE_LINERS, prevTag) < 0);
        };
        action = function(token, i) {

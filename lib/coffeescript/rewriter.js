    ...
    class Rewriter {
        ...
        return this.scanTokens(function(token, i, tokens) {
          ...
          if (indexOf.call(IMPLICIT_END, tag) >= 0 || (indexOf.call(CALL_CLOSERS, tag) >= 0 && newLine) || ((tag === '..' || tag === '...') && this.findTagsBackwards(i, ["INDEX_START"]))) {
            while (inImplicit()) {
              ...
              } else if (inImplicitObject() && tag === 'TERMINATOR' && prevTag !== ',' && !(startsLine && (this.looksObjectish(i + 1) || this.isLeadingLogical(i)))) {
                endImplicitObject();
      ...
      tagPostfixConditionals() {
        ...
        condition = function(token, i) {
          ...
          return tag === 'TERMINATOR' && !this.isLeadingLogical(i) || (tag === 'INDENT' && indexOf.call(SINGLE_LINERS, prevTag) < 0);
        };
        action = function(token, i) {
      ...
      isLeadingLogical(i) {
        var ref;
        return this.tag(i) === 'TERMINATOR' && (ref = this.tag(i + 1), indexOf.call(LEADING_LOGICAL, ref) >= 0);
      }
      ...
      tagLeadingLogical() {
        return this.scanTokens(function(token, i, tokens) {
          var operatorToken, ref;
          if (!(token[0] === 'TERMINATOR' && tokens.length >= i + 2 && (ref = (operatorToken = tokens[i + 1])[0], indexOf.call(LEADING_LOGICAL, ref) >= 0))) {
            return 1;
          }
          ...
          this.mergeTokenData(token, operatorToken);
          tokens.splice(i + 1, 1);
          return 1;
        });
      }
      ...
      mergeTokenData(intoToken, fromToken) {
        ...
        return Object.assign((intoToken.data != null ? intoToken.data : intoToken.data = {}), fromToken.data);
      }

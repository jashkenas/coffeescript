    ...
    class Rewriter {
      ...
      addImplicitBracesAndParens() {
        ...
        return this.scanTokens(function(token, i, tokens) {
          var implicitObjectIndent, nextToken, prevToken, ref, ref1, ref2, ref3, startIndex, startTag;
          var [tag] = token;
          ...
          if (tag === ':') {
            ...
            var startsLine = s <= 0 || (ref1 = this.tag(s - 1), indexOf.call(LINEBREAKS, ref1) >= 0) || tokens[s - 1].newLine;

...
break;
case 33: case 365:
this.$ = yy.addDataToNode(yy, _$[$0-3], _$[$0], {forceUpdateLocation: true})(new yy.Op($$[$0-3],
      $$[$0-1]));
break;
case 34:
...
break;
case 40:
this.$ = yy.addDataToNode(yy, _$[$0], _$[$0], {forceUpdateLocation: true})(new yy.NumberLiteral($$[$0].toString(),
      {
...
break;
case 50:
this.$ = yy.addDataToNode(yy, _$[$0], _$[$0], {forceUpdateLocation: true})(new yy.RegexLiteral($$[$0].toString(),
      {
...
break;
case 53:
this.$ = yy.addDataToNode(yy, _$[$0], _$[$0], {forceUpdateLocation: true})(new yy.PassthroughLiteral($$[$0].toString(),
      {
          here: $$[$0].here,
...
break;
case 57:
this.$ = yy.addDataToNode(yy, _$[$0], _$[$0], {forceUpdateLocation: true})(new yy.BooleanLiteral($$[$0].toString(),
      {
...
break;
case 178:
this.$ = yy.addDataToNode(yy, _$[$0], _$[$0], {forceUpdateLocation: true})(new yy.ImportSpecifier(new yy.Literal($$[$0])));
break;
case 179:
this.$ = yy.addDataToNode(yy, _$[$0-2], _$[$0], {forceUpdateLocation: true})(new yy.ImportSpecifier(new yy.Literal($$[$0-2]),
      $$[$0]));
break;
case 180:
...
break;
case 200:
this.$ = yy.addDataToNode(yy, _$[$0], _$[$0], {forceUpdateLocation: true})(new yy.ExportSpecifier(new yy.Literal($$[$0])));
break;
case 201:
this.$ = yy.addDataToNode(yy, _$[$0-2], _$[$0], {forceUpdateLocation: true})(new yy.ExportSpecifier(new yy.Literal($$[$0-2]),
      $$[$0]));
break;
case 202:
...
break;
case 273: case 274:
this.$ = yy.addDataToNode(yy, _$[$0-1], _$[$0], {forceUpdateLocation: true})($$[$0].addBody(yy.addDataToNode(yy, _$[$0-1], null, {forceUpdateLocation: true})(yy.Block.wrap([$$[$0-1]]))));
break;
case 276:
this.$ = yy.addDataToNode(yy, _$[$0-1], _$[$0], {forceUpdateLocation: true})(new yy.While(yy.addDataToNode(yy, _$[$0-1], null, {forceUpdateLocation: true})(new yy.BooleanLiteral('true'))).addBody($$[$0]));
break;
case 277:
this.$ = yy.addDataToNode(yy, _$[$0-1], _$[$0], {forceUpdateLocation: true})(new yy.While(yy.addDataToNode(yy, _$[$0-1], null, {forceUpdateLocation: true})(new yy.BooleanLiteral('true'))).addBody(yy.addDataToNode(yy, _$[$0], null, {forceUpdateLocation: true})(yy.Block.wrap([$$[$0]]))));
break;
case 278: case 279:
this.$ = yy.addDataToNode(yy, _$[$0-1], _$[$0], {forceUpdateLocation: true})($$[$0].addBody($$[$0-1]));
break;
case 282:
...
break;
case 359:
this.$ = yy.addDataToNode(yy, _$[$0-1], _$[$0], {forceUpdateLocation: true})(new yy.Op($$[$0-1].toString(),
      $$[$0],
      void 0,
      void 0,
      {
...
this.$ = yy.addDataToNode(yy, _$[$0-2], _$[$0], {forceUpdateLocation: true})(new yy.Op($$[$0-1].toString(),
      $$[$0-2],
      $$[$0],
      void 0,
      {

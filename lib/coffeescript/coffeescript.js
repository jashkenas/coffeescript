...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, base64encode, checkShebangLine, compile, formatSourcePosition, getSourceMap, helpers, lexer, nativeSourceMaps, packageJson, parser, ref, registerCompiled, sourceMaps, sources, withPrettyErrors,
    indexOf = [].indexOf;
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    ...
    generateSourceMap = options.sourceMap || options.inlineMap || nativeSourceMaps || (options.filename == null);
    ...
    if (options.inlineMap || nativeSourceMaps) {
  ...
  nativeSourceMaps = (typeof process !== "undefined" && process !== null ? process.execArgv.includes('--enable-source-maps') : void 0) || (typeof process !== "undefined" && process !== null ? (ref = process.env.NODE_OPTIONS) != null ? ref.includes('--enable-source-maps') : void 0 : void 0);

  if (nativeSourceMaps || Error.prepareStackTrace) {

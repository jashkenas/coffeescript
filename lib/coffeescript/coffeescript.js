...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, base64encode, checkShebangLine, compile, helpers, lexer, packageJson, parser, registerCompiled, withPrettyErrors;
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    ...
    generateSourceMap = options.sourceMap || options.inlineMap || !options.filename;
    ...
    console.log(`COMPILE: ${filename} ${generateSourceMap}`);

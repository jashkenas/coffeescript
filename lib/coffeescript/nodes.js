...
(function() {
        ...
        for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
          ...
          if (node instanceof Block) {
            ...
            if (!node.isStatement(o)) {
              ...
              [lastFragment] = slice.call(fragments, -1);
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      isSplice() {
        var lastProp, ref1;
        ref1 = this.properties, [lastProp] = slice.call(ref1, -1);
      ...
      cacheReference(o) {
        ...
        ref1 = this.properties, [name] = slice.call(ref1, -1);
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      determineName() {
        ...
        ref1 = this.variable.properties, [tail] = slice.call(ref1, -1);
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileDestructuring(o) {
        ...
        compSlice = function(vvar, start, end = false) {
          var endVal;
          endVal = end ? `, ${end}` : "";
          return new Value(new Literal(`${utility('slice', o)}.call(${vvar}, ${start}${endVal})`));
        };
        // Helper which outputs `[].splice` code.
        compSplice = function(vvar, start, end = false) {
          var endVal;
          endVal = end ? `, ${end}` : "";
          return new Value(new Literal(`${utility('splice', o)}.call(${vvar}, ${start}${endVal})`));
        };
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      compileNode(o) {
        ...
        ref1 = body.expressions, [last] = slice.call(ref1, -1);

...
(function() {
  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      ...
      isNestedTag(element) {
        var call, exprs, ref1;
        return this.csx && (exprs = element != null ? (ref1 = element.body) != null ? ref1.expressions : void 0 : void 0) && exprs.length === 1 && (call = exprs != null ? exprs[0] : void 0) instanceof Call && call.csx;
      }

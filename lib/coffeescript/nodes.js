...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      ast() {
        var astLocationData, astProperties, astType, property, ref1;
        if (!this.hasProperties()) {
        ...
        property = this.properties[this.properties.length - 1];
        astProperties = {
          object: new Value(this.base.unwrap(), this.properties.slice(0, (this.properties.length - 1)), this.tag, this.isDefaultValue).ast(),
        ...
        astLocationData = mergeAstLocationData(this.base.astLocationData(), this.properties[this.properties.length - 1].astLocationData());
        return Object.assign({}, astProperties, {
          type: astType
        }, astLocationData);
      }

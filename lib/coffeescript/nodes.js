  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      constructor(variable1, value1, context1, options = {}) {
        ...
        // to be on `var`.
        if (this.variable.this && ((ref1 = this.variable.base) != null ? ref1.comments : void 0) && (((ref2 = this.variable.properties[0]) != null ? ref2.name : void 0) != null)) {
          attachCommentsToNode(this.variable.properties[0].name, this.variable.base.comments);
          delete this.variable.base.comments;
        }
      }
      ...
      compileSplice(o) {
        ...
        if (unwrappedVar.comments) {
          attachCommentsToNode(this, unwrappedVar.comments);

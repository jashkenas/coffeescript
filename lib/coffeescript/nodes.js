...
(function() {
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      // Compile a unary **Op**.
      compileUnary(o) {
        var op, parts, plusMinus, validUnaryExpression;
        parts = [];
        op = this.operator;
        validUnaryExpression = function(node) {
          ...
          if (expr.contains(function(n) {
            return n instanceof NumberLiteral || n instanceof Code || n instanceof Call;
          })) {
            return false;
          }
          return true;
        };
        if ((op === '++' || op === '--') && this.first instanceof Parens && !validUnaryExpression(this.first)) {
          this.first.error("Invalid left-hand side expression");
        }

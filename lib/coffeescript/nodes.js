...
(function() {
  ...
  exports.SubStructAssign = SubStructAssign = class SubStructAssign extends Base {
    ...
    finalProps(props = []) {
      ...
      ret = [];
      getProps = (props) => {
        var j, len1, p, ref1, results;
        ref1 = this.finalProps(this.objProperties(props));
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          p = ref1[j];
          results.push(p);
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileNode(o) {
        ...
        if (this.value instanceof SubStructAssign && this.value.lhs && !o.scope.check(this.value.value.value)) {
          this.error(`the variable '${this.value.value.value}' has not been declared before`);
        }
        if (isValue) {

    ...
    class Obj extends Base {
      ...
      expandProperty(property) {
        ...
        if (key instanceof Value && key.hasProperties()) {
          ...
          return new Assign(key, property, 'object', {
            shorthand: true
          }).withLocationDataFrom(property);
        }
        if (key !== property) {
          return property;
        }
        ...
        return new Assign(property, property, 'object', {
          shorthand: true
        }).withLocationDataFrom(property);
      }
      ...
      getPropertyAst(property) {
        var isComputedPropertyName, key, shorthand, value, variable;
        if (property instanceof Splat) {
          return property.ast();
        }
        ...
        key = isComputedPropertyName ? variable.base.value : variable.unwrap();
      ...
      astProperties() {
        ...
        return {
          properties: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              property = ref1[j];
              results.push(this.getPropertyAst(property));
            }
            return results;
          }).call(this),
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      constructor(variable1, value1, context1, options = {}) {
        ...
        ({param: this.param, subpattern: this.subpattern, operatorToken: this.operatorToken, moduleDeclaration: this.moduleDeclaration, shorthand: this.shorthand, originalContext: this.originalContext = this.context} = options);
      }

...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      astType() {
        if (this.base instanceof CSXTag) {
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXToAst() {
        ...
        return Object.assign(tagName.value.length ? this.CSXElementToAst({tagName, attributes, content}) : this.CSXFragmentToAst({tagName, attributes, content}), {
          children: []
        });
      }

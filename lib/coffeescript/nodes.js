  ...
  exports.Range = Range = (function() {
    class Range extends Base {
      ...
      compileNode(o) {
        ...
        condPart = known ? this.step == null ? from <= to ? `${lt} ${to}` : `${gt} ${to}` : from <= to ? `${from} <= ${idx} && ${lt} ${to}` : `${from} >= ${idx} && ${gt} ${to}` : `${this.fromVar} <= ${this.toVar} ? ${this.fromVar} <= ${idx} && ${lt} ${this.toVar} : ${this.fromVar} >= ${idx} && ${gt} ${this.toVar}`;

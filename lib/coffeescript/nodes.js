  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      getExpressionAst(expression, o) {
        ...
        return this.asExpressionStatementAst(ast);
      }

      bodyToAst(o) {
        var expression, j, len1, ref1, results;
        ref1 = this.expressions;
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          expression = ref1[j];
          results.push(this.getExpressionAst(expression, o));
        }
        return results;
      }
...
// multiline need to be indented.
  ...
  exports.Try = Try = (function() {
    class Try extends Base {
      constructor(attempt, _catch, ensure) {
        super();
      ...
      compileNode(o) {
        var catchPart, ensurePart, generatedErrorVariableName, tryPart;
        o.indent += TAB;
        tryPart = this.attempt.compileToFragments(o, LEVEL_TOP);
        catchPart = this.catch ? this.catch.compileToFragments(o, LEVEL_TOP) : !(this.ensure || this.catch) ? (generatedErrorVariableName = o.scope.freeVariable('error', {
          reserve: false
      ...
      astProperties(o) {
        ...
        return {
          ...
          finalizer: (ref3 = (ref4 = this.ensure) != null ? ref4.ast(o) : void 0) != null ? ref3 : null
        };
      }
  ...
  extractAstLocationData = function(ast) {
    return {
      loc: ast.loc,
      range: ast.range,
      start: ast.start,

...
// in the first place, but for now, clean up obvious double-parentheses.
      ...
      compileComments(fragments) {
        var code, commentFragment, fragment, fragmentIndent, fragmentIndex, indent, j, k, l, len1, len2, newLineIndex, pastFragment, pastFragmentIndex, q, ref1, ref2, ref3, upcomingFragment, upcomingFragmentIndex;
...
// impractical to abstract into a function that both blocks can share.
          if (fragment.trailingComments) {
            code = ((function() {
              var len2, q, ref3, results;
              ref3 = fragment.trailingComments;
              results = [];
              for (q = 0, len2 = ref3.length; q < len2; q++) {
                commentFragment = ref3[q];
                results.push(commentFragment.code);
              }
              return results;
            })()).join('\n');
            ...
            for (upcomingFragmentIndex = q = 0, len2 = ref3.length; q < len2; upcomingFragmentIndex = ++q) {

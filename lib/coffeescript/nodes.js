  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      attachComments(o, node, fragments) {
        var base1, base2, code, comment, commentFragment, fragment, fragmentIndex, hasLeadingMarks, j, k, largestIndent, leadingWhitespace, len1, len2, line, multiline, ref1, ref2, results;
        ref1 = node.comments;
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (comment.here) { // Comment delimited by `###`.
            ...
            commentFragment = this.makeCode(`//${comment.content}`);
            ...
            if (comment.unshift) {
              ...
              results.push(fragments[fragments.length - 1].trailingComments.push(commentFragment));
            }
          }
        }
        return results;

...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToBabylon, babylonLocationFields, isArray, isFunction, isPlainObject, getNumberValue} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withBabylonLocationData(ast, node) {
        ...
        return merge(ast, locationDataToBabylon(locationData));
      }

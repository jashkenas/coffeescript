...
// multiline need to be indented.
    ...
    class YieldReturn extends Return {
      ...
      checkScope(o) {
        if (o.scope.parent == null) {
          return this.error('yield can only occur inside functions');
        }
      }
      ...
      ast(o) {
        this.checkScope(o);
        return new Op('yield', new Return(this.expression).withLocationDataFrom(mergeLocationData(this.returnKeyword, this.expression))).withLocationDataFrom(this).ast(o);
      }

    };

    YieldReturn.prototype.isStatementAst = NO;
  ...
  exports.AwaitReturn = AwaitReturn = (function() {
    class AwaitReturn extends Return {
      ...
      checkScope(o) {
        if (o.scope.parent == null) {
          return this.error('await can only occur inside functions');
        }
      }
      ...
      ast(o) {
        this.checkScope(o);
        return new Op('await', new Return(this.expression).withLocationDataFrom(mergeLocationData(this.returnKeyword, this.expression))).withLocationDataFrom(this).ast(o);
      }

    };

    AwaitReturn.prototype.isStatementAst = NO;

...
(function() {
  ...
  exports.SubStructAssign = SubStructAssign = class SubStructAssign extends Base {
    ...
    objProperties(props) {
      var j, len1, obj, prop, ret, validObj;
      ret = [];
      for (j = 0, len1 = props.length; j < len1; j++) {
        ...
        if (prop instanceof Assign && prop.context === 'object') {
          ...
          validObj = (obj instanceof Arr && obj.objects.length > 0) || (obj instanceof Obj && obj.properties.length > 0) || obj instanceof IdentifierLiteral;
          if (validObj) {
            ret.push(obj);
          }

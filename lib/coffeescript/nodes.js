  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compilePatternMatch(o) {
        var acc, assigns, code, defaultValue, expandedIdx, fragments, hasSplat, i, idx, isObject, ivar, j, len1, message, name, nonSplatKeys, obj, objects, olen, ref, ref3, ref4, ref5, ref6, refVar, rest, splatKey, splatVarObj, top, ts, val, value, vvar, vvarSplatText, vvarText;
        top = o.level === LEVEL_TOP;
        value = this.value;
        ...
        if (hasSplat && splatKey) {
          ...
          assigns.push(new Assign(splatVarObj, new Arr(nonSplatKeys, null, {
            param: this.param,
            subpattern: true
          })).compileToFragments(o, LEVEL_LIST));

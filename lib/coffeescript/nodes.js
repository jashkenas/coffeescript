...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToBabel, babelLocationFields, isArray, isFunction, isPlainObject, getNumberValue} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      toAst(o, level) {
        ...
        return this.withBabelLocationData(this.withAstType(this._toAst(o), o));
      }
      ...
      withAstType(ast, o) {
        ...
        if (!(this.emptyAst || (function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            key = ref1[j];
            if (indexOf.call(['comments', ...babelLocationFields], key) < 0) {
              return true;
            }
          }
        })())) {
      ...
      withBabelLocationData(ast, node) {
        ...
        if (isArray(ast)) {
          return (function() {
            ...
            for (j = 0, len1 = ast.length; j < len1; j++) {
              item = ast[j];
              results.push(this.withBabelLocationData(item, node));
            }
            return results;
          }).call(this);
        }
        ...
        return merge(ast, locationDataToBabel(locationData));
      }
    ...
    class Op extends Base {
      constructor(op, first, second, flip, {invertOperator, originalOperator: originalOperator = op} = {}) {
        ...
        if (op === 'new') {
          ...
          if (firstCall instanceof Code && firstCall.bound || firstCall.do) {
            first = new Parens(firstCall);
          }
        }

...
(function() {
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      astLocationData() {
        return locationDataToAst(this.locationData);
      }
  ...
  exports.RegexLiteral = RegexLiteral = class RegexLiteral extends Literal {
    constructor(value, {delimiter: delimiter1 = '/'} = {}) {
...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      astLocationData() {
        ...
        return mergeAstLocationData(locationDataToAst(this.base.tagNameLocationData), locationDataToAst(this.properties[this.properties.length - 1].locationData));
      }
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXElementToAst({tagName, attributes, content}) {
        var closingElement, closingElementLocationData, currentExpr, openingElement, openingElementLocationData, rangeDiff, shiftAstLocationData;
        ...
        openingElement = Object.assign({
          ...
          name: this.variable.unwrap().ast(),
          selfClosing: !content,
          attributes: []
        }, openingElementLocationData);
        closingElement = null;
        if (content) {
          closingElementLocationData = mergeAstLocationData(locationDataToAst(tagName.closingTagOpeningBracketLocationData), locationDataToAst(tagName.closingTagClosingBracketLocationData));
          closingElement = Object.assign({
            type: 'JSXClosingElement',
            name: Object.assign(this.variable.unwrap().ast(), locationDataToAst(tagName.closingTagNameLocationData))
        ...
        return Object.assign({
          ...
          openingElement,
          closingElement
        }, closingElement != null ? mergeAstLocationData(openingElementLocationData, closingElementLocationData) : openingElementLocationData);
      }
      ...
      CSXToAst() {
        ...
        return Object.assign(this.CSXElementToAst({tagName, attributes, content}), {
          // else
  ...
  exports.RegexWithInterpolations = RegexWithInterpolations = class RegexWithInterpolations extends Base {
    constructor(call1) {
      super();
      this.call = call1;
    }
  ...
  exports.Splat = Splat = (function() {
    class Splat extends Base {
      constructor(name, {postfix: postfix = true} = {}) {
        super();
  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      ...
      isNestedTag(element) {
        ...
        return this.csx && call instanceof Call && call.csx;
      }
  ...
  makeDelimitedLiteral = function(body, options = {}) {
    var regex;
  ...
  locationDataToAst = function({first_line, first_column, last_line, last_column, range}) {
    return {
      loc: {
        start: {
          line: first_line + 1,

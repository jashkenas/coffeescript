...
(function() {
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileNode(o) {
        var answer, compiledNodes, fragments, index, j, lastFragment, len1, node, ref1, ref2, top;
        this.tab = o.indent;
        ...
        for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
          ...
          if (node instanceof Block) {
            ...
            if (node instanceof IdentifierLiteral && ((ref2 = node.comments) != null ? ref2.some(function(comment) {
              return comment.here && !comment.unshift && !comment.newLine;
            }) : void 0)) {
              fragments = this.wrapInParentheses(fragments);
            }

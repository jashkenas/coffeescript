...
(function() {
  ...
  exports.Splat = Splat = (function() {
    class Splat extends Base {
      ...
      compileToFragments(o) {
        var flen, fragment, fragments, ix, j, len1;
        ...
        // f(a.b?.c...) => f((a.b?.c)...)
        // [a if b...]  => [(a if b)...]
        if (!(this.name instanceof Value) || !this.isAssignable()) {
          fragments = this.name.compileToFragments(o, LEVEL_OP);
          ...
          for (ix = j = 0, len1 = fragments.length; j < len1; ix = ++j) {
            ...
            if (fragment.type === 'If' && fragment.code === 'void 0' && ix + 1 < flen && fragments[ix + 1].type !== 'Call') {
              fragments[ix].code = '[]';
            }
          }
        } else {
        ...
        return [this.makeCode('...'), ...fragments];
      }

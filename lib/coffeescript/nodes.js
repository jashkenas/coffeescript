...
(function() {
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      hasSplat() {
        return this.isObject() && this.base.hasSplat();
      }
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      shouldCache() {
        return !this.isAssignable() || this.hasSplat();
      }

      hasSplat() {
        var j, len1, prop, props, splat;
        props = this.properties;
        for (j = 0, len1 = props.length; j < len1; j++) {
          prop = props[j];
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileNode(o) {
        ...
        if (isValue) {
          ...
          if (this.variable.isArray() || this.variable.isObject()) {
            ...
            if (this.variable.isObject() && this.variable.hasSplat()) {
      ...
      compileObjectDestruct(o) {
        var compiledName, extractKeys, fragments, getPropValue, j, len1, objVar, objects, ref, restElement, restList, setScopeVar, traverseRest, val, varProp, vvarPropText, vvarText;
        setScopeVar = function(obj) {
          var newVar;
          newVar = false;
          if (obj instanceof Assign && obj.value.base instanceof Obj) {
            return;
          }
        ...
        getPropValue = function(obj) {
          var wrapInQutes;
          wrapInQutes = function(obj) {
            return (new Literal(`'${obj.compile(o)}'`)).compile(o);
          };
          setScopeVar(obj);
          if (obj instanceof Assign) {
            if (obj.variable.base instanceof StringWithInterpolations || obj.variable.base instanceof StringLiteral) {
              return obj.variable.compile(o);
            }
        ...
        traverseRest = function(objects, props = []) {
          var j, key, len1, obj, p, restElement, results;
          results = [];
          restElement = false;
            ...
            if (obj instanceof Splat) {
              ...
              restElement = {
                ...
                props: ((function() {
                  ...
                  for (k = 0, len2 = ref1.length; k < len2; k++) {
                    p = ref1[k];
                    results1.push((new Literal(`[${p}]`)).compile(o));
                  }
                  return results1;
                })()).join("")
              };
          ...
          if (restElement) {
            ...
            restElement["excludeProps"] = new Literal(`[${(function() {
              var k, len2, results1;
              results1 = [];
        ...
        if ((!(this.value.unwrap() instanceof IdentifierLiteral)) || this.variable.assigns(vvarText)) {
          fragments.push([this.makeCode(`${(ref = o.scope.freeVariable('obj'))} = `, ...val)]);
          val = (new IdentifierLiteral(ref)).compileToFragments(o, LEVEL_TOP);
          vvarText = ref;
        }
        compiledName = this.variable.compileToFragments(o, LEVEL_TOP);
        objVar = compiledName.concat(this.makeCode(" = "), val);
        fragments.push(this.wrapInParentheses(objVar));
        ...
        return this.joinFragmentArrays(fragments, ", ");
      }
      ...
      compileNode(o) {
        ...
        for (i = j = 0, len1 = ref4.length; j < len1; i = ++j) {
          ...
          if (param.splat || param instanceof Expansion) {
            ...
            haveSplatParam = true && !(param.name instanceof Obj);
            if (param.splat) {
            ...
            if (!haveSplatParam) {
              ...
              if (param.name instanceof Arr || param.name instanceof Obj) {
                ...
                if (param.name instanceof Arr && param.shouldCache()) {
                  ...
                  for (q = 0, len4 = arrParams.length; q < len4; q++) {
                    val = arrParams[q];
                    o.scope.add(val, 'var', true);
                  }
                }
        ...
        if (paramsAfterSplat.length !== 0) {
          exprs.unshift(new Assign(new Value(new Arr([
            new Splat(new IdentifierLiteral(splatParamName)), ...(function() {
              var len5, r, results1;
              results1 = [];
              for (r = 0, len5 = paramsAfterSplat.length; r < len5; r++) {
                param = paramsAfterSplat[r];
        ...
        answer = this.joinFragmentArrays((function() {
          var len6, results1, s;
          results1 = [];
          for (s = 0, len6 = modifiers.length; s < len6; s++) {
            m = modifiers[s];
  ...
  UTILITIES = {
    ...
    objectWithoutKeys: function() {
      return 'function(obj, props) { return Object.keys(obj).reduce(function(a,c) { return (![].includes.call(props, c)) && (a[c] = obj[c]), a; }, {}); }';
    },
    hasProp: function() {

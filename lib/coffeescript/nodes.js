...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToBabel, babelLocationFields, isFunction, isPlainObject, getNumberValue} = require('./helpers'));

...
// multiline need to be indented.
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      reorderProperties() {
        var objProps, prop, props, splatProps;
        props = this.properties;
        splatProps = (function() {
          var j, len1, results;
          results = [];
        ...
        return this.objects = this.properties = [].concat(objProps, splatProps);
      }

      compileNode(o) {
        var answer, i, idt, indent, isCompact, ix, j, join, k, key, l, lastNode, len1, len2, len3, len4, node, p, prop, props, ref1, splatProps, unwrappedVal, value;
        ...
        if (this.hasSplat() && this.lhs) {
          splatProps = (function() {
            var k, len2, results;
            results = [];
            for (ix = k = 0, len2 = props.length; k < len2; ix = ++k) {
              prop = props[ix];
              if (prop instanceof Splat) {
                results.push(ix);
              }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileNode(o) {
        var answer, compiledName, hasSplat, isValue, name, properties, prototype, ref1, ref2, ref3, ref4, ref5, val, varBase;

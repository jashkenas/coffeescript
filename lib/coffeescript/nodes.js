...
// multiline need to be indented.
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      getCasesAst(o) {
        var caseIndex, caseLocationData, cases, consequent, consequentAst, j, k, kase, lastTestIndex, len1, len2, ref1, ref2, test, testIndex, tests;
        cases = [];
        ref1 = this.cases;
        for (caseIndex = j = 0, len1 = ref1.length; j < len1; caseIndex = ++j) {
          ...
          for (testIndex = k = 0, len2 = tests.length; k < len2; testIndex = ++k) {
            ...
            consequentAst = testIndex === lastTestIndex ? consequent.ast(o).body : [];
            caseLocationData = test.astLocationData();
            if (consequentAst.length) {
              caseLocationData = mergeAstLocationData(caseLocationData, consequentAst[consequentAst.length - 1]);
            }
            if (testIndex === 0) {
              caseLocationData = mergeAstLocationData(caseLocationData, kase.astLocationData(), {
                justLeading: true
              });
            }
        ...
        if ((ref2 = this.otherwise) != null ? ref2.expressions.length : void 0) {
          cases.push(Object.assign({
            type: 'SwitchCase',
            test: null,
            consequent: this.otherwise.ast(o).body
          }, this.otherwise.astLocationData()));
        }
        return cases;
      }
      ...
      astProperties(o) {
        var ref1;
        return {
          discriminant: (ref1 = this.subject) != null ? ref1.ast(o) : void 0,
          cases: this.getCasesAst(o)
        };
      }
  ...
  mergeLocationData = function(locationDataA, locationDataB) {
    return Object.assign(isLocationDataStartGreater(locationDataA, locationDataB) ? {

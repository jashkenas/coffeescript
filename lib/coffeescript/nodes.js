    ...
    class Base {
      ...
      compileCommentFragments(o, node, fragments) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          comment = ref1[j];
          if (!(indexOf.call(compiledComments, comment) < 0)) {
            continue;
          }
          ...
          if (comment.here) { // Block comment, delimited by `###`.
            ...
            unshiftCommentFragment(commentFragment); // Line comment, delimited by `#`.
          } else {
    ...
    class Existence extends Base {
      constructor(expression1, onlyNotUndefined = false) {
        ...
        if (this.expression.comments) {
          ...
          attachCommentsToNode(this, salvagedComments);
          delete this.expression.comments;
        }
      }
    ...
    class If extends Base {
      constructor(condition, body1, options = {}) {
        ...
        if (this.condition.comments) {
          attachCommentsToNode(this, this.condition.comments);
          delete this.condition.comments;
        }
      }

...
(function() {
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      compileClosure(o) {
        var args, argumentsNode, func, meth, parts, ref, ref1;
        ...
        switch (false) {
          case !(func.isGenerator || ((ref = func.base) != null ? ref.isGenerator : void 0)):
            parts.unshift(this.makeCode("(yield* "));
            parts.push(this.makeCode(")"));
            break;
          case !(func.isAsync || ((ref1 = func.base) != null ? ref1.isAsync : void 0)):
      ...
      compileCommentFragments(o, node, fragments) {
        var base, base1, comment, commentFragment, i, len, ref, unshiftCommentFragment;
        if (!node.comments) {
          return fragments;
        }
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if ((commentFragment.isHereComment && !commentFragment.newLine) || node.includeCommentFragments()) {
            ...
            if (commentFragment.unshift) {
              if ((base = fragments[0]).precedingComments == null) {
                base.precedingComments = [];
              }
              fragments[0].precedingComments.push(commentFragment);
            } else {
              if ((base1 = fragments[fragments.length - 1]).followingComments == null) {
                base1.followingComments = [];
              }
      ...
      replaceInContext(match, replacement) {
        var attr, child, children, i, j, k, len, len1, ref, ref1;
        if (!this.children) {
          return false;
        }
        ref = this.children;
          ...
          if (children = this[attr]) {
            if (Array.isArray(children)) {
              for (i = k = 0, len1 = children.length; k < len1; i = ++k) {
                child = children[i];
                if (match(child)) {
                  splice.apply(children, [i, i - i + 1].concat(ref1 = replacement(child, this))), ref1;
                  return true;
                } else {
      ...
      findReferencedVars(scopeNodes) {
        return this.eachChild(function(child) {
          return child.findReferencedVars(scopeNodes);
        });
      }
      ...
      joinFragmentArrays(fragmentsList, joinStr) {
        var answer, fragments, i, j, len;
        answer = [];
        for (i = j = 0, len = fragmentsList.length; j < len; i = ++j) {
  ...
  exports.HoistTarget = HoistTarget = class HoistTarget extends Base {
    ...
    static expand(fragments) {
      var fragment, i, j, ref;
      for (i = j = fragments.length - 1; j >= 0; i = j += -1) {
        fragment = fragments[i];
        if (fragment.fragments) {
          splice.apply(fragments, [i, i - i + 1].concat(ref = this.expand(fragment.fragments))), ref;
        }
      }
      return fragments;
    }
  ...
  exports.Root = Root = (function() {
    class Root extends Base {
      constructor(body) {
        ...
        this.referencedVars = new Set(); // all referenced variable names in this scope
      }
      ...
      findReferencedVars(scopeNodes = []) {
        ...
        return super.findReferencedVars(scopeNodes.concat(this));
      }
      ...
      initializeScope(o) {
        ...
        o.scope = new Scope(null, this.body, null, this.referencedVars);
        ref = o.locals || [];
        results = [];
        for (i = 0, len = ref.length; i < len; i++) {
          name = ref[i];
      ...
      commentsAst() {
        var comment, commentToken, i, len, ref, results;
        if (this.allComments == null) {
          this.allComments = (function() {
            var i, len, ref, ref1, results;
            ref1 = (ref = this.allCommentTokens) != null ? ref : [];
            results = [];
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      makeReturn(results, mark) {
        var expr, expressions, last, lastExp, len, penult, ref, ref1;
        len = this.expressions.length;
        ref = this.expressions, [lastExp] = slice1.call(ref, -1);
        ...
        if (mark) {
          if ((ref1 = this.expressions[len - 1]) != null) {
      ...
      compileNode(o) {
        var answer, compiledNodes, fragments, i, index, lastFragment, len, node, ref, top;
        this.tab = o.indent;
      ...
      compileWithDeclarations(o) {
        var assigns, declaredVariable, declaredVariables, declaredVariablesIndex, declars, exp, fragments, i, j, k, len, len1, post, ref, rest, scope, spaced;
        fragments = [];
        post = [];
        ref = this.expressions;
        ...
        if (scope.expressions === this) {
          ...
          if (declars || assigns) {
            ...
            if (declars) {
              ...
              for (declaredVariablesIndex = k = 0, len1 = declaredVariables.length; k < len1; declaredVariablesIndex = ++k) {
      ...
      compileComments(fragments) {
        var code, commentFragment, fragment, fragmentIndent, fragmentIndex, i, indent, j, k, l, len, len1, len2, m, newLineIndex, onNextLine, pastFragment, pastFragmentIndex, ref, ref1, ref2, ref3, trail, upcomingFragment, upcomingFragmentIndex;
        for (fragmentIndex = i = 0, len = fragments.length; i < len; fragmentIndex = ++i) {
          ...
          if (fragment.precedingComments) {
            ...
            fragmentIndent = '';
            ref = fragments.slice(0, (fragmentIndex + 1));
            ...
            code = `\n${fragmentIndent}` + ((function() {
              ...
              ref1 = fragment.precedingComments;
              results = [];
              for (k = 0, len1 = ref1.length; k < len1; k++) {
                commentFragment = ref1[k];
            ...
            for (pastFragmentIndex = k = ref1.length - 1; k >= 0; pastFragmentIndex = k += -1) {
              pastFragment = ref1[pastFragmentIndex];
          ...
          if (fragment.followingComments) {
            ...
            if (!(trail && fragment.followingComments.length === 1)) {
              onNextLine = false;
              ref2 = fragments.slice(fragmentIndex);
              for (l = 0, len1 = ref2.length; l < len1; l++) {
                upcomingFragment = ref2[l];
                if (!onNextLine) {
            ...
            code += ((function() {
              ...
              ref3 = fragment.followingComments;
              results = [];
              for (m = 0, len2 = ref3.length; m < len2; m++) {
                commentFragment = ref3[m];
                if (commentFragment.isHereComment && commentFragment.multiline) {
                  results.push(multident(commentFragment.code, fragmentIndent, false));
                } else {
                  results.push(commentFragment.code);
            ...
            for (upcomingFragmentIndex = m = 0, len2 = ref3.length; m < len2; upcomingFragmentIndex = ++m) {
              upcomingFragment = ref3[upcomingFragmentIndex];
      ...
      astProperties(o) {
        var body, checkForDirectives, directives, expression, expressionAst, i, len, ref;
  ...
  exports.InfinityLiteral = InfinityLiteral = class InfinityLiteral extends NumberLiteral {
    constructor(value, {originalValue: originalValue = 'Infinity'} = {}) {
      super();
      this.value = value;
  ...
  exports.RegexLiteral = RegexLiteral = (function() {
    class RegexLiteral extends Literal {
      constructor(value, {delimiter: delimiter = '/', heregexCommentTokens: heregexCommentTokens = []} = {}) {
      ...
      astProperties(o) {
        ...
        return {
          ...
          comments: (function() {
            ...
            ref = this.heregexCommentTokens;
            results = [];
            for (i = 0, len = ref.length; i < len; i++) {
              heregexCommentToken = ref[i];
  ...
  exports.IdentifierLiteral = IdentifierLiteral = (function() {
    class IdentifierLiteral extends Literal {
      ...
      findReferencedVars(scopeNodes) {
        var i, len, results, scopeNode;
        results = [];
        for (i = 0, len = scopeNodes.length; i < len; i++) {
          scopeNode = scopeNodes[i];
          ...
          results.push(scopeNode.referencedVars.add(this.value));
        }
        return results;
      }
  ...
  exports.ThisLiteral = ThisLiteral = class ThisLiteral extends Literal {
    ...
    compileNode(o) {
      var code, ref;
      code = ((ref = o.scope.method) != null ? ref.bound : void 0) ? o.scope.method.context : this.value;
  ...
  exports.Return = Return = (function() {
    class Return extends Base {
      ...
      compileToFragments(o, level) {
        var expr, ref;
        expr = (ref = this.expression) != null ? ref.makeReturn() : void 0;
...
// multiline need to be indented.
      ...
      astProperties(o) {
        var ref, ref1;
        return {
          argument: (ref = (ref1 = this.expression) != null ? ref1.ast(o, LEVEL_PAREN) : void 0) != null ? ref : null
        };
      }
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      constructor(base, props, tag, isDefaultValue = false) {
        ...
        // to be on `foo`.
        if (((ref = this.base) != null ? ref.comments : void 0) && this.base instanceof ThisLiteral && (((ref1 = this.properties[0]) != null ? ref1.name : void 0) != null)) {
      ...
      isAtomic() {
        var i, len, node, ref;
        ref = this.properties.concat(this.base);
        for (i = 0, len = ref.length; i < len; i++) {
          node = ref[i];
      ...
      isSplice() {
        var lastProperty, ref;
        ref = this.properties, [lastProperty] = slice1.call(ref, -1);
        return lastProperty instanceof Slice;
      }

      looksStatic(className) {
        var name, ref, thisLiteral;
        if (!(((thisLiteral = this.base) instanceof ThisLiteral || (name = this.base).value === className) && this.properties.length === 1 && ((ref = this.properties[0].name) != null ? ref.value : void 0) !== 'prototype')) {
          return false;
        }
        return {
      ...
      cacheReference(o) {
        var base, bref, name, nref, ref;
        ref = this.properties, [name] = slice1.call(ref, -1);
      ...
      compileNode(o) {
        var fragments, i, len, prop, props;
      ...
      unfoldSoak(o) {
        return this.unfoldedSoak != null ? this.unfoldedSoak : this.unfoldedSoak = (() => {
          var fst, i, ifn, j, len, prop, ref, ref1, snd;
      ...
      astProperties(o) {
        var computed, property, ref, ref1;
        ref = this.properties, [property] = slice1.call(ref, -1);
        if (this.isJSXTag()) {
          property.name.jsx = true;
        }
        computed = property instanceof Index || !(((ref1 = property.name) != null ? ref1.unwrap() : void 0) instanceof PropertyName);
        return {
  ...
  exports.HereComment = HereComment = class HereComment extends Base {
    ...
    compileNode(o) {
      var fragment, hasLeadingMarks, i, indent, leadingWhitespace, len, line, multiline, ref;
      multiline = indexOf.call(this.content, '\n') >= 0;
      // Unindent multiline comments. They will be reindented later.
      if (multiline) {
        indent = null;
        ref = this.content.split('\n');
        for (i = 0, len = ref.length; i < len; i++) {
          line = ref[i];
  ...
  exports.JSXAttribute = JSXAttribute = (function() {
    class JSXAttribute extends Base {
      constructor({name, value}) {
        ...
        if ((ref = this.value) != null) {
          ref.comments = value.comments;
        }
      }
      ...
      astProperties(o) {
        ...
        return {
          name: name.ast(o),
          value: (ref = (ref1 = this.value) != null ? ref1.ast(o) : void 0) != null ? ref : null
        };
      }
  ...
  exports.JSXAttributes = JSXAttributes = (function() {
    class JSXAttributes extends Base {
      constructor(arr) {
        var attribute, base, i, j, len, len1, object, property, ref, ref1, value, variable;
        super();
        this.attributes = [];
        ref = arr.objects;
        for (i = 0, len = ref.length; i < len; i++) {
      ...
      compileNode(o) {
        var attribute, fragments, i, len, ref;
        fragments = [];
        ref = this.attributes;
        for (i = 0, len = ref.length; i < len; i++) {
          attribute = ref[i];
  ...
  exports.JSXElement = JSXElement = (function() {
    class JSXElement extends Base {
      ...
      elementAstProperties(o) {
        var closingElement, columnDiff, currentExpr, openingElement, rangeDiff, ref, shiftAstLocationData, tagNameAst;
        tagNameAst = () => {
          var tag;
        ...
        if (this.closingElementLocationData != null) {
          ...
          if ((ref = closingElement.name.type) === 'JSXMemberExpression' || ref === 'JSXNamespacedName') {
      ...
      contentAst(o) {
        var base, child, children, content, element, emptyExpression, expression, i, len, results, unwrapped;
        if (!(this.content && !(typeof (base = this.content.base).isEmpty === "function" ? base.isEmpty() : void 0))) {
          return [];
        }
        ...
        children = (function() {
          ...
          if (content instanceof StringLiteral) {
            ...
            ref = this.content.unwrapAll().extractElements(o, {
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      constructor(variable, args = [], soak, token) {
        ...
        // the grammar.
        if (((ref = this.variable.base) != null ? ref.value : void 0) === 'RegExp' && this.args.length !== 0) {
      ...
      updateLocationDataIfMissing(locationData) {
        ...
        if (this.locationData && this.needsUpdatedStartLocation) {
          ...
          base = ((ref = this.variable) != null ? ref.base : void 0) || this.variable;
      ...
      unfoldSoak(o) {
        var call, i, ifn, left, len, list, ref, rite;
        if (this.soak) {
      ...
      compileNode(o) {
        var arg, argCode, argIndex, cache, compiledArgs, fragments, i, len, ref, ref1, ref2, ref3, varAccess;
        this.checkForNewSuper();
        if ((ref = this.variable) != null) {
          ref.front = this.front;
        }
        compiledArgs = [];
        ...
        // `a(x = 5); b(-> x = 6)`
        // (see issue #4437, https://github.com/jashkenas/coffeescript/issues/4437)
        varAccess = ((ref1 = this.variable) != null ? (ref2 = ref1.properties) != null ? ref2[0] : void 0 : void 0) instanceof Access;
        argCode = (function() {
        ...
        ref3 = this.args;
        for (argIndex = i = 0, len = ref3.length; i < len; argIndex = ++i) {
          arg = ref3[argIndex];
          if (argIndex) {
      ...
      containsSoak() {
        ...
        if ((ref = this.variable) != null ? typeof ref.containsSoak === "function" ? ref.containsSoak() : void 0 : void 0) {
          return true;
        }
        return false;
      }
      ...
      astNode(o) {
        var ref;
        if (this.soak && this.variable instanceof Super && ((ref = o.scope.namedMethod()) != null ? ref.ctor : void 0)) {
          this.variable.error("Unsupported reference to 'super'");
        }
        this.checkForNewSuper();
        return super.astNode(o);
  ...
  exports.SuperCall = SuperCall = (function() {
    class SuperCall extends Call {
      isStatement(o) {
        var ref;
        return ((ref = this.expressions) != null ? ref.length : void 0) && o.level === LEVEL_TOP;
      }
  ...
  exports.Super = Super = (function() {
    class Super extends Base {
      ...
      compileNode(o) {
        var fragments, method, name, nref, ref, ref1, salvagedComments, variable;
        ...
        if ((ref = this.accessor) != null ? (ref1 = ref.name) != null ? ref1.comments : void 0 : void 0) {
      ...
      astNode(o) {
        ...
        if (this.accessor != null) {
          return (new Value(new Super().withLocationDataFrom((ref = this.superLiteral) != null ? ref : this), [this.accessor]).withLocationDataFrom(this)).ast(o);
        }
        return super.astNode(o);
      }
  ...
  exports.RegexWithInterpolations = RegexWithInterpolations = (function() {
    class RegexWithInterpolations extends Base {
      constructor(call, {heregexCommentTokens: heregexCommentTokens = []} = {}) {
        super();
        this.call = call;
        this.heregexCommentTokens = heregexCommentTokens;
      }
      ...
      astProperties(o) {
        var heregexCommentToken, ref, ref1;
        return {
          interpolatedPattern: this.call.args[0].ast(o),
          flags: (ref = (ref1 = this.call.args[1]) != null ? ref1.unwrap().originalValue : void 0) != null ? ref : '',
          comments: (function() {
            var i, len, ref2, results;
            ref2 = this.heregexCommentTokens;
            results = [];
            for (i = 0, len = ref2.length; i < len; i++) {
              heregexCommentToken = ref2[i];
              if (heregexCommentToken.here) {
                results.push(new HereComment(heregexCommentToken).ast(o));
              } else {
                results.push(new LineComment(heregexCommentToken).ast(o));
  ...
  exports.Range = Range = (function() {
    class Range extends Base {
      ...
      compileNode(o) {
        var cond, condPart, from, gt, idx, idxName, known, lowerBound, lt, namedIndex, ref, ref1, stepCond, stepNotZero, stepPart, to, upperBound, varPart;
        if (!this.fromVar) {
        ...
        stepNotZero = `${(ref = this.stepNum) != null ? ref : this.stepVar} !== 0`;
        stepCond = `${(ref1 = this.stepNum) != null ? ref1 : this.stepVar} > 0`;
      ...
      compileArray(o) {
        var args, body, cond, hasArgs, i, idt, known, post, pre, range, ref, ref1, result, vars;
        known = (this.fromNum != null) && (this.toNum != null);
        if (known && Math.abs(this.fromNum - this.toNum) <= 20) {
          range = (function() {
            var results = [];
            for (var j = ref = this.fromNum, ref1 = this.toNum; ref <= ref1 ? j <= ref1 : j >= ref1; ref <= ref1 ? j++ : j--){ results.push(j); }
            return results;
          }).apply(this);
          if (this.exclusive) {
            range.pop();
      ...
      astProperties(o) {
        ...
        return {
          from: (ref = (ref1 = this.from) != null ? ref1.ast(o) : void 0) != null ? ref : null,
          to: (ref2 = (ref3 = this.to) != null ? ref3.ast(o) : void 0) != null ? ref2 : null,
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      isAssignable(opts) {
        var i, len, message, prop, ref, ref1;
        ref = this.properties;
        for (i = 0, len = ref.length; i < len; i++) {
          prop = ref[i];
          ...
          if (prop instanceof Assign && prop.context === 'object' && !(((ref1 = prop.value) != null ? ref1.base : void 0) instanceof Arr)) {
            prop = prop.value;
          }
      ...
      compileNode(o) {
        var answer, i, idt, indent, isCompact, j, join, k, key, l, lastNode, len, len1, len2, node, prop, props, ref, value;
        ...
        for (i = l = 0, len2 = props.length; l < len2; i = ++l) {
          prop = props[i];
      ...
      propagateLhs(setLhs) {
        var i, len, property, ref, results, unwrappedValue, value;
        if (setLhs) {
          this.lhs = true;
        }
        if (!this.lhs) {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if (property instanceof Assign && property.context === 'object') {
            ...
            results.push(property.propagateLhs(true));
          } else {
            results.push(void 0);
          }
        }
  ...
  exports.ObjectProperty = ObjectProperty = class ObjectProperty extends Base {
    ...
    astProperties(o) {
      var isComputedPropertyName, keyAst, ref, ref1;
      ...
      return {
        ...
        value: (ref = (ref1 = this.value) != null ? ref1.ast(o, LEVEL_LIST) : void 0) != null ? ref : keyAst,
        shorthand: !!this.shorthand,
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      isAssignable(opts) {
        var allowEmptyArray, allowExpansion, allowNontrailingSplat, i, j, len, obj, ref;
      ...
      compileNode(o) {
        var answer, compiledObjs, fragment, fragmentIndex, fragmentIsElision, fragments, i, includesLineCommentsOnNonFirstElement, index, j, k, l, len, len1, len2, len3, len4, m, obj, objIndex, olen, passedElision, ref, ref1, unwrappedObj;
        if (!this.objects.length) {
        ...
        answer = [];
        ref = this.objects;
        for (objIndex = i = 0, len = ref.length; i < len; objIndex = ++i) {
          obj = ref[objIndex];
        ...
        if (includesLineCommentsOnNonFirstElement || indexOf.call(fragmentsToText(answer), '\n') >= 0) {
          for (fragmentIndex = l = 0, len3 = answer.length; l < len3; fragmentIndex = ++l) {
            fragment = answer[fragmentIndex];
            if (fragment.isHereComment) {
              fragment.code = `${multident(fragment.code, o.indent, false)}\n${o.indent}`;
            } else if (fragment.code === ', ' && !(fragment != null ? fragment.isElision : void 0) && ((ref1 = fragment.type) !== 'StringLiteral' && ref1 !== 'StringWithInterpolations')) {
              fragment.code = `,\n${o.indent}`;
            }
          }
          ...
          for (m = 0, len4 = answer.length; m < len4; m++) {
            fragment = answer[m];
            if (fragment.isHereComment) {
      ...
      // are too.
      propagateLhs(setLhs) {
        var i, len, object, ref, results, unwrappedObject;
        if (setLhs) {
          this.lhs = true;
        }
        if (!this.lhs) {
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      determineName() {
        var message, name, node, ref, tail;
        if (!this.variable) {
          return null;
        }
        ref = this.variable.properties, [tail] = slice1.call(ref, -1);
      ...
      walkBody(o) {
        var assign, end, executableBody, expression, expressions, exprs, i, initializer, initializerExpression, j, k, len, len1, method, properties, pushSlice, ref, start;
        this.ctor = null;
        this.boundMethods = [];
        executableBody = null;
        initializer = [];
        ...
        for (k = 0, len1 = initializer.length; k < len1; k++) {
        ...
        if (initializer.length !== expressions.length) {
          this.body.expressions = (function() {
            var l, len2, results;
            results = [];
            for (l = 0, len2 = initializer.length; l < len2; l++) {
      ...
      declareName(o) {
        var alreadyDeclared, name, ref;
        if (!((name = (ref = this.variable) != null ? ref.unwrap() : void 0) instanceof IdentifierLiteral)) {
          return;
        }
      ...
      astNode(o) {
        var argumentsNode, jumpNode, ref;
      ...
      astProperties(o) {
        var ref, ref1, ref2, ref3;
        return {
          id: (ref = (ref1 = this.variable) != null ? ref1.ast(o) : void 0) != null ? ref : null,
          superClass: (ref2 = (ref3 = this.parent) != null ? ref3.ast(o, LEVEL_PAREN) : void 0) != null ? ref2 : null,
  ...
  exports.ExecutableClassBody = ExecutableClassBody = (function() {
    class ExecutableClassBody extends Base {
      ...
      compileNode(o) {
        var args, argumentsNode, directives, externalCtor, ident, jumpNode, klass, params, parent, ref, wrapper;
        if (jumpNode = this.body.jumps()) {
          jumpNode.error('Class bodies cannot contain pure statements');
        }
        if (argumentsNode = this.body.contains(isLiteralArguments)) {
        ...
        this.name = (ref = this.class.name) != null ? ref : o.classScope.freeVariable(this.defaultClassVariableName);
      ...
      addProperties(assigns) {
        ...
        result = (function() {
          var i, len, results;
          results = [];
          for (i = 0, len = assigns.length; i < len; i++) {
            assign = assigns[i];
    ...
    class ClassProperty extends Base {
      ...
      astProperties(o) {
        ...
        return {
          ...
          operator: (ref = (ref1 = this.operatorToken) != null ? ref1.value : void 0) != null ? ref : '=',
          staticClassName: (ref2 = (ref3 = this.staticClassName) != null ? ref3.ast(o) : void 0) != null ? ref2 : null
        };
      }
  ...
  exports.ModuleDeclaration = ModuleDeclaration = (function() {
    class ModuleDeclaration extends Base {
      ...
      astAssertions(o) {
        var ref;
        if (((ref = this.assertions) != null ? ref.properties : void 0) != null) {
  ...
  exports.ImportDeclaration = ImportDeclaration = class ImportDeclaration extends ModuleDeclaration {
    ...
    astProperties(o) {
      var ref, ref1, ret;
      ret = {
        specifiers: (ref = (ref1 = this.clause) != null ? ref1.ast(o) : void 0) != null ? ref : [],
  ...
  exports.ImportClause = ImportClause = (function() {
    class ImportClause extends Base {
      ...
      astNode(o) {
        ...
        return compact(flatten([(ref = this.defaultBinding) != null ? ref.ast(o) : void 0, (ref1 = this.namedImports) != null ? ref1.ast(o) : void 0]));
      }
  ...
  exports.ExportNamedDeclaration = ExportNamedDeclaration = class ExportNamedDeclaration extends ExportDeclaration {
    astProperties(o) {
      var clauseAst, ref, ref1, ret;
      ret = {
        source: (ref = (ref1 = this.source) != null ? ref1.ast(o) : void 0) != null ? ref : null,
        assertions: this.astAssertions(o),
        exportKind: 'value'
      };
  ...
  exports.ModuleSpecifierList = ModuleSpecifierList = (function() {
    class ModuleSpecifierList extends Base {
      ...
      compileNode(o) {
        var code, compiledList, fragments, i, index, len, specifier;
        code = [];
        o.indent += TAB;
        ...
        if (this.specifiers.length !== 0) {
          code.push(this.makeCode(`{\n${o.indent}`));
          for (index = i = 0, len = compiledList.length; i < len; index = ++i) {
      ...
      astNode(o) {
        var i, len, ref, results, specifier;
        ref = this.specifiers;
        results = [];
        for (i = 0, len = ref.length; i < len; i++) {
          specifier = ref[i];
  ...
  exports.ModuleSpecifier = ModuleSpecifier = (function() {
    class ModuleSpecifier extends Base {
      constructor(original, alias, moduleDeclarationType) {
        ...
        if (this.original.comments || ((ref = this.alias) != null ? ref.comments : void 0)) {
          this.comments = [];
          if (this.original.comments) {
            this.comments.push(...this.original.comments);
          }
          if ((ref1 = this.alias) != null ? ref1.comments : void 0) {
  ...
  exports.ImportSpecifier = ImportSpecifier = class ImportSpecifier extends ModuleSpecifier {
    ...
    addIdentifierToScope(o) {
      ...
      if ((ref = this.identifier, indexOf.call(o.importedSymbols, ref) >= 0) || o.scope.check(this.identifier)) {
    ...
    astProperties(o) {
      var originalAst, ref, ref1;
      originalAst = this.original.ast(o);
      return {
        imported: originalAst,
        local: (ref = (ref1 = this.alias) != null ? ref1.ast(o) : void 0) != null ? ref : originalAst,
        importKind: null
      };
    }
  ...
  exports.ExportSpecifier = ExportSpecifier = class ExportSpecifier extends ModuleSpecifier {
    ...
    astProperties(o) {
      ...
      return {
        local: originalAst,
        exported: (ref = (ref1 = this.alias) != null ? ref1.ast(o) : void 0) != null ? ref : originalAst
      };
    }
  ...
  exports.DynamicImportCall = DynamicImportCall = class DynamicImportCall extends Call {
    ...
    checkArguments() {
      var ref;
      if (!((1 <= (ref = this.args.length) && ref <= 2))) {
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileNode(o) {
        var answer, compiledName, isValue, name, properties, prototype, ref, ref1, ref2, ref3, val;
        ...
        if (this.value instanceof Code) {
          ...
          } else if (((ref1 = this.variable.properties) != null ? ref1.length : void 0) >= 2) {
            ref2 = this.variable.properties, [...properties] = ref2, [prototype, name] = splice.call(properties, -2);
            if (((ref3 = prototype.name) != null ? ref3.value : void 0) === 'prototype') {
      ...
      compileDestructuring(o) {
        ...
        loopObjects = (objs, vvar, vvarTxt) => {
          var acc, i, idx, j, len, message, results, vval;
          results = [];
          for (i = j = 0, len = objs.length; j < len; i = ++j) {
            obj = objs[i];
            if (obj instanceof Elision) {
      ...
      propagateLhs() {
        var ref, ref1;
        if (!(((ref = this.variable) != null ? typeof ref.isArray === "function" ? ref.isArray() : void 0 : void 0) || ((ref1 = this.variable) != null ? typeof ref1.isObject === "function" ? ref1.isObject() : void 0 : void 0))) {
          return;
        }
      ...
      isConditional() {
        var ref;
        return (ref = this.context) === '||=' || ref === '&&=' || ref === '?=';
      }
      ...
      astProperties(o) {
        ...
        if (!this.isDefaultAssignment()) {
          ret.operator = (ref = this.originalContext) != null ? ref : '=';
        }
        return ret;
      }
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      constructor(params, body, funcGlyph, paramStart) {
        ...
        this.bound = ((ref = this.funcGlyph) != null ? ref.glyph : void 0) === '=>';
      ...
      makeScope(parentScope) {
        return new Scope(parentScope, this.body, this, this.referencedVars);
      }
      ...
      compileNode(o) {
        ...
        if (paramsAfterSplat.length !== 0) {
          ...
          exprs.unshift(new Assign(new Value(new Arr([
            ...
            results;
              results = [];
              for (k = 0, len1 = paramsAfterSplat.length; k < len1; k++) {
        ...
        answer = this.joinFragmentArrays((function() {
          var len3, n, results;
          results = [];
          for (n = 0, len3 = modifiers.length; n < len3; n++) {
            m = modifiers[n];
      ...
      disallowLoneExpansionAndMultipleSplats() {
        var i, len, param, ref, results, seenSplatParam;
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if (param.splat || param instanceof Expansion) {
            ...
            results.push(seenSplatParam = true);
          } else {
            results.push(void 0);
          }
        }
      ...
      expandCtorSuper(thisAssignments) {
        var haveThisParam, param, ref, seenSuper;
        if (!this.ctor) {
          return false;
        }
        seenSuper = this.eachSuperCall(this.body, (superCall) => {
        ...
        haveThisParam = thisAssignments.length && thisAssignments.length !== ((ref = this.thisAssignments) != null ? ref.length : void 0);
      ...
      propagateLhs() {
        var i, len, name, param, ref, results;
        ref = this.params;
        results = [];
        for (i = 0, len = ref.length; i < len; i++) {
          param = ref[i];
      ...
      methodAstProperties(o) {
        var getIsComputed, ref, ref1, ref2, ref3;
        getIsComputed = () => {
        ...
        return {
          ...
          operator: (ref = (ref1 = this.operatorToken) != null ? ref1.value : void 0) != null ? ref : '=',
          staticClassName: (ref2 = (ref3 = this.isStatic.staticClassName) != null ? ref3.ast(o) : void 0) != null ? ref2 : null,
          bound: !!this.bound
        };
      }
      ...
      astProperties(o) {
        ...
        return Object.assign({
          ...
          id: null,
          hasIndentedBody: this.body.locationData.first_line > ((ref = this.funcGlyph) != null ? ref.locationData.first_line : void 0)
  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      ...
      eachName(iterator, name = this.name) {
        var atParam, checkAssignabilityOfLiteral, i, len, nObj, node, obj, ref, ref1;
        ...
        ref1 = (ref = name.objects) != null ? ref : [];
        for (i = 0, len = ref1.length; i < len; i++) {
          obj = ref1[i];
          // Save original obj.
          nObj = obj;
  ...
  exports.Splat = Splat = (function() {
    class Splat extends Base {
      constructor(name, {lhs, postfix: postfix = true} = {}) {
        super();
        this.lhs = lhs;
      ...
      propagateLhs(setLhs) {
        ...
        return typeof (base = this.name).propagateLhs === "function" ? base.propagateLhs(true) : void 0;
      }
  ...
  exports.While = While = (function() {
    class While extends Base {
      ...
      jumps() {
        var expressions, i, jumpNode, len, node;
        ({expressions} = this.body);
      ...
      astProperties(o) {
        ...
        return {
          ...
          body: this.body.ast(o, LEVEL_TOP),
          guard: (ref = (ref1 = this.guard) != null ? ref1.ast(o) : void 0) != null ? ref : null,
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      constructor(op, first, second, flip, {invertOperator, originalOperator: originalOperator = op} = {}) {
        var call, firstCall, message, ref, unwrapped;
        super();
      ...
      isNumber() {
        var ref;
        return this.isUnary() && ((ref = this.operator) === '+' || ref === '-') && this.first instanceof Value && this.first.isNumber();
      }
      ...
      isYield() {
        var ref;
        return (ref = this.operator) === 'yield' || ref === 'yield*';
      }
      ...
      isChainable() {
        var ref;
        return (ref = this.operator) === '<' || ref === '>' || ref === '>=' || ref === '<=' || ref === '===' || ref === '!==';
      }
      ...
      invert() {
        var allInvertable, curr, fst, op, ref;
        ...
        if (this.isChain()) {
          ...
          return new Parens(this).invert();
        } else if (this.operator === '!' && (fst = this.first.unwrap()) instanceof Op && ((ref = fst.operator) === '!' || ref === 'in' || ref === 'instanceof')) {
          return fst;
        } else {
          return new Op('!', this);
        }
      ...
      unfoldSoak(o) {
        var ref;
        return ((ref = this.operator) === '++' || ref === '--' || ref === 'delete') && unfoldSoak(o, this, 'first');
      }

      generateDo(exp) {
        var call, func, i, len, param, passedParams, ref, ref1;
        passedParams = [];
      ...
      checkContinuation(o) {
        ...
        if (((ref = o.scope.method) != null ? ref.bound : void 0) && o.scope.method.isGenerator) {
      ...
      astProperties(o) {
        var argument, firstAst, operatorAst, ref, secondAst;
        if (this.isChain()) {
          return this.chainAstProperties(o);
        }
        firstAst = this.first.ast(o, LEVEL_OP);
        secondAst = (ref = this.second) != null ? ref.ast(o, LEVEL_OP) : void 0;
  ...
  exports.In = In = (function() {
    class In extends Base {
      ...
      compileNode(o) {
        var hasSplat, i, len, obj, ref;
        if (this.array instanceof Value && this.array.isArray() && this.array.base.objects.length) {
          ref = this.array.base.objects;
          for (i = 0, len = ref.length; i < len; i++) {
            obj = ref[i];
            if (!(obj instanceof Splat)) {
              continue;
      ...
      compileOrTest(o) {
        var cmp, cnj, i, item, j, len, ref, ref1, sub, tests;
  ...
  exports.Try = Try = (function() {
    class Try extends Base {
      ...
      jumps(o) {
        var ref;
        return this.attempt.jumps(o) || ((ref = this.catch) != null ? ref.jumps(o) : void 0);
      }

      makeReturn(results, mark) {
        var ref, ref1;
        if (mark) {
          if ((ref = this.attempt) != null) {
            ref.makeReturn(results, mark);
          }
          if ((ref1 = this.catch) != null) {
            ref1.makeReturn(results, mark);
          }
          return;
        }
      ...
      astProperties(o) {
        ...
        return {
          ...
          handler: (ref = (ref1 = this.catch) != null ? ref1.ast(o) : void 0) != null ? ref : null,
  ...
  exports.Catch = Catch = (function() {
    class Catch extends Base {
      constructor(recovery, errorVariable) {
        ...
        if ((ref = this.errorVariable) != null) {
          if (typeof (base = ref.unwrap()).propagateLhs === "function") {
            base.propagateLhs(true);
          }
        }
      }
      ...
      astProperties(o) {
        var ref, ref1;
        return {
          param: (ref = (ref1 = this.errorVariable) != null ? ref1.ast(o) : void 0) != null ? ref : null,
  ...
  exports.Parens = Parens = (function() {
    class Parens extends Base {
      ...
      compileNode(o) {
        var bare, expr, fragments, ref, shouldWrapComment;
        ...
        shouldWrapComment = (ref = expr.comments) != null ? ref.some(function(comment) {
    ...
    class StringWithInterpolations extends Base {
      ...
      extractElements(o, {includeInterpolationWrappers, isJsx} = {}) {
        ...
        expr.traverseChildren(false, (node) => {
          var comment, commentPlaceholder, empty, i, j, len, len1, ref, ref1, ref2, unwrapped;
          if (node instanceof StringLiteral) {
            ...
            if (salvagedComments.length !== 0) {
              for (i = 0, len = salvagedComments.length; i < len; i++) {
                comment = salvagedComments[i];
                comment.unshift = true;
                comment.newLine = true;
              }
              attachCommentsToNode(salvagedComments, node);
            }
            if ((unwrapped = (ref = node.expression) != null ? ref.unwrapAll() : void 0) instanceof PassthroughLiteral && unwrapped.generated && !(isJsx && o.compiling)) {
              if (o.compiling) {
              ...
              if (node.comments) {
                ((ref1 = node.expression) != null ? ref1.comments != null ? ref1.comments : ref1.comments = [] : void 0).push(...node.comments);
              }
      ...
      compileNode(o) {
        var code, element, elements, fragments, i, len, ref, unquotedElementValue, wrapped;
        if (this.comments == null) {
          this.comments = (ref = this.startQuote) != null ? ref.comments : void 0;
        }
        if (this.jsxAttribute) {
      ...
      astProperties(o) {
        var element, elements, emptyInterpolation, expression, expressions, i, index, last, len, node, quasis;
        elements = this.extractElements(o, {
          includeInterpolationWrappers: true
        });
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      isAwait() {
        var ref;
        return (ref = this.await) != null ? ref : false;
      }

      addBody(body) {
        var base, expressions;
        this.body = Block.wrap([body]);
        ({expressions} = this.body);
        if (expressions.length) {
          if ((base = this.body).locationData == null) {
            base.locationData = mergeLocationData(expressions[0].locationData, expressions[expressions.length - 1].locationData);
          }
        }
        return this;
      }
      ...
      addSource(source) {
        var attr, attribs, attribute, base, i, j, len, len1, ref, ref1, ref2, ref3;
        ({source: this.source = false} = source);
        attribs = ["name", "index", "guard", "step", "own", "ownTag", "await", "awaitTag", "object", "from"];
        for (i = 0, len = attribs.length; i < len; i++) {
          attr = attribs[i];
          this[attr] = (ref = source[attr]) != null ? ref : this[attr];
        }
        if (!this.source) {
          return this;
        }
        ...
        if (this.pattern) {
          if (typeof (base = this.name.unwrap()).propagateLhs === "function") {
            base.propagateLhs(true);
          }
        }
      ...
      astNode(o) {
        ...
        if ((ref = this.name) != null) {
          ref.eachName(addToScope, {
            checkAssignability: false
          });
        }
        if ((ref1 = this.index) != null) {
      ...
      astProperties(o) {
        ...
        return {
          source: (ref = this.source) != null ? ref.ast(o) : void 0,
          body: this.body.ast(o, LEVEL_TOP),
          guard: (ref1 = (ref2 = this.guard) != null ? ref2.ast(o) : void 0) != null ? ref1 : null,
          name: (ref3 = (ref4 = this.name) != null ? ref4.ast(o) : void 0) != null ? ref3 : null,
          index: (ref5 = (ref6 = this.index) != null ? ref6.ast(o) : void 0) != null ? ref5 : null,
          step: (ref7 = (ref8 = this.step) != null ? ref8.ast(o) : void 0) != null ? ref7 : null,
          postfix: !!this.postfix,
          own: !!this.own,
          await: !!this.await,
          style: (function() {
    ...
    For.prototype.children = ['body', 'name', 'index', 'source', 'guard', 'step'];
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      jumps(o = {
        ...
        var block, i, jumpNode, len, ref, ref1;
        ref = this.cases;
        for (i = 0, len = ref.length; i < len; i++) {
          ({block} = ref[i]);
        ...
        return (ref1 = this.otherwise) != null ? ref1.jumps(o) : void 0;
      }

      makeReturn(results, mark) {
        var block, i, len, ref, ref1;
        ref = this.cases;
        for (i = 0, len = ref.length; i < len; i++) {
          ({block} = ref[i]);
      ...
      compileNode(o) {
        var block, body, cond, conditions, expr, fragments, i, idt1, idt2, j, k, len, len1, ref, ref1;
        idt1 = o.indent + TAB;
        idt2 = o.indent = idt1 + TAB;
        fragments = [].concat(this.makeCode(this.tab + "switch ("), (this.subject ? this.subject.compileToFragments(o, LEVEL_PAREN) : this.makeCode("false")), this.makeCode(") {\n"));
        ref = this.cases;
        for (i = j = 0, len = ref.length; j < len; i = ++j) {
          ({conditions, block} = ref[i]);
          ref1 = flatten([conditions]);
          for (k = 0, len1 = ref1.length; k < len1; k++) {
            cond = ref1[k];
            if (!this.subject) {
              cond = cond.invert();
      ...
      casesAst(o) {
        var caseIndex, caseLocationData, cases, consequent, i, j, k, kase, lastTestIndex, len, len1, len2, ref, ref1, results, test, testConsequent, testIndex, tests;
        cases = [];
        ref = this.cases;
        for (caseIndex = i = 0, len = ref.length; i < len; caseIndex = ++i) {
          kase = ref[caseIndex];
          ({
            conditions: tests,
            block: consequent
          ...
          for (testIndex = j = 0, len1 = tests.length; j < len1; testIndex = ++j) {
        ...
        if ((ref1 = this.otherwise) != null ? ref1.expressions.length : void 0) {
          cases.push(new SwitchCase(null, this.otherwise).withLocationDataFrom(this.otherwise));
        }
        results = [];
        for (k = 0, len2 = cases.length; k < len2; k++) {
          kase = cases[k];
      ...
      astProperties(o) {
        var ref, ref1;
        return {
          discriminant: (ref = (ref1 = this.subject) != null ? ref1.ast(o, LEVEL_PAREN) : void 0) != null ? ref : null,
  ...
  SwitchCase = (function() {
    class SwitchCase extends Base {
      ...
      astProperties(o) {
        var ref, ref1, ref2, ref3;
        return {
          test: (ref = (ref1 = this.test) != null ? ref1.ast(o, LEVEL_PAREN) : void 0) != null ? ref : null,
          consequent: (ref2 = (ref3 = this.block) != null ? ref3.ast(o, LEVEL_TOP).body : void 0) != null ? ref2 : [],
  ...
  exports.If = If = (function() {
    class If extends Base {
      ...
      isStatement(o) {
        var ref;
        return (o != null ? o.level : void 0) === LEVEL_TOP || this.bodyNode().isStatement(o) || ((ref = this.elseBodyNode()) != null ? ref.isStatement(o) : void 0);
      }
      ...
      makeReturn(results, mark) {
        var ref, ref1;
        if (mark) {
          if ((ref = this.body) != null) {
            ref.makeReturn(results, mark);
          }
          if ((ref1 = this.elseBody) != null) {
            ref1.makeReturn(results, mark);
          }
          return;
        }
      ...
      astProperties(o) {
        var isStatement, ref, ref1, ref2, ref3;
        ...
        return {
          ...
          alternate: this.isChain ? this.elseBody.unwrap().ast(o, isStatement ? LEVEL_TOP : LEVEL_COND) : !isStatement && ((ref = this.elseBody) != null ? (ref1 = ref.expressions) != null ? ref1.length : void 0 : void 0) === 1 ? this.elseBody.expressions[0].ast(o, LEVEL_TOP) : (ref2 = (ref3 = this.elseBody) != null ? ref3.ast(o, LEVEL_TOP) : void 0) != null ? ref2 : null,
          postfix: !!this.postfix,
  ...
  indentInitial = function(fragments, node) {
    var fragment, fragmentIndex, i, len;
    for (fragmentIndex = i = 0, len = fragments.length; i < len; fragmentIndex = ++i) {
      fragment = fragments[fragmentIndex];
      if (fragment.isHereComment) {
  ...
  unshiftAfterComments = function(fragments, fragmentToInsert) {
    var fragment, fragmentIndex, i, inserted, len;
    inserted = false;
    for (fragmentIndex = i = 0, len = fragments.length; i < len; fragmentIndex = ++i) {
      fragment = fragments[fragmentIndex];

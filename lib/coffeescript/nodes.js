...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, makeDelimitedLiteral, normalizeStringObject} = require('./helpers'));
    ...
    class Op extends Base {
      ...
      compileNode(o) {
        ...
        if (this.originalOperator === 'in') {
          return new In(this.first, this.second).compileNode(o);
        }
  ...
  exports.Parens = Parens = (function() {
    class Parens extends Base {
      ...
      compileNode(o) {
        ...
        bare = o.level < LEVEL_OP && !shouldWrapComment && (expr instanceof Op && expr.originalOperator !== 'in' || expr.unwrap() instanceof Call || (expr instanceof For && expr.returns)) && (o.level < LEVEL_COND || fragments.length <= 3);

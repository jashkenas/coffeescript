...
(function() {
  ...
  //### ParamStart
  exports.ParamStart = ParamStart = class ParamStart extends Base {
    constructor() {
      super();
    }
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      // function body.
      compileNode(o) {
        var answer, body, boundMethodCheck, comment, condition, exprs, generatedVariables, haveBodyParam, haveSplatParam, i, ifTrue, j, k, l, len1, len2, len3, len4, m, methodScope, modifiers, name, param, paramNames, paramToAddToScope, params, paramsAfterSplat, q, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, scopeVariablesCount, signature, splatParamName, thisAssignments, wasEmpty;
        if (this.ctor) {
          if (this.isAsync) {
        ...
        answer = this.joinFragmentArrays((function() {
          var len5, r, results;
          results = [];
          for (r = 0, len5 = modifiers.length; r < len5; r++) {
            m = modifiers[r];

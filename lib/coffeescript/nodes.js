        ...
        for (k = 0, len2 = initializer.length; k < len2; k++) {
          ...
          if (method instanceof Code) {
            if (method.ctor) {
              ...
              method.constructorName = this.name;
            }
          }
        }
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
        ...
        if (this.isMethod && this.bound && !this.isStatic && this.constructorName) {
          _boundMethodCheck = new Value(new Literal(utility('_boundMethodCheck', o)));
          this.body.expressions.unshift(new Call(_boundMethodCheck, [new Value(new ThisLiteral), new Value(new Literal(this.constructorName))]));
        }

...
// multiline need to be indented.
  ...
  exports.ImportMeta = ImportMeta = (function() {
    class ImportMeta extends Literal {
      constructor(value, meta) {
        super(value);
        this.meta = meta;
        if (this.meta && this.meta.value.value !== 'meta') {
          this.error(`\"${this.meta.value.value}\" is not a valid import attribute.`);
        }
      }
    ...
    ImportMeta.prototype.isAssignable = YES;

    ...
    class Obj extends Base {
      ...
      hasSplat() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (prop instanceof Assign && prop.value instanceof Obj) {
            return prop.value.hasSplat;
          }
        }
        return false;
      }
      ...
      compileObjectDestruct(o) {
        ...
        getPropValue = function(prop) {
          ...
          wrapInQutes = function(prop) {
            return (new Literal(`'${prop.compile(o)}'`)).compile(o);
          };
          setScopeVar(prop);
          if (prop instanceof Assign) {
        ...
        traverseRest = function(properties, path = []) {
          var j, key, len1, p, prop, restElement, results;
          results = [];
          restElement = false;
          ...
          if (restElement) {
            ...
            restElement["excludeProps"] = new Literal(`[${(function() {
              ...
              for (k = 0, len2 = properties.length; k < len2; k++) {
                prop = properties[k];
                results1.push(getPropValue(prop));
              }
              return results1;
            })()}]`);

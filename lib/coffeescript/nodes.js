...
(function() {
  ...
  exports.CodeFragment = CodeFragment = class CodeFragment {
    ...
    toString() {
      return `${      // This is only intended for debugging.
this.code}${(this.locationData ? ": " + locationDataToString(this.locationData) : '')}`;
    }
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      attachComments(o, node, fragments) {
        var base1, base2, comment, commentFragment, fragment, fragmentIndex, j, len1, ref1, results;
        ref1 = node.comments;
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          // have been added.
          this.attachedComments.push(comment); // Don’t output this comment twice.
          if (comment.here) { // Comment delimited by `###`.
            ...
            if (comment.unshift) {
              results.push((function() {
                var k, len2, results1;
                results1 = [];
                for (fragmentIndex = k = 0, len2 = fragments.length; k < len2; fragmentIndex = ++k) {
              ...
              results.push(fragments.push(commentFragment)); // Line comment, delimited by `#`.
            }
          } else {
            ...
            if (comment.unshift) {
              ...
              results.push(fragments[0].precedingComments.push(commentFragment));
            } else {
              if ((base2 = fragments[fragments.length - 1]).followingComments == null) {
                base2.followingComments = [];
              }
              results.push(fragments[fragments.length - 1].followingComments.push(commentFragment));
            }
          }
        }
        return results;
      ...
      lastNonComment(list) {
        ...
        i = list.length;
        while (i--) {
          if (!(list[i] instanceof HereComment)) {
            return list[i];
          }
        }
        return null;
    ...
    class Block extends Base {
      ...
      makeReturn(res) {
        ...
        while (len--) {
          ...
          if (!(expr instanceof HereComment)) {
        ...
        for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
          ...
          if (node instanceof Block) {
            ...
            if (!node.isStatement(o)) {
              ...
              if (!(lastFragment.code === '' || lastFragment.type === 'HereComment')) {
        ...
        if (!o.bare) {
          preludeExps = (function() {
            ...
            for (i = k = 0, len2 = ref3.length; k < len2; i = ++k) {
              exp = ref3[i];
              if (!(exp.unwrap() instanceof HereComment)) {
                break;
              }
              results.push(exp);
            }
      ...
      compileWithDeclarations(o) {
        ...
        for (i = j = 0, len1 = ref1.length; j < len1; i = ++j) {
          exp = ref1[i];
          exp = exp.unwrap();
          if (!(exp instanceof HereComment || exp instanceof Literal)) {
            break;
          }
        }
        o = merge(o, {
  ...
  exports.Literal = Literal = (function() {
    class Literal extends Base {
      ...
      toString() {
        return ` ${        // This is only intended for debugging.
(this.isStatement() ? super.toString() : this.constructor.name)}: ${this.value}`;
      }
      ...
      compileNode(o) {
        ...
        if (this.expression) {
          ...
          for (i = j = 0, len1 = fragments.length; j < len1; i = ++j) {
            fragment = fragments[i];
            if ((fragment != null ? fragment.type : void 0) === 'HereComment' && indexOf.call(fragment.code, '\n') >= 0) {
  ...
  exports.HereComment = HereComment = class HereComment extends Base {
    ...
    compileNode(o) {
      var hasLeadingMarks, j, largestIndent, leadingWhitespace, len1, line, multiline, ref1;
      ...
      return this.makeCode(this.content);
    }
    ...
    class Obj extends Base {
      ...
      compileNode(o) {
        ...
        for (l = 0, len3 = ref1.length; l < len3; l++) {
          prop = ref1[l];
          if (prop instanceof HereComment || (prop instanceof Assign && prop.context === 'object' && !this.csx)) {
            isCompact = false;
          }
        }
        answer = [];
        ...
        for (i = q = 0, len4 = props.length; q < len4; i = ++q) {
          prop = props[i];
          join = i === props.length - 1 ? '' : isCompact && this.csx ? ' ' : isCompact ? ', ' : prop === lastNoncom || prop instanceof HereComment || this.csx ? '\n' : ',\n';
          indent = isCompact || prop instanceof HereComment ? '' : idt;
          key = prop instanceof Assign && prop.context === 'object' ? prop.variable : prop instanceof Assign ? (!this.lhs ? prop.operatorToken.error(`unexpected ${prop.operatorToken.value}`) : void 0, prop.variable) : !(prop instanceof HereComment) ? prop : void 0;
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      addInitializerExpression(node) {
        switch (false) {
          case !(node instanceof HereComment):
            return node;
    ...
    class ExecutableClassBody extends Base {
      ...
      walkBody() {
        ...
        while (expr = this.body.expressions[index]) {
          if (!(expr instanceof HereComment || expr instanceof Value && expr.isString())) {
            break;
          }
          if (expr.hoisted) {
            index++;
      ...
      constructor(original, alias, moduleDeclarationType1) {
        ...
        if (this.original.comments || ((ref1 = this.alias) != null ? ref1.comments : void 0)) {
          ...
          if (this.original.comments) {
            this.comments = this.comments.concat(this.original.comments);
          }
          if ((ref2 = this.alias) != null ? ref2.comments : void 0) {
            this.comments = this.comments.concat(this.alias.comments);
          }
        }

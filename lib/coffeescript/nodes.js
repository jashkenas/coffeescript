...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes} = require('./helpers'));
  ...
  exports.Parens = Parens = (function() {
    class Parens extends Base {
      ...
      compileNode(o) {
        ...
        bare = o.level < LEVEL_OP && !shouldWrapComment && (expr instanceof Op && !expr.isInExpression() || expr.unwrap() instanceof Call || (expr instanceof For && expr.returns)) && (o.level < LEVEL_COND || fragments.length <= 3);

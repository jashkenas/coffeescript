...
(function() {
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      findReferencedVars(scopes) {
        return this.eachChild(function(child) {
          return child.findReferencedVars(scopes);
        });
      }
  ...
  exports.Root = Root = (function() {
    class Root extends Base {
      ...
      findReferencedVars(scopes = []) {
        return super.findReferencedVars(scopes.concat(this));
      }
  ...
  exports.IdentifierLiteral = IdentifierLiteral = (function() {
    class IdentifierLiteral extends Literal {
      ...
      findReferencedVars(scopes) {
        var i, len, results, scope;
        results = [];
        for (i = 0, len = scopes.length; i < len; i++) {
          scope = scopes[i];
          results.push(scope.referencedVars.add(this.value));
        }
        return results;
      }

  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      makeReturn(res) {
        ...
        if (len > 1) {
          ref1 = this.expressions, [penult, last] = slice1.call(ref1, -2);
          penult = penult.unwrap();
          last = last.unwrap();
          if (penult instanceof Call && penult.csx && last instanceof Call && last.csx) {
            this.expressions[len - 1].error('Adjacent JSX elements must be wrapped in an enclosing tag');
          }
        }
        while (len--) {

          ...
          if (children = this[attr]) {
            if (Array.isArray(children)) {
              for (i = k = 0, len2 = children.length; k < len2; i = ++k) {
                child = children[i];
                if (match(child)) {
                  splice1.apply(children, [i, i - i + 1].concat(ref2 = replacement(child, this))), ref2;
                  return true;
                } else {
    ...
    static expand(fragments) {
      ...
      for (i = j = fragments.length - 1; j >= 0; i = j += -1) {
        ...
        if (fragment.fragments) {
          splice1.apply(fragments, [i, i - i + 1].concat(ref1 = this.expand(fragment.fragments))), ref1;
        }
      }
      return fragments;
    }
      ...
      walkBody() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (expression instanceof Value && expression.isObject(true)) {
            ...
            pushSlice();
            splice1.apply(expressions, [i, i - i + 1].concat(exprs)), exprs;
            i += exprs.length;
          } else {
    ...
    class Assign extends Base {
      ...
      compileNode(o) {
        ...
        if (this.value instanceof Code) {
          if (this.value.isStatic) {
            ...
            ref4 = this.variable.properties, [...properties] = ref4, [prototype, name] = splice1.call(properties, -2);
      ...
      compileDestructuring(o) {
        ...
        compSplice = function(vvar, start, end = false) {
          ...
          return new Value(new Call(splice, args));
        };

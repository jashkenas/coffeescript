...
(function() {
      ...
      compileNode(o) {
        ...
        for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
          ...
          if (node instanceof Block) {
            ...
            if (!(node.isStatement(o) || node instanceof Comment || (node instanceof HoistTarget && node.source instanceof Comment))) {
  ...
  exports.Comment = Comment = (function() {
    ...
    Comment.prototype.isStatement = NO;
    ...
    class Arr extends Base {
      ...
      compileNode(o) {
        ...
        for (index = k = 0, len2 = compiledObjs.length; k < len2; index = ++k) {
          ...
          if (fragments[0].type !== 'Comment') {
            answer.push(...fragments);
            if (index !== compiledObjs.length - 1) {
              answer.push(this.makeCode(', '));
            }
          } else {
            answer = answer.concat([this.makeCode(`\n${o.indent}`), ...fragments, this.makeCode('\n')]);
          }
        }
  ...
  exports.If = If = (function() {
    class If extends Base {
      ...
      compileExpression(o) {
        ...
        if (this.bodyNode() instanceof Comment) {
          body.push(this.makeCode('void 0'));
        }
        if (this.elseBodyNode() instanceof Comment) {
          alt.push(this.makeCode('void 0'));
        }

...
(function() {
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      compileClassDeclaration(o) {
        ...
        o.indent += TAB;
        result = [];
        if (this.assignParentRef) {
          result.push(this.makeCode("("));
          result.push(...this.assignParentRef.compileToFragments(o));
          result.push(this.makeCode(", "));
        }
      ...
      setParentRef(o) {
        var ref, ref1;
        if (this._setParentRef) {
          return;
        }
        this._setParentRef = true;
        if ((ref1 = this.parent) != null ? ref1.shouldCache() : void 0) {
          ref = new IdentifierLiteral(o.scope.freeVariable('ref'));
          this.assignParentRef = new Assign(ref, this.parent);
        ...
        for (k = 0, len2 = initializer.length; k < len2; k++) {
          ...
          if (method instanceof Code) {
            if (method.ctor) {
              ...
              this.setParentRef(o);
              method.parentClass = this.parent;
            }
          }
        }
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
        var _boundMethodCheck, answer, body, condition, exprs, haveBodyParam, haveSplatParam, i, ifTrue, j, k, len1, len2, m, methodScope, modifiers, name, param, paramNames, params, paramsAfterSplat, ref, ref1, ref2, ref3, ref4, ref5, signature, splatParamName, thisAssignments, wasEmpty;
        if (this.ctor) {
          if (this.isAsync) {
        ...
        if (this.isMethod && this.bound && !this.isStatic && this.parentClass) {
          _boundMethodCheck = new Value(new Literal(utility('_boundMethodCheck', o)));
          this.body.expressions.unshift(new Call(_boundMethodCheck, [new Value(new ThisLiteral), this.parentClass]));
        }

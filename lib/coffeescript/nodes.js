    ...
    class Call extends Base {
      ...
      updateLocationDataIfMissing(locationData) {
        ...
        if (this.locationData && this.needsUpdatedStartLocation) {
          ...
          this.locationData.range = [locationData.range[0], this.locationData.range[1]];
          ...
          if (base.needsUpdatedStartLocation) {
            ...
            this.variable.locationData.range = [locationData.range[0], this.variable.locationData.range[1]];
    ...
    class Op extends Base {
      constructor(op, first, second, flip, {invertOperator, originalOperator: originalOperator = op} = {}) {
        ...
        if (op === 'new') {
          ...
          if (unwrapped instanceof Op && unwrapped.operator === 'do') {
      ...
      checkUpdateAssignability() {
        ...
        if ((ref1 = this.operator) === '--' || ref1 === '++') {
          ...
          if (message) {
            return this.first.error(message);
          }
        }
      }
      ...
      astChildren(o) {
        ...
        firstAst = this.first.toAst(o, LEVEL_OP);
        secondAst = (ref1 = this.second) != null ? ref1.toAst(o, LEVEL_OP) : void 0;
        switch (false) {

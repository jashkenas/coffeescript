  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileObjectDestruct(o) {
        var fragments, getPropKey, getPropName, j, len1, restElement, restElements, setScopeVar, traverseRest, value, valueRef;
            ...
            if (prop instanceof Assign) {
              ...
              if (nestedProperties) {
                ...
                if (nestedSourceDefault) {
                  nestedSource = new Op('?', nestedSource, nestedSourceDefault);
                }
        ...
        fragments = [this.wrapInParentheses(this.compileToFragments(o, LEVEL_TOP))];

  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileObjectDestruct(o) {
        var answers, extractKeys, j, len1, objects, prop, ref, restElement, restList, traverseRest, val, varProp, vvarPropText, vvarText;
          ...
          if (restElement) {
            ...
            excludeProps = (function() {
              ...
              for (k = 0, len2 = objects.length; k < len2; k++) {
                obj = objects[k];
                results1.push(obj instanceof Assign ? obj.variable.unwrap().value : obj.unwrap().value);
              }
              return results1;
            })();
            excludeProps = (function() {

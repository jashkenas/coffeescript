  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compilePatternMatch(o) {
        var acc, assigns, code, defaultValue, expandedIdx, fragments, hasSplat, i, idx, isObject, ivar, j, len1, message, name, nlitArr, nonSplatKeys, obj, objects, olen, ref, ref3, ref4, ref5, ref6, refVar, rest, splatKey, splatObj, top, ts, val, value, vvar, vvarSplatText, vvarText;
        top = o.level === LEVEL_TOP;
        value = this.value;
        ...
        if (hasSplat && splatKey) {
          nlitArr = new Arr(nonSplatKeys);
          refVar = this.makeCode(`${(ref = o.scope.freeVariable('ref'))}`);
          vvarSplatText = ref;
          splatObj = new IdentifierLiteral(ref);
          assigns.push(new Assign(splatObj, nlitArr, null, {
            param: this.param,
            subpattern: true
          }).compileToFragments(o, LEVEL_LIST));
          ts = `Object.keys(${vvarText}).reduce((a,c) => {if (${vvarSplatText}.indexOf(c) == -1) a[c] = ${vvarText}[c]; return a;}, {})`;
          assigns.push(new Assign(splatKey, new Literal(ts), null, {
            param: this.param,
            subpattern: true
          }).compileToFragments(o, LEVEL_LIST));
        }

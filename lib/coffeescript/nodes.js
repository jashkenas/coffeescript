    ...
    class Obj extends Base {
      ...
      checkForMultipleSplats() {
        ...
        if ((splatProps != null ? splatProps.length : void 0) > 1) {
          return props[splatProps[1]].error("multiple spread elements are disallowed");
        }
      }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      disallowMultipleSplats() {
        ...
        if (splatsAndExpans.length > 1) {
          // Sort 'splatsAndExpans' so we can show error at first disallowed token.
          return objects[splatsAndExpans.sort()[1]].error("multiple splats/expansions are disallowed in an assignment");
        }
      }
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      disallowLoneExpansionAndMultipleSplats() {
        var haveSplatParam, i, j, len1, param, ref1, results1;
        haveSplatParam = false;
        ref1 = this.params;
        results1 = [];
        for (i = j = 0, len1 = ref1.length; j < len1; i = ++j) {
          ...
          if (param.splat || param instanceof Expansion) {
            ...
            results1.push(haveSplatParam = true);
          } else {
            results1.push(void 0);
          }
        }

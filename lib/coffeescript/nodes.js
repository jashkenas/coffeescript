    ...
    class Assign extends Base {
      ...
      compileNode(o) {
        ...
        if (isValue) {
          ...
          if (this.variable.base instanceof PropertyName && this.value.base instanceof Obj) {
            this.value.base.lhs = true;
          }
        ...
        if (o.level > LEVEL_LIST || (o.level < LEVEL_LIST && isValue && this.variable.base instanceof Obj && !this.param)) {
          return this.wrapInParentheses(answer);
        } else {
          return answer;
        }
        ...
        traverseRest = function(properties, path = []) {
          ...
          for (key = j = 0, len1 = properties.length; j < len1; key = ++j) {
            ...
            if (prop instanceof Assign) {
              ...
              if (prop.value instanceof Assign && prop.value.variable.isObject()) {

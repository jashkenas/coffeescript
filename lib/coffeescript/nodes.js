...
(function() {
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      compileToFragments(o, lvl) {
        ...
        if (node.comments) {
          this.compileComments(o, node, fragments);
        }
        return fragments;
      }
      ...
      compileComments(o, node, fragments) {
        var code, comment, commentFragment, hasLeadingMarks, j, k, largestIndent, leadingWhitespace, len1, len2, line, multiline, ref1, ref2, results;
        ref1 = node.comments;
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (comment.here) {
            ...
            if (comment.unshift) {
              results.push(fragments.unshift(commentFragment));
            } else {
        ...
        for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
          ...
          if (node instanceof Block) {
            ...
            if (!node.isStatement(o)) {
              ...
              if (lastFragment.code !== '') {
                fragments.unshift(this.makeCode(`${this.tab}`));
                if (!lastFragment.suppressTrailingSemicolon) {
  ...
  exports.Return = Return = (function() {
    class Return extends Base {
      ...
      compileNode(o) {
        var answer, fragments;
        answer = [];
        if (this.expression) {
          fragments = this.expression.compileToFragments(o, LEVEL_PAREN);
          if (fragments[0].comment && indexOf.call(fragments[0].code, '\n') >= 0) {
            fragments[0].code = this.tab + fragments[0].code;
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
        ...
        answer.push(this.makeCode('}'));
        if (this.isMethod) {
          return indentFirstNonCommentLine(answer, this);
        }
  ...
  indentFirstNonCommentLine = function(fragments, node) {
    var fragment, i, j, len1, ref1;
    for (i = j = 0, len1 = fragments.length; j < len1; i = ++j) {
      fragment = fragments[i];
      if (!(!((ref1 = fragment.comment) != null ? ref1.newLine : void 0))) {
        continue;
      }

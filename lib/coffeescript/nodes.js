...
(this.isStatement() ? super.toString() : this.constructor.name)}: ${this.value}`;
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      compileNode(o) {
        var answer, compiledObjs, fragment, fragmentIndex, fragments, index, j, k, l, len1, len2, len3, len4, len5, obj, q, r, ref1, unwrappedObj;
        if (!this.objects.length) {
        ...
        if (indexOf.call(fragmentsToText(answer), '\n') >= 0) {
          ...
          answer.unshift(this.makeCode(`[\n${(answer[0].type !== 'HereComment' ? o.indent : '')}`));
          answer.push(this.makeCode(`\n${this.tab}]`));
        } else {

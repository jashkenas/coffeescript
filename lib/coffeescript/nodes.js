...
(function() {
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    ast(o, level) {
      if (this.shouldGenerateTemplateLiteralAst()) {
...
// multiline need to be indented.
  ...
  sniffDirectives = function(expressions, {notFinalExpression} = {}) {
    var expression, index, lastIndex, results;
    index = 0;
    lastIndex = expressions.length - 1;
    results = [];
    while (index <= lastIndex && (expression = expressions[index])) {
      if (index === lastIndex && notFinalExpression) {
        break;
      }
      if (!(expression instanceof Value && expression.isString() && !expression.unwrap().shouldGenerateTemplateLiteralAst())) {
        break;
      }

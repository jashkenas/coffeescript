  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileObjectDestruct(o) {
        var compiledName, extractKeys, fragments, getPropValue, j, len1, objVar, properties, ref, restElement, restList, setScopeVar, traverseRest, val, varProp, vvarPropText, vvarText;
        ...
        traverseRest = function(properties, path = []) {
          var base1, j, key, len1, nestedProperties, prop, restElement, restKey, results;
          results = [];
          restElement = false;
          for (key = j = 0, len1 = properties.length; j < len1; key = ++j) {
            ...
            if (prop instanceof Assign) {
              nestedProperties = (typeof (base1 = prop.value).isObject === "function" ? base1.isObject() : void 0) ? prop.value.base.properties : prop.value instanceof Assign && prop.value.variable.isObject() ? prop.value.variable.base.properties : void 0;
              if (nestedProperties) {

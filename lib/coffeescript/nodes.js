  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      attachComments(o, node, fragments) {
        var base1, base2, comment, commentFragment, fragment, fragmentIndex, j, k, len1, len2, ref1;
        if (!node.comments) {
          return fragments;
        }
        ref1 = node.comments;
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (comment.here) { // Comment delimited by `###`.
            ...
            commentFragment.isHereComment = true;
            if (comment.unshift) {
              ...
              fragments.push(commentFragment); // Line comment, delimited by `#`.
            }
          } else {
        ...
        for (index = j = 0, len1 = ref1.length; j < len1; index = ++j) {
          ...
          if (node instanceof Block) {
            ...
            if (!node.isStatement(o)) {
              ...
              if (!(lastFragment.code === '' || lastFragment.isHereComment)) {
...
(this.isStatement() ? super.toString() : this.constructor.name)}: ${this.value}`;
      ...
      compileNode(o) {
        ...
        if (this.expression) {
          ...
          for (i = j = 0, len1 = fragments.length; j < len1; i = ++j) {
            fragment = fragments[i];
            if ((fragment != null ? fragment.isHereComment : void 0) && indexOf.call(fragment.code, '\n') >= 0) {
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      compileNode(o) {
        var answer, compiledObjs, fragment, fragmentIndex, fragments, includesLineCommentsOnNonFirstElement, index, j, k, l, len1, len2, len3, len4, len5, obj, q, r, ref1, unwrappedObj;
        if (!this.objects.length) {
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      // function body.
      compileNode(o) {
        var answer, body, boundMethodCheck, condition, exprs, haveBodyParam, haveSplatParam, i, ifTrue, j, k, len1, len2, m, methodScope, modifiers, name, param, paramNames, paramToAddToScope, params, paramsAfterSplat, ref, ref1, ref2, ref3, ref4, ref5, ref6, salvagedComments, signature, splatParamName, thisAssignments, wasEmpty;
        if (this.ctor) {
          if (this.isAsync) {
  ...
  hasLineComments = function(fragment) {
    var comment, j, len1, ref1;
    if (!fragment.comments) {
      return false;
    }
    ref1 = fragment.comments;
    for (j = 0, len1 = ref1.length; j < len1; j++) {
      comment = ref1[j];

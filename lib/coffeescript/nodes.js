...
(function() {
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileWithDeclarations(o) {
        var assigns, declars, exp, fragments, i, j, len1, post, ref3, rest, scope, spaced;
        fragments = [];
        post = [];
        ref3 = this.expressions;
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      unfoldSoak(o) {
        var call, ifn, j, left, len1, list, ref3, rite;
        if (this.soak) {
  ...
  exports.SuperCall = SuperCall = (function() {
    class SuperCall extends Call {
      ...
      compileNode(o) {
        var ref, ref3, replacement, superCall;
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      compileNode(o) {
        var answer, i, idt, indent, j, join, k, key, lastNoncom, len1, len2, node, prop, props, value;
        props = this.properties;
        if (this.generated) {
          for (j = 0, len1 = props.length; j < len1; j++) {
            node = props[j];
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileSplice(o) {
        var answer, exclusive, from, fromDecl, fromRef, name, ref3, to, valDef, valRef;
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
        var answer, body, condition, exprs, haveBodyParam, haveSplatParam, i, ifTrue, j, k, len1, len2, m, methodScope, modifiers, name, param, paramNames, params, paramsAfterSplat, ref, ref3, ref4, ref5, ref6, ref7, signature, splatParamName, thisAssignments, wasEmpty;
        if (this.ctor) {
          if (this.isAsync) {
  ...
  exports.In = In = (function() {
    class In extends Base {
      ...
      compileOrTest(o) {
        var cmp, cnj, i, item, j, len1, ref, ref3, sub, tests;
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      compileNode(o) {
        var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, defPartFragments, down, forPartFragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, last, lvar, name, namePart, ref, ref3, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, varPart;
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      jumps(o = {
        ...
        var block, conds, j, jumpNode, len1, ref3, ref4;
        ref3 = this.cases;
        for (j = 0, len1 = ref3.length; j < len1; j++) {
          [conds, block] = ref3[j];
        ...
        return (ref4 = this.otherwise) != null ? ref4.jumps(o) : void 0;
      }
      ...
      compileNode(o) {
        var block, body, cond, conditions, expr, fragments, i, idt1, idt2, j, k, len1, len2, ref3, ref4;
        idt1 = o.indent + TAB;
        idt2 = o.indent = idt1 + TAB;
        fragments = [].concat(this.makeCode(this.tab + "switch ("), (this.subject ? this.subject.compileToFragments(o, LEVEL_PAREN) : this.makeCode("false")), this.makeCode(") {\n"));
        ref3 = this.cases;
        for (i = j = 0, len1 = ref3.length; j < len1; i = ++j) {
          [conditions, block] = ref3[i];
          ref4 = flatten([conditions]);
          for (k = 0, len2 = ref4.length; k < len2; k++) {
            cond = ref4[k];
            if (!this.subject) {
              cond = cond.invert();

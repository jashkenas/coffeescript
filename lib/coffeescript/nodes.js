  ...
  exports.CSXElement = CSXElement = (function() {
    class CSXElement extends Base {
      ...
      ast() {
        ...
        this.openingElementLocationData = locationDataToAst(this.attributes.base.locationData);
        tagName = this.tagName.base;
        tagName.locationData = tagName.tagNameLocationData;
        if (this.content != null) {
          this.closingElementLocationData = mergeAstLocationData(locationDataToAst(tagName.closingTagOpeningBracketLocationData), locationDataToAst(tagName.closingTagClosingBracketLocationData));
        }
        return super.ast();
      }
      ...
      astProperties() {
        ...
        if (this.closingElementLocationData != null) {
          closingElement = Object.assign({
            ...
            name: Object.assign(this.tagName.unwrap().ast(), locationDataToAst(this.tagName.base.closingTagNameLocationData))

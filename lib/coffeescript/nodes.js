...
(function() {
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileNode(o) {
        var answer, answers, compiledName, isValue, j, name, properties, prototype, ref1, ref2, ref3, ref4, ref5, ref6, restElements, val, varBase;
        answers = [];
        ...
        if (isValue) {
          ...
          if (this.variable.isArray() || this.variable.isObject()) {
            ...
            answers = this.variable.isObject() && (restElements = this.compileObjectDestruct(o)) ? restElements : [];
          }
        ...
        return this.joinFragmentArrays(answers, ', ');
      }

      compileObjectDestruct(o) {
        var answers, extractKeys, getPropValue, j, len1, objects, prop, ref, restElement, restList, traverseRest, val, varProp, vvarPropText, vvarText;
        ...
        if (!(this.value.unwrap() instanceof IdentifierLiteral) || this.variable.assigns(vvarText)) {
          answers.push([this.makeCode(`${(ref = o.scope.freeVariable('ref'))} = `), ...val]);
          val = [this.makeCode(ref)];
          vvarText = ref;
        }

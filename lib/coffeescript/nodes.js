...
(function() {
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      compileNode(o) {
        var answer, hasSplat, i, idt, indent, isCompact, j, join, k, key, l, lastNoncom, len1, len2, len3, len4, node, p, prop, props, ref1, value;
        props = this.properties;
        if (this.generated) {
          for (j = 0, len1 = props.length; j < len1; j++) {
            node = props[j];
      ...
      compileSpread(o) {
        var addSlice, i, j, len1, prop, propSlices, props, slices, splatSlices;
        props = this.properties;
        splatSlices = [];
        propSlices = [];
        ...
        addSlice = function() {
          if (propSlices.length) {
            slices = [...slices, new Obj([...propSlices], false)];
          }
          if (splatSlices.length) {
            return slices = [...slices, ...splatSlices];
          }
        };

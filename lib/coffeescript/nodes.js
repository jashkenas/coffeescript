  ...
  exports.If = If = (function() {
    class If extends Base {
      constructor(condition, body1, options = {}) {
        ...
        this.elseBody = null;
        this.isChain = false;
        ({soak: this.soak, postfix: this.postfix} = options);
      ...
      astProperties(o) {
        var ref1, ref2;
        return {
          test: this.condition.ast(o),
          consequent: this.body.ast(o),
          alternate: (ref1 = (ref2 = this.elseBody) != null ? ref2.ast(o) : void 0) != null ? ref1 : null
        };
      }

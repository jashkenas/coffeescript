...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      astProperties() {
        var initialProps, property, ref1, ref2;
        ref1 = this.properties, [...initialProps] = ref1, [property] = splice.call(initialProps, -1);
        return {
          object: new Value(this.base, initialProps, this.tag, this.isDefaultValue).ast(),

  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXElementToAst({tagName}) {
        var closingElement, closingElementLocationData, currentExpr, j, len1, openingElement, openingElementLocationData, property, rangeDiff, ref1, shiftAstLocationData;
        openingElementLocationData = tagName.astLocationData();
        ref1 = this.variable.properties;
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          property = ref1[j];
      ...
      CSXToAst() {
        var attributes, base1, content, tagName;
        [attributes, content] = this.args;
        tagName = this.variable.base;
        tagName.locationData = tagName.tagNameLocationData;
        return Object.assign(tagName.value.length ? this.CSXElementToAst({tagName, content}) : this.CSXFragmentToAst({tagName, content}), {
          children: content && !(typeof (base1 = content.base).isEmpty === "function" ? base1.isEmpty() : void 0) ? (content.base.csx = true, compact(flatten([content.ast()]))) : []
        });
      }

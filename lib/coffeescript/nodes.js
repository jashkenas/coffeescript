...
(function() {
  ...
  exports.PropertyNumber = PropertyNumber = (function() {
    class PropertyNumber extends Literal {};

    PropertyNumber.prototype.isAssignable = YES;

    return PropertyNumber;

  }).call(this);

  exports.PropertyString = PropertyString = (function() {
    class PropertyString extends StringLiteral {};

    PropertyString.prototype.isAssignable = YES;
...
// multiline need to be indented.
  ...
  exports.PropertyStringWithInterpolations = PropertyStringWithInterpolations = (function() {
    class PropertyStringWithInterpolations extends StringWithInterpolations {};

    PropertyStringWithInterpolations.prototype.isAssignable = YES;

    return PropertyStringWithInterpolations;

...
(function() {
  ...
  exports.ComputedPropertyName = ComputedPropertyName = class ComputedPropertyName extends PropertyName {
    compileNode(o) {
      return [this.makeCode("[" + this.value.compile(o) + "]")];
    }
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      compileNode(o) {
        var answer, i, idt, indent, isCompact, j, join, k, key, l, lastNode, len1, len2, len3, len4, node, prop, props, q, ref, ref1, unwrappedVal, value;
        props = this.properties;
        if (this.generated) {
          for (j = 0, len1 = props.length; j < len1; j++) {
            node = props[j];
        ...
        for (i = q = 0, len4 = props.length; q < len4; i = ++q) {
          ...
          if (key === prop && key instanceof Value && key.base instanceof ComputedPropertyName) {
            // { [foo()] } => { [ref = foo()]: ref }

...
// multiline need to be indented.
  ...
  mergeAstLocationData = function(nodeA, nodeB) {
    return {
      loc: {
        start: isAstLocGreater(nodeA.loc.start, nodeB.loc.start) ? nodeB.loc.start : nodeA.loc.start,
        end: isAstLocGreater(nodeA.loc.end, nodeB.loc.end) ? nodeA.loc.end : nodeB.loc.end
      },

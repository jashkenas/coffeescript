...
// multiline need to be indented.
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      reorderProperties() {
        var prop, props, splatProp, splatProps, x;
        props = this.properties;
        splatProps = (function() {
          var j, len1, results;
          results = [];
          for (x = j = 0, len1 = props.length; j < len1; x = ++j) {
            prop = props[x];
            if (prop instanceof Splat) {
              results.push(x);
            }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileDestructuring(o) {
        var assignObjects, assigns, code, compSlice, compSplice, complexObjects, expIdx, expans, fragments, hasObjAssigns, i, isArray, isExpans, isObject, isSplat, leftObjs, loopObjects, obj, objIsUnassignable, objects, olen, processObjects, ref, refExp, restVar, rightObjs, slicer, splats, splatsAndExpans, top, value, vvar, vvarText;
        top = o.level === LEVEL_TOP;
        ({value} = this);

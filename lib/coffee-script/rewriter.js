(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      var action, addImplicitBracesCondition, noCall;
      noCall = false;
      action = function(token, i) {
        return this.tokens.splice(i, 0, ['CALL_END', ')', token[2]]);
      };
      addImplicitBracesCondition = function(token, i) {
        var one, tag, three, two, _ref, _ref2;
        _ref = this.tokens.slice(i + 1, (i + 3) + 1 || 9e9), one = _ref[0], two = _ref[1], three = _ref[2];
        if ('HERECOMMENT' === (one != null ? one[0] : void 0)) return false;
        tag = token[0];
      ...
      return this.scanTokens(function(token, i, tokens) {
        var callObject, current, in_object, next, prev, seenControl, seenSingle, tag, _ref, _ref2, _ref3;
        tag = token[0];
        ...
        this.detectEnd(i + 1, function(token, i) {
          ...
          if (!in_object && tag === ':') {
            in_object = true;
          } else if (in_object && addImplicitBracesCondition.call(this, token, i)) {
            in_object = false;
          }
          if (in_object) return false;

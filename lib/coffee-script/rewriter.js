...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.tagPostfixReturns = function() {
      var insideOpExpr;
      insideOpExpr = false;
      return this.scanTokens(function(token, i, tokens) {
        var _ref;
        if (_ref = token[0], __indexOf.call(CONDITIONAL_OPERATIONS, _ref) >= 0) {
          insideOpExpr = true;
        }
        if (token[0] === 'INDENT') {
          insideOpExpr = false;
        }
        if (!(!insideOpExpr && token[0] === 'THEN' && this.tag(i + 1) === 'RETURN')) {
          if (token[0] === 'THEN') {
            insideOpExpr = false;
          }
          return 1;

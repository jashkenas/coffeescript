    ...
    Rewriter.prototype.adjustCoffeeTags = function() {
      return this.scanTokens(function(token, i, tokens) {
        ...
        if (token[0] === 'CSX') {
          ...
          if (clas) {
            tokens.splice(i + 2, 0, generate(',', ','), generate('PROPERTY', 'class'), generate(':', ':'), generate('STRING', "'" + clas + "'"));
          }
          if (myid) {
            tokens.splice(i + 2, 0, generate(',', ','), generate('PROPERTY', 'id'), generate(':', ':'), generate('STRING', "'" + myid + "'"));
          }
          if (more) {

...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    __defineProperty(Rewriter,  "rewrite", function(tokens) {
      this.tokens = tokens;
    ...
    __defineProperty(Rewriter,  "scanTokens", function(block) {
      var i, token, tokens;
      tokens = this.tokens;
      i = 0;
    ...
    __defineProperty(Rewriter,  "detectEnd", function(i, condition, action) {
    ...
    __defineProperty(Rewriter,  "removeLeadingNewlines", function() {
    ...
    __defineProperty(Rewriter,  "removeMidExpressionNewlines", function() {
    ...
    __defineProperty(Rewriter,  "closeOpenCalls", function() {
    ...
    __defineProperty(Rewriter,  "closeOpenIndexes", function() {
      var action, condition;
      condition = function(token, i) {
        var _ref;
    ...
    __defineProperty(Rewriter,  "addImplicitBraces", function() {
    ...
    __defineProperty(Rewriter,  "addImplicitParentheses", function() {
    ...
    __defineProperty(Rewriter,  "addImplicitIndentation", function() {
    ...
    __defineProperty(Rewriter,  "tagPostfixConditionals", function() {
    ...
    __defineProperty(Rewriter,  "indentation", function(token, implicit) {
      var indent, outdent;
      if (implicit == null) {
        implicit = false;
      }
    ...
    __defineProperty(Rewriter,  "generate", function(tag, value, line) {
      var tok;
      tok = [tag, value, line];
      tok.generated = true;
      return tok;
    ...
    __defineProperty(Rewriter,  "tag", function(i) {
      var _ref;

...
break;
case 126:
this.$ = yy.addLocationDataFn(_$[$0-1], _$[$0])(new yy.ModuleList($$[$0-1], false));
break;
case 127:
this.$ = yy.addLocationDataFn(_$[$0-5], _$[$0])(new yy.ModuleList($$[$0-5], false, $$[$0-2], true));
break;
case 128: case 135:
...
defaultActions: {68:[2,69],69:[2,70],104:[2,152],229:[2,108],265:[2,125],380:[2,128],415:[2,127]},

...
break;
case 128:
this.$ = yy.addLocationDataFn(_$[$0-5], _$[$0])(new yy.ImportDeclaration([$$[$0-4], $$[$0-2]], $$[$0]));
break;
case 129:
this.$ = yy.addLocationDataFn(_$[$0-8], _$[$0])(new yy.ImportDeclaration([$$[$0-7], new yy.ImportSpecifierList($$[$0-4])], $$[$0]));
break;

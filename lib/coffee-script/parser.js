...
break;
case 125:
this.$ = yy.addLocationDataFn(_$[$0-1], _$[$0])(new yy.ModuleList([], true));
break;
case 126:
this.$ = yy.addLocationDataFn(_$[$0], _$[$0])(new yy.ModuleList($$[$0], false));
break;
case 127:
this.$ = yy.addLocationDataFn(_$[$0-4], _$[$0])(new yy.ModuleList($$[$0-4], false, $$[$0-1], true));
break;
case 128: case 135:
this.$ = yy.addLocationDataFn(_$[$0-2], _$[$0])(new yy.ModuleList($$[$0-1], true));
break;
case 129:

...
(function() {
  var Lexer, SourceMap, base64encode, compile, compileCode, compiledFiles, ext, fn1, formatSourcePosition, fs, getSourceMap, helpers, i, len, lexer, packageJson, parser, path, ref, sourceMaps, vm, withPrettyErrors,
  ...
  exports._compileFile = function(filename, sourceMap, inlineMap) {
    ...
    return compileCode(stripped, filename, sourceMap, inlineMap);
  };

  compileCode = function(code, filename, sourceMap, inlineMap) {
    var answer, err;
    if (sourceMap == null) {
      sourceMap = false;
    }
  ...
  getSourceMap = function(filename) {
    ...
    } else if (compiledFiles[filename] != null) {
      answer = compileCode(compiledFiles[filename], filename, true, false);

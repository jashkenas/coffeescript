...
(function() {
  var Lexer, SourceMap, compile, formatSourcePosition, fs, getSourceMap, helpers, lexer, nodes, parser, path, sourceMaps, vm, withPrettyErrors,
  ...
  exports.nodes = withPrettyErrors(function(source, options) {
    var ast, comments, others, token, tokens, _i, _len;
    ...
    if (options.comment) {
      ast.comments = comments.map(function(_arg) {
        var comment, commentNode, locationData, _;
        _ = _arg[0], comment = _arg[1], locationData = _arg[2];

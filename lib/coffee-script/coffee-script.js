...
(function() {
  var Lexer, Module, SourceMap, binary, child_process, compile, compileFile, ext, fileExtensions, findExtension, fork, formatSourcePosition, fs, getSourceMap, helpers, lexer, loadFile, parser, path, sourceMaps, trueModule_load, vm, withPrettyErrors, _i, _len,
  ...
  if (require.extensions) {
    ...
    Module._load = function(request) {
      if (request === 'coffee-script') {
        return exports;
      } else {
        return trueModule_load.apply(this, arguments);
      }
    };
  }

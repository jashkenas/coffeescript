...
(function() {
  var Lexer, SourceMap, child_process, compile, compileHelper, fork, formatSourcePosition, fs, getSourceMap, helpers, lexer, parser, path, sourceMaps, vm,
  ...
  compileHelper = require('./compile-helper');
  ...
  exports.run = function(code, options) {
    ...
    compileHelper.registerRequire(require);
  ...
  getSourceMap = function(filename) {
    ...
    if (_ref = path != null ? path.extname(filename) : void 0, __indexOf.call(compileHelper.fileExtensions, _ref) < 0) {
      return;
    }
    answer = compileHelper.compileFile(filename, true);

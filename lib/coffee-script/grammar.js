  ...
  grammar = {
    ...
    Return: [
      o('RETURN Expression', function() {
        ...
        return new Return;
      }), o('Expression POST_RETURN', function() {
        return new Return($1, true);
      })
    ],
    Comment: [

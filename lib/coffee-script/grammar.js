  ...
  grammar = {
    ...
    Import: [
      o('IMPORT String', function() {
        return new Import(null, $2);
      }), o('IMPORT ImportClause FROM String', function() {
        return new Import($2, $4);
      })
    ],
    ImportClause: [
      o('ModuleList', function() {
        return new ModuleList($1, false);
      }), o('ModuleList , { ModuleList OptComma }', function() {
        return new ModuleList($1, false, $4, true);
      }), o('{ ModuleList OptComma }', function() {
        return new ModuleList($2, true);
      })
    ],
    Export: [
      o('EXPORT Class', function() {
        ...
        return new Export(new Assign($2, $4, null, {
          moduleStatement: 'export'
        }));
      }), o('EXPORT DEFAULT Expression', function() {
        return new ExportDefault($3);
      }), o('EXPORT ExportImportClause', function() {
        return new ExportImport($2);
      }), o('EXPORT ExportImportClause FROM String', function() {
        return new ExportImport($2, $4);
      })
    ],
    ExportImportClause: [
      o('IMPORT_ALL', function() {
        return new Literal($1);
      }), o('{ }', function() {
        return new Literal($1.concat($2));
      }), o('{ ModuleList OptComma }', function() {
        return new ModuleList($2, true);
      })
    ],
    ModuleList: [
      o('ModuleIdentifier', function() {
        return [$1];
      }), o('ModuleList , ModuleIdentifier', function() {
        return $1.concat($3);
      }), o('ModuleList OptComma TERMINATOR ModuleIdentifier', function() {
        return $1.concat($4);
      }), o('INDENT ModuleList OptComma OUTDENT', function() {
        return $2;
      }), o('ModuleList OptComma INDENT ModuleList OptComma OUTDENT', function() {
        return $1.concat($4);
      })
    ],
    ModuleIdentifier: [
      o('Identifier'), o('IMPORT_ALL', function() {
        return new ModuleIdentifier(new Literal($1), null, true);
      }), o('IMPORT_ALL AS Identifier', function() {
        return new ModuleIdentifier(new Literal($1), $3, true);
      }), o('Identifier AS Identifier', function() {
        return new ModuleIdentifier($1, $3);
      }), o('Identifier AS DEFAULT', function() {
        return new ModuleIdentifier($1, new Literal($3));
      })
    ],
    Invocation: [

...
(function() {
  ...
  grammar = {
    ...
    ForSource: [
      ...
      }), o('FOROUTOF Expression', function() {
        return {
          source: $2,
          generator: true
        };
      ...
      }), o('FOROUTOF Expression WHEN Expression', function() {
        return {
          source: $2,
          guard: $4,
          generator: true

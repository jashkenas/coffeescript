  ...
  grammar = {
    ...
    AssignObj: [
      o('ObjAssignable', function() {
        ...
        return new Assign(LOCDATA(1)(Value.create($1)), $3, 'object');
      }), o('ObjAssignable :\
       INDENT Expression OUTDENT', function() {
        return new Assign(LOCDATA(1)(Value.create($1)), $4, 'object');
      }), o('Comment')
    ],
    ...
    ThisProperty: [
      o('@ Identifier', function() {
        return Value.create(LOCDATA(1)(new Literal('this')), [LOCDATA(2)(new Access($2))], 'this');
      })
    ],
    Array: [
      o('[ ]', function() {
    ...
    Catch: [
      o('CATCH Identifier Block', function() {
        ...
        return [LOCDATA(2)(Value.create($2)), $3];
      })
    ],
    Throw: [
    ...
    ForBody: [
      o('FOR Range', function() {
        return {
          source: LOCDATA(2)(Value.create($2))
        };

...
(function() {
  ...
  grammar = {
    ...
    ObjectAccessWithDefault: [
      o('Value AccessWithDefault', function() {
        return new ObjectAccessWithDefault($1, $2[0], $2[1]);
      }), o('Invocation AccessWithDefault', function() {
        return new ObjectAccessWithDefault($1, $2[0], $2[1]);
      })
    ],
    AccessWithDefault: [
    ...
    Value: [
      o('Assignable'), o('ObjectAccessWithDefault', function() {
        return new Value($1);
      }), o('Literal', function() {
        return new Value($1);

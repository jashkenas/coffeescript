...
(function() {
  ...
  grammar = {
    ...
    JsxElement: [o('JsxTag'), o('JsxHamlElement')],
    JsxTag: [
      o('JsxStartTag JSX_ELEMENT_BODY_START JsxTagChildren JSX_END_TAG', function() {
        return new JsxElement({
          name: $1.name,
          attributes: $1.attributes,
          children: $3
        });
      }), o('JsxStartTag JSX_ELEMENT_BODY_START JSX_END_TAG', function() {
        return new JsxElement({
          name: $1.name,
          attributes: $1.attributes
        });
    ...
    JsxStartTag: [
      o('JSX_START_TAG_START JSX_ELEMENT_NAME JSX_START_TAG_END', function() {
        return {
          name: $2
        };
      }), o('JSX_START_TAG_START JSX_ELEMENT_NAME JsxParenthesizedAttributes JSX_START_TAG_END', function() {
        return {
          name: $2,
          attributes: {
            list: $3
      ...
      }), o('JSX_START_TAG_START JSX_ELEMENT_NAME INDENT OUTDENT JSX_START_TAG_END', function() {
        return {
          name: $2,
          attributes: {
            list: $3
    ...
    JsxTagChildren: [
      o('JsxElementChildren'), o('INDENT JsxElementChildren OUTDENT', function() {
        return $2;
      })
    ],
    JsxHamlElement: [
      o('JSX_ELEMENT_NAME', function() {
        return new JsxElement({
          name: $1
        });
      }), o('JSX_ELEMENT_NAME JsxElementShorthands', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2
        });
      }), o('JSX_ELEMENT_NAME JsxAttributes', function() {
        return new JsxElement({
          name: $1,
          attributes: $2
        });
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          attributes: $3
        });
      }), o('JSX_ELEMENT_NAME JsxAttributes JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          attributes: $2,
          children: $4
        });
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          attributes: $3,
      ...
      }), o('JSX_ELEMENT_NAME JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          children: $3
        });
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          children: $4
    ...
    JsxElementShorthands: [
      o('JsxElementShorthandClasses', function() {
        return {
          classes: $1
        };
      }), o('JsxElementShorthandId', function() {
        return {
          id: $1
        };
      }), o('JsxElementShorthandId JsxElementShorthandClasses', function() {
        return {
          classes: $2,
          id: $1
        };
      }), o('JsxElementShorthandClasses JsxElementShorthandId JsxElementShorthandClasses', function() {
        return {
          classes: $1.concat($2),
          id: $2
        };
      }), o('JsxElementShorthandClasses JsxElementShorthandId', function() {
        return {
          classes: $1,
          id: $2
        };
    ...
    JsxElementShorthandId: [
      o('JSX_ID_SHORTHAND_SYMBOL JSX_ID_SHORTHAND', function() {
        return $2;
      })
    ],
    JsxElementShorthandClasses: [
      o('JsxElementShorthandClass', function() {
        return [$1];
      }), o('JsxElementShorthandClasses JsxElementShorthandClass', function() {
        return $1.concat($2);
      })
    ],
    JsxElementShorthandClass: [
      o('JSX_CLASS_SHORTHAND_SYMBOL JSX_CLASS_SHORTHAND', function() {
        return $2;
      })
    ],
    JsxAttributes: [
      o('JsxParenthesizedAttributes_', function() {
        return {
          list: $1
        };
      }), o('JsxParenthesizedAttributes_ JsxObjectAttributes_', function() {
        return {
          list: $1,
          object: $2
        };
      }), o('JsxObjectAttributes_ JsxParenthesizedAttributes_', function() {
        return {
          list: $2,
          object: $1
        };
      }), o('JsxObjectAttributes_', function() {
        return {
          object: $1
        };
      })
    ...
    JsxParenthesizedAttributes_: [
      o('JSX_PARENTHESIZED_ATTRIBUTES_START JsxParenthesizedAttributes JSX_PARENTHESIZED_ATTRIBUTES_END', function() {
        return $2;
      })
    ],
    JsxParenthesizedAttributes: [
      o('JsxParenthesizedAttribute', function() {
        return [$1];
      }), o('JsxParenthesizedAttributes JsxParenthesizedAttribute', function() {
        return $1.concat($2);
      }), o('INDENT JsxParenthesizedAttributes OUTDENT', function() {
        return $2;
      }), o('JsxParenthesizedAttributes TERMINATOR', function() {
        return $1;
      }), o('JsxParenthesizedAttributes INDENT JsxParenthesizedAttributes OUTDENT', function() {
        return $1.concat($3);
      })
    ],
    JsxParenthesizedAttribute: [
      o('JSX_ATTRIBUTE_NAME = JsxParenthesizedAttributeValue', function() {
        return {
          name: $1,
          value: $3
        };
    ...
    JsxObjectAttributes_: [
      o('JSX_OBJECT_ATTRIBUTES_START JsxAttributesObject JSX_OBJECT_ATTRIBUTES_END', function() {
        return $2;
      })
    ],
    JsxAttributesObject: [
      o('{ AssignList OptComma }', function() {
        return new JsxAttributesObj($2, $1.generated);
      })
    ],
    JsxElementChildren_: [
      o('JsxElementChildren JSX_ELEMENT_INLINE_BODY_END', function() {
        return $1;
      }), o('INDENT JsxElementChildren OUTDENT', function() {
        return $2;
      })
    ],
    JsxElementChildren: [
      o('JsxElementChild', function() {
        return [$1];
      }), o('JsxElementChildren JsxElementChild', function() {
        return $1.concat($2);
      })
    ],
    JsxElementChild: [
      o('JSX_ELEMENT_CONTENT', function() {
        return $1;
      }), o('JsxElement', function() {
        return $1;
      }), o('{ Expression }', function() {

...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.makeReturn = function(res) {
      ...
      me = this.unwrapAll();
      if (res) {
        return new Call(new Value(new Literal(res)).add(new Access(new Literal("push"))), [me]);
      } else {
  ...
  exports.Splat = Splat = (function(superClass1) {
    ...
    Splat.prototype.compileToFragments = function() {
      if (this.safe) {
        return this.compileSplat.apply(this, arguments);
      } else {
        return this.error('Splats are not allowed here');
      }
    };

    Splat.prototype.compileSplat = function(o, level) {
      return this.name.compileToFragments(o, level);
    };
    ...
    Splat.compileSplattedArray = function(o, list, apply) {
      ...
      for (i = j = 0, len1 = args.length; j < len1; i = ++j) {
        node = args[i];
        compiledNode = node instanceof Splat ? node.compileSplat(o, LEVEL_LIST) : node.compileToFragments(o, LEVEL_LIST);

...
(function() {
  ...
  exports.ModuleDeclaration = ModuleDeclaration = (function(superClass1) {
    ...
    function ModuleDeclaration(clause1, moduleName1) {
      this.clause = clause1;
      this.moduleName = moduleName1;
      this.checkModuleName();
    }

    ModuleDeclaration.prototype.children = ['clause', 'moduleName'];
    ...
    ModuleDeclaration.prototype.checkModuleName = function() {
      if ((this.moduleName != null) && this.moduleName instanceof StringWithInterpolations) {
        return this.moduleName.error('the name of the module to be imported from must be an uninterpolated string');
      }
    };
  ...
  exports.ImportDeclaration = ImportDeclaration = (function(superClass1) {
    ...
    ImportDeclaration.prototype.compileNode = function(o) {
      var code, j, len1, ref3, ref4, subclause;
      ...
      if (((ref4 = this.moduleName) != null ? ref4.value : void 0) != null) {
        if (this.clause !== null) {
  ...
  exports.ExportDeclaration = ExportDeclaration = (function(superClass1) {
    ...
    function ExportDeclaration(clause1, moduleName1, _default) {
      this.clause = clause1;
      this.moduleName = moduleName1;
      this["default"] = _default != null ? _default : false;
      ExportDeclaration.__super__.constructor.call(this, this.clause, this.moduleName);
    }
    ...
    ExportDeclaration.prototype.compileNode = function(o) {
      ...
      if (((ref3 = this.moduleName) != null ? ref3.value : void 0) != null) {
        code.push(this.makeCode(" from " + this.moduleName.value));
      }
      code.push(this.makeCode(';'));
      return code;
    };
  ...
  exports.ExportDefaultDeclaration = ExportDefaultDeclaration = (function(superClass1) {
    ...
    function ExportDefaultDeclaration(clause, moduleName) {
      ExportDefaultDeclaration.__super__.constructor.call(this, clause, moduleName, true);
    }
  ...
  exports.ModuleSpecifier = ModuleSpecifier = (function(superClass1) {
    ...
    function ModuleSpecifier(original1, alias1, moduleDeclarationType1) {
    ...
    ModuleSpecifier.prototype.compileNode = function(o) {
      ...
      o.scope.add(variableName, this.moduleDeclarationType);
      code = [];
  ...
  exports.ImportSpecifier = ImportSpecifier = (function(superClass1) {
    ...
    function ImportSpecifier(original, alias) {
      ImportSpecifier.__super__.constructor.call(this, original, alias, 'import');
    }
  ...
  exports.ExportSpecifier = ExportSpecifier = (function(superClass1) {
    ...
    function ExportSpecifier(original, alias) {
      ExportSpecifier.__super__.constructor.call(this, original, alias, 'export');
    }

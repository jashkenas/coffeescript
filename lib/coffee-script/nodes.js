...
(function() {
  ...
  UTILITIES = {
    "extends": function() {
      return "function(child, parent) { for (var key in parent) { if (" + (utility('hasProp')) + ".call(parent, key)) " + (utility('defProp')) + "(child, key, " + (utility('getProp')) + "(parent, key)); } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; }";
    },
    bind: function() {
    ...
    getProp: function() {
      return '{}.__proto__.constructor.getOwnPropertyDescriptor';
    },
    defProp: function() {
      return '{}.__proto__.constructor.defineProperty';
    },
    hasProp: function() {

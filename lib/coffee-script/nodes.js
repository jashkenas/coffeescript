  ...
  exports.Op = Op = (function(superClass1) {
    ...
    Op.prototype.compileNode = function(o) {
      ...
      switch (this.operator) {
        ...
        case '//':
          return this.compileBoundDivision(o, 'floor');
        case '\\\\':
          return this.compileBoundDivision(o, 'ceil');
        case '%%':
    ...
    Op.prototype.compileBoundDivision = function(o, op) {
      var div, mathRef;
      mathRef = new Value(new IdentifierLiteral('Math'), [new Access(new PropertyName(op))]);
      div = new Op('/', this.first, this.second);
      return new Call(mathRef, [div]).compileToFragments(o);
    };

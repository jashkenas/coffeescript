...
(function() {
  ...
  exports.JsxElement = JsxElement = (function(superClass1) {
    ...
    JsxElement.prototype.children = ['children', 'attributes'];

    function JsxElement(options) {
      this.name = options.name, this.children = options.children, this.attributes = options.attributes;
    ...
    JsxElement.prototype.compileNode = function(o) {
      var child, compiledAttributes, compiledChildren, endTag, isString, startTag;
      ...
      compiledChildren = flatten((function() {
        ...
        for (j = 0, len1 = ref3.length; j < len1; j++) {
          child = ref3[j];
          if (isString(child)) {
            results.push([this.makeCode(child)]);
          } else if (child instanceof JsxElement) {
            results.push(child.compileToFragments(o));
          } else {
            results.push([this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')]);
          }
        }
        return results;
      }).call(this));

...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var exp, fragments, i, name, prelude, preludeExps, rest, strictStatement, _i, _len, _ref2;
      o.indent = o.bare ? '' : TAB;
      o.level = LEVEL_TOP;
      this.spaced = true;
      ...
      strictStatement = this.makeCode(o.strict ? "" + this.tab + "\"use strict\";\n\n" : '');
      return [].concat(prelude, this.makeCode("(function() {\n"), strictStatement, fragments, this.makeCode("\n}).call(this);\n"));
    };

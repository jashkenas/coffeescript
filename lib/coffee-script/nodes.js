...
(function() {
  ...
  exports.ExportDeclaration = ExportDeclaration = (function(superClass1) {
    ...
    function ExportDeclaration(clause, source1) {
      this.clause = clause;
      this.source = source1;
      ExportDeclaration.__super__.constructor.call(this, this.clause, this.source);
    }
    ...
    ExportDeclaration.prototype.compileNode = function(o) {
      ...
      if (this instanceof ExportDefaultDeclaration === false && (this.clause instanceof Assign || this.clause instanceof Class)) {
  ...
  exports.ImportSpecifier = ImportSpecifier = (function(superClass1) {
    ...
    ImportSpecifier.prototype.compileNode = function(o) {
      var ref3;
      if (ref3 = this.identifier, indexOf.call(o.importedSymbols, ref3) >= 0) {

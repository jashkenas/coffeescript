(function() {
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.compileRoot = function(o) {
      var code, comment, exp, node;
      o.scope = new Scope(null, this, null);
      o.level = LEVEL_TOP;
      comment = '';
      if (!o.bare && this.expressions.length > 0 && this.expressions[0] instanceof Comment) {
        exp = this.expressions;
        node = this.expressions[0];
        this.expressions = [node];
        o.indent = this.tab = '';
        comment = this.compileNode(o);
        this.expressions = exp.splice(1, exp.length);
      }

...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, Void, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Void = Void = (function(_super) {
    ...
    Void.prototype.children = ['expression'];

    Void.prototype.makeReturn = function(res) {
      if (res) {
        return Void.__super__.makeReturn.apply(this, arguments);
      } else {
        return this.expression || new Return;
      }
    };

    Void.prototype.compileNode = function(o) {
      var expr;
      expr = this.expression || new Literal('0');
      return [this.makeCode("void(")].concat(__slice.call(expr.compileToFragments(o, LEVEL_LIST)), [this.makeCode(")")]);
    };

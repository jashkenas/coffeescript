...
(function() {
  ...
  exports.JsxElement = JsxElement = (function(superClass1) {
    ...
    JsxElement.prototype.compileNode = function(o) {
      var compiledAttributes, compiledChildren, endTag, isString, startTag;
      compiledAttributes = (function(_this) {
        return function() {
      ...
      startTag = [this.makeCode('<'), this.makeCode(this.name)].concat(slice.call(compiledAttributes), [this.makeCode('>')]);
      isString = function(obj) {
        return Object.prototype.toString.call(obj) === '[object String]';
      };
      compiledChildren = (function(_this) {
        return function() {
          var child, compiled, initialSpace, ref3;
          ...
          ref3 = compiled, initialSpace = ref3[0], compiled = 2 <= ref3.length ? slice.call(ref3, 1) : [];
          return compiled;
        };
      })(this)();

// Generated by CoffeeScript 1.7.2-alpha
(function() {
  ...
  exports.Return = Return = (function(_super) {
    ...
    function Return(expression, makeGenerator) {
      this.expression = expression;
      this.makeGenerator = makeGenerator != null ? makeGenerator : false;
    }
    ...
    Return.prototype.compileNode = function(o) {
      var answer, siblingExpression, _i, _len, _ref2;
      _ref2 = o.scope.expressions.expressions;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        siblingExpression = _ref2[_i];
        if (siblingExpression.makeGenerator === true) {
          this.error('unexpected POST_YIELD');
        }
      }
      answer = [];
  ...
  exports.Code = Code = (function(_super) {
    ...
    function Code(params, body, tag) {
      ...
      this.generator = this.isGenerator();
    }

    Code.prototype.children = ['params', 'body'];

    Code.prototype.isGenerator = function() {
      return this.body.contains(function(node) {
        var _ref2;
        return (node instanceof Op && ((_ref2 = node.operator) === 'yield' || _ref2 === 'yield*')) || (node instanceof Return && node.makeGenerator);
      });
    };
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.makeReturn = function(res) {
      var _ref2;
      if ((_ref2 = this.operator) === 'yield' || _ref2 === 'yield*') {
        return this;
      } else {
        return Op.__super__.makeReturn.apply(this, arguments);
      }
    };

    Op.prototype.jumps = function(o) {
      var _ref2;
      if ((_ref2 = this.operator) === 'yield' || _ref2 === 'yield*') {
        return this;
      } else {
        return Op.__super__.jumps.apply(this, arguments);
      }
    };
    ...
    Op.prototype.compileUnary = function(o) {
      ...
      parts = [];
      op = this.operator;
      if (op === 'yield' || op === 'yield*') {
        if (!(__indexOf.call(process.execArgv, '--harmony') >= 0 || __indexOf.call(process.execArgv, '--harmony-generators') >= 0)) {
          this.error('yield statement found without generator support. use `coffee -g` to enable generators.');
        }

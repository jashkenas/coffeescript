(function() {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.tameWalkAst = function(p, o) {
      this.tameParentAwait = p;
      if (Code.__super__.tameWalkAst.call(this, null, o)) this.tameNodeFlag = true;
      return false;
    };
  ...
  exports.Await = Await = (function(_super) {
    ...
    Await.prototype.tameWalkAst = function(p, o) {
      ...
      return this.tameNodeFlag = o.found = true;
    };

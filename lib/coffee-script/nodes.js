...
(function() {
  ...
  exports.TaggedTemplateCall = TaggedTemplateCall = (function(superClass1) {
    ...
    function TaggedTemplateCall(variable, arg, soak) {
      ...
      interpolatedString = arg instanceof StringLiteral ? new StringWithInterpolations(Block.wrap([new Value(arg)])) : arg;
      TaggedTemplateCall.__super__.constructor.call(this, variable, [interpolatedString], soak);
    }

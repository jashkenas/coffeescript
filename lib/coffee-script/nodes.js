...
(function() {
  ...
  exports.Param = Param = (function(superClass) {
    class Param extends superClass {
      ...
      isComplex() {
        var hasComplexChild;
        if (this.name.isComplex()) {
          return true;
        } else if ((this.value != null) && this.value.isComplex()) {
          if (this.value instanceof Value) {
            if (!this.value.base.isComplex()) {
              return false;
            } else {
              if (this.value.base instanceof Arr || this.value.base instanceof Obj) {
                hasComplexChild = false;
                this.value.base.traverseChildren(false, function(node) {
                  if (node.isComplex()) {

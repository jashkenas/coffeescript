...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileClosure = function(o) {
      ...
      if (func.isContinuation || ((ref3 = func.base) != null ? ref3.isContinuation : void 0)) {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    function Code(params, body, tag) {
      ...
      this.isContinuation = this.isGenerator || this.isAsync;
      if (this.isAsync && this.isGenerator) {
        this.error("function can't contain both yield and await");
      }
    }
    ...
    Code.prototype.compileNode = function(o) {
      var answer, asyncify, boundfunc, code, exprs, i, j, k, l, len1, len2, len3, len4, len5, len6, lit, m, p, param, params, q, r, ref, ref3, ref4, ref5, ref6, ref7, ref8, splats, uniqs, val, wasEmpty, wrapper;
  ...
  exports.Op = Op = (function(superClass1) {
    ...
    Op.prototype.isYield = function() {
      var ref3;
      return this.originalOperator !== 'await' && ((ref3 = this.operator) === 'yield' || ref3 === 'yield*');
    };
    ...
    Op.prototype.compileContinuation = function(o) {
      ...
      op = this.operator;
      if (o.scope.parent == null) {
        this.error(this.originalOperator + " can only occur inside functions");
      }

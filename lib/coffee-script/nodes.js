...
(function() {
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      toString(idt = '', name) {
        var tree;
        name = name != null ? name : this.constructor.name;
        tree = '\n' + idt + name;
        if (this.soak) {
          tree += '?';
        }
  ...
  exports.Class = Class = (function(superClass) {
    class Class extends superClass {
      constructor(variable1, parent1, body1) {
        body1 = body1 != null ? body1 : new Block;
        super();
        this.variable = variable1;
        this.parent = parent1;
        this.body = body1;
  ...
  exports.Param = Param = (function(superClass) {
    class Param extends superClass {
      ...
      isComplex() {
        var ref3;
        return this.name.isComplex() || ((((ref3 = this.value) != null ? ref3.isComplex : void 0) != null) && this.value.isComplex());
      }

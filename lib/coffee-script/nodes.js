...
(function() {
  ...
  exports.TemplateLiteral = TemplateLiteral = (function(superClass1) {
    extend1(TemplateLiteral, superClass1);

    function TemplateLiteral(value) {
      TemplateLiteral.__super__.constructor.call(this, "`" + (value.slice(1, -1)) + "`");
    }
  ...
  exports.TaggedTemplateLiteral = TaggedTemplateLiteral = (function(superClass1) {
    extend1(TaggedTemplateLiteral, superClass1);

    function TaggedTemplateLiteral(variable, arg) {
      TaggedTemplateLiteral.__super__.constructor.call(this, new Value(new IdentifierLiteral(variable)), [new TemplateLiteral(arg)], false);
    }

    TaggedTemplateLiteral.prototype.compileNode = function(o) {
      var fragments, ref3;
      if ((ref3 = this.variable) != null) {
        ref3.front = this.front;
      }
      fragments = [];
      fragments.push.apply(fragments, this.variable.compileToFragments(o, LEVEL_ACCESS));
      fragments.push.apply(fragments, this.args[0].compileToFragments(o, LEVEL_LIST));
      return fragments;
    };

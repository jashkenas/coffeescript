  ...
  exports.Code = Code = (function(superClass) {
    class Code extends superClass {
      ...
      compileNode(o) {
        ...
        if (this.ctor && (superCall = this.ctorSuperCall())) {
      ...
      ctorSuperCall() {
        ...
        this.traverseChildren(true, (child) => {
          ...
          if (this.ctor === 'derived' && child instanceof ThisLiteral && (superCall == null)) {
            child.error("Can't reference 'this' before calling super in derived class constructors");
          }
          return !superCall && (!(child instanceof Code) || child.bound);
        });
        if (this.ctor === 'derived' && (superCall == null)) {
          this.error('Derived class constructors must include a call to super');
        } else if (this.ctor === 'base' && (superCall != null)) {

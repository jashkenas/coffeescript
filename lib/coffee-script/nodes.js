...
(function() {
  ...
  exports.Code = Code = (function(superClass) {
    class Code extends superClass {
      ...
      compileNode(o) {
        var answer, body, condition, exprs, haveSplatParam, i, ifTrue, j, k, l, len1, len2, len3, m, modifiers, name, param, paramNames, params, paramsAfterSplat, ref, ref3, ref4, ref5, ref6, ref7, signature, splatParamName, superCall, superCalls, thisAssignments, val, wasEmpty;
        if (this.ctor) {
          if (this.isAsync) {
        ...
        if (this.ctor) {
          superCalls = this.superCalls();
        }
        wasEmpty = this.body.isEmpty();
        if (this.ctor === 'derived') {
          for (k = 0, len2 = superCalls.length; k < len2; k++) {
            superCall = superCalls[k];

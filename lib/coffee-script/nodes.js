(function() {
  var Access, Arr, Assign, Await, Base, Block, Call, Class, Closure, Code, Comment, CpsCascade, Defer, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, InlineDeferral, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Slot, Splat, Switch, TAB, THIS, TameRequire, TameReturnValue, TameTailCall, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, tame, unfoldSoak, utility, _ref,
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileCps = function(o) {
      var first, node, ret, second;
      this.tameGotCpsSplitFlag = true;
      if (this.tamePrequelBlock) {
        first = this.tamePrequelBlock;
        if (this.tameContinuationBlock) {
          second = this.tameContinuationBlock;
          second.unshift(this);
        } else {
          second = this;
        }
      ...
      node = CpsCascade.wrap(first, second, this.tameReturnValue, o);
      ret = node.compile(o);
      return ret;
    };
    ...
    Base.prototype.toString = function(idt, name) {
      ...
      if (this.tamePrequelBlock) {
        pidt = idt + TAB;
        tree += '\n' + pidt + "Prequel";
        tree += this.tamePrequelBlock.toString(pidt + TAB);
      }
    ...
    Base.prototype.tamePrequelBlock = null;
    ...
    Base.prototype.tameNestPrequelBlock = function(b) {
      return this.tamePrequelBlock = b;
    };

    Base.prototype.tameHasContinuation = function() {
      return !!this.tameContinuationBlock || !!this.tamePrequelBlock;
    };

(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, Location, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref,
  ...
  exports.Location = Location = (function() {
    ...
    Location.prototype.toString = function() {
      if (this.firstLine === this.lastLine) {
        return "" + this.file + ": " + (this.firstLine + 1) + ": ";
      } else {
        return "" + this.file + ": " + (this.firstLine + 1) + "-" + (this.lastLine + 1) + ": ";
      }
    };

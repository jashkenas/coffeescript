...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Extended, Extends, For, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __extended = function(child, parent) { if (typeof parent.extended === "function") { parent.extended(child); } },
  ...
  exports.Extends = Extends = (function(_super) {
    ...
    Extends.prototype.utility = 'extends';

    Extends.prototype.compileToFragments = function(o) {
      return new Call(new Value(new Literal(utility(this.utility))), [this.child, this.parent]).compileToFragments(o);
    };

    __extended(Extends, _super);

    return Extends;

  })(Base);

  exports.Extended = Extended = (function(_super) {
    __extends(Extended, _super);

    function Extended() {
      return Extended.__super__.constructor.apply(this, arguments);
    }

    Extended.prototype.utility = 'extended';

    __extended(Extended, _super);
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      ...
      if (this.parent) {
        ...
        this.body.expressions.push(new Extended(lname, superClass));
      }
  ...
  UTILITIES = {
    ...
    extended: function() {
      return "function(child, parent) { if (typeof parent.extended === \"function\") { parent.extended(child); } }";
    },
    bind: function() {

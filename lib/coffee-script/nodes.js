  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.ensureConstructor = function(name) {
      if (!this.ctor) {
        this.ctor = new Code;
        if (this.parent) {
          this.ctor.body.push(new Call(new Literal("" + name + ".__super__.constructor.apply"), [new Literal('this'), new Literal('arguments')]));
        }
        if (this.externalCtor) {
          this.ctor.body.push(new Call(new Literal("" + this.externalCtor + ".apply"), [new Literal('this'), new Literal('arguments')]));
        }

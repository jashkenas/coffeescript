...
(function() {
  ...
  exports.Yield = Yield = (function(_super) {
    ...
    Yield.prototype.isStatement = NO;

    Yield.prototype.makeReturn = THIS;

    Yield.prototype.jumps = NO;

    Yield.prototype.compile = function(o, level) {
      var expr, _ref2;
      expr = (_ref2 = this.expression) != null ? _ref2.makeReturn() : void 0;
      if (expr && !(expr instanceof Return)) {
        return expr.compile(o, level);
      } else {
        return Yield.__super__.compile.call(this, o, level);
      }
    };

(function() {
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.compileNode = function(o) {
      var arg, argIndex, args, compiledArgs, compiledArray, fragments, preface, _i, _len, _ref2;
      ...
      compiledArgs = [];
      for (argIndex = _i = 0, _len = args.length; _i < _len; argIndex = ++_i) {
        arg = args[argIndex];
        if (argIndex) {
  ...
  exports.Arr = Arr = (function(_super) {
    ...
    Arr.prototype.compileNode = function(o) {
      var answer, compiledObjs, fragments, index, obj, objs, _i, _len;

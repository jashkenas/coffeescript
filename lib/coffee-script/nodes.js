...
(function() {
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.addAttrReader = function(props, name) {
      var code, value;
      value = new Value(new Literal('get' + name[1].toUpperCase() + name.slice(2, -1)));
      code = new Code;
      code.body.push(new Literal("this[" + name + "]"));
      code.body.makeReturn();
      return props.unshift(new Assign(value, code, null));
    };

    Class.prototype.addAttrWriter = function(props, name) {
      var code, value;
      value = new Value(new Literal('set' + name[1].toUpperCase() + name.slice(2, -1)));
    ...
    Class.prototype.addAttrProperty = function(type, name, props) {
      var code, value;
      value = new Value(new Literal(type + name[1].toUpperCase() + name.slice(2, -1)));
      code = new Code(type === 'set' ? [new Param(new Literal("value"))] : []);
      code.body.push(new Literal(type === 'set' ? "this[" + name + "] = value" : "this[" + name + "]"));
      code.body.makeReturn();
      return props.unshift(new Assign(value, code, null));
    };

    Class.prototype.addProperties = function(node, name, o) {
      var assign, base, exprs, func, prop, props;
      props = node.base.properties.slice(0);
      exprs = (function() {
        var _i, _j, _k, _len, _len1, _len2, _ref2, _ref3, _ref4, _results;
        _results = [];
          ...
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              if (assign.variable["this"]) {
                ...
                if (base.value === 'attr_reader' && func instanceof Value && func.isArray()) {
                  _ref2 = func.base.objects;
                  for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                    prop = _ref2[_i];
                    this.addAttrProperty('get', prop.base.value, props);
                  }
                } else if (base.value === 'attr_writer' && func instanceof Value && func.isArray()) {
                  _ref3 = func.base.objects;
                  for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
                    prop = _ref3[_j];
                    this.addAttrProperty('set', prop.base.value, props);
                  }
                } else if (base.value === 'attr_accessor' && func instanceof Value && func.isArray()) {
                  _ref4 = func.base.objects;
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (isValue = this.variable instanceof Value) {
        ...
        if (this.context === '.=') return this.compileObjectExtensionLiteral(o);
      }
    ...
    Assign.prototype.compileObjectExtensionLiteral = function(o) {
      var code, name, prop, _i, _len, _ref2;
      name = this.variable.compile(o, LEVEL_LIST);
      code = [];
      _ref2 = this.value.base.properties;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        prop = _ref2[_i];

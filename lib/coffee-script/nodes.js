...
(function() {
  ...
  exports.JsxElement = JsxElement = (function(superClass1) {
    ...
    function JsxElement(options) {
      var base1, base2;
      this.name = options.name, this.children_ = options.children, this.attributes = options.attributes;
    ...
    JsxElement.prototype.compileNode = function(o) {
      var compiledChildren, compiledListAttributes, compiledObjectAttributes, endTag, isString, ref3, ref4, startTag;
      ...
      startTag = [this.makeCode('<'), this.makeCode(this.name)].concat(slice.call(compiledListAttributes), slice.call(compiledObjectAttributes), [this.makeCode('>')]);

...
(function() {
  ...
  exports.CodeFragment = CodeFragment = (function() {
    ...
    CodeFragment.prototype.annotateCode = function() {
      var ref3;
      if (((ref3 = this.locationData) != null ? ref3.annotation : void 0) && !this.locationData.annotation.emitted) {
        this.locationData.annotation.emitted = true;
        if (this.locationData.annotation.type === "word") {
          return this.code = "/* " + this.locationData.annotation.text + " */ " + this.code;
        } else if (this.locationData.annotation.type === "line") {
          return this.code = "/* " + this.locationData.annotation.text + " */\n" + this.code;
        }
      }
    };
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.toString = function(idt, name) {
      var annotation, annotationString, ref3, tree;
      if (idt == null) {
        idt = '';
      }
      if (name == null) {
      ...
      if (annotation = (ref3 = this.locationData) != null ? ref3.annotation : void 0) {
  ...
  exports.Block = Block = (function(superClass1) {
    ...
    Block.prototype.compileRoot = function(o) {
      var exp, fragments, i, j, len1, n, name, prelude, preludeExps, ref3, ref4, rest;
      o.indent = o.bare ? '' : TAB;
      o.level = LEVEL_TOP;
      this.spaced = true;
      ...
      if (!o.bare) {
        preludeExps = (function() {
          ...
          for (i = k = 0, len2 = ref5.length; k < len2; i = ++k) {
            exp = ref5[i];
            if (!((n = exp.unwrap()) instanceof Comment && !n.isAnnotate())) {
              break;
            }
            results.push(exp);
          }
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      var assigns, declars, exp, fragments, i, j, len1, n, post, ref3, ref4, ref5, rest, scope, spaced;
      fragments = [];
      post = [];
      ref3 = this.expressions;
      for (i = j = 0, len1 = ref3.length; j < len1; i = ++j) {
        exp = ref3[i];
        exp = exp.unwrap();
        if (!(((n = exp) instanceof Comment && !n.isAnnotate()) || exp instanceof Literal)) {
          break;
        }
      }
      o = merge(o, {
  ...
  exports.Comment = Comment = (function(superClass1) {
    ...
    function Comment(comment1, _isAnnotate) {
      this.comment = comment1;
      this._isAnnotate = _isAnnotate;
    }
    ...
    Comment.prototype.isAnnotate = function() {
      return this._isAnnotate;
    };
  ...
  exports.Class = Class = (function(superClass1) {
    ...
    function Class(variable1, parent1, body1) {
      ...
      if ((ref3 = this.parent) != null ? (ref4 = ref3.locationData) != null ? ref4.annotation : void 0 : void 0) {
        console.log("aaa");
      }
      if (this.locationData) {
        console.log("bbb");
    ...
    Class.prototype.hoistDirectivePrologue = function() {
      ...
      while ((node = expressions[index]) && (node instanceof Comment && !node.isAnnotate()) || (node instanceof Value && node.isString())) {
        ++index;
      }
    ...
    Class.prototype.compileNode = function(o) {
      var args, argumentsNode, call, func, jumpNode, klass, lname, name, ref3, ref4, ref5, superClass;
      ...
      lname.locationData = this.locationData;
      if ((ref3 = this.variable) != null) {
        ref3.locationData = this.locationData;
      }
      if ((ref4 = this.body) != null) {
        ref4.locationData = this.locationData;
      }
      func = new Code([], Block.wrap([this.body]));
      func.locationData = this.locationData;
      args = [];
      ...
      (ref5 = this.body.expressions).unshift.apply(ref5, this.directives);
      call = new Call(func, args);
      call.locationData = this.locationData;
      klass = new Parens(call);
      if (this.variable) {
        this.variable.base.locationData = this.locationData;
        klass.locationData = this.locationData;
        klass = new Assign(this.variable, klass);
        this.variable.locationData = this.locationData;
        klass.locationData = this.locationData;
      }
      klass.locationData = this.locationData;

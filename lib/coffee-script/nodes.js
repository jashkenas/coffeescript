...
(function() {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, code, condition, exprs, haveSplatParam, i, ifTrue, j, k, len1, len2, param, paramNames, params, paramsAfterSplat, ref, ref3, ref4, ref5, ref6, ref7, splatParamName, val, wasEmpty;
      if (this.bound) {
      ...
      for (i = j = 0, len1 = ref4.length; j < len1; i = ++j) {
        ...
        if (param.splat || param instanceof Expansion) {
          ...
          if (!haveSplatParam) {
            ...
            if ((((ref6 = param.name) != null ? ref6.value : void 0) != null) && (param.name["this"] == null)) {
      ...
      if (exprs.length) {
        (ref7 = this.body.expressions).unshift.apply(ref7, exprs);
      }

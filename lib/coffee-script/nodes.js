...
(function() {
  ...
  UTILITIES = {
    async: function() {
      return "(function(){ var async = function(generator) { return function() { var args = arguments, self = this; return new Promise(function(win, fail){ var tracker = new Tracker(); tracker.iterator = generator.apply(self, args); tracker.win = win; tracker.fail = fail; tracker.tick(); }); }; }; function Tracker() { var self = this; this.thenHandle = function(value) { self.result = value; self.tick(); }; this.failHandle = function(value) { self.fail(value); }; this.send     = false; this.result   = undefined; this.iterator = undefined; this.win      = undefined; this.fail     = undefined; }; Tracker.prototype = { tick: function() { var next; if (this.send) { next = this.iterator.next(this.result); } else { next = this.iterator.next(); this.send = true; } if (next.done) { this.win(next.value); } else { next.value.then(this.thenHandle, this.failHandle); } } }; return async; }())";
    },
    "extends": function() {

...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, PartialApplication, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.PartialApplication = PartialApplication = (function(_super) {

    __extends(PartialApplication, _super);

    function PartialApplication(variable, args, soak) {
      this.variable = variable;
      this.args = args != null ? args : [];
      this.soak = soak;
    }

    PartialApplication.prototype.children = ['variable', 'args'];

    PartialApplication.prototype.unfoldSoak = function(o) {
      var call, ifn, left, list, rite, _i, _len, _ref2, _ref3;
      if (this.soak) {
        if (this.variable) {
          if (ifn = unfoldSoak(o, this, 'variable')) {
        ...
        rite = new PartialApplication(rite, this.args);
        rite.isNew = this.isNew;
        left = new Literal("typeof " + (left.compile(o)) + " === \"function\"");
        return new If(left, new Value(rite), {
          soak: true
      ...
      while (true) {
        ...
        list.push(call);
        if (!((call = call.variable.base) instanceof PartialApplication)) {
          break;
        }
      }
      _ref3 = list.reverse();
    ...
    PartialApplication.prototype.filterImplicitObjects = function(list) {
      var node, nodes, obj, prop, properties, _i, _j, _len, _len1, _ref2;
      nodes = [];
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        node = list[_i];
    ...
    PartialApplication.prototype.compileNode = function(o) {
      var arg, args, base, code, name, ref, _ref2;
      base = new Value(this.variable);
      name = base.properties[0];
      if (o.scope.expressions.classBody != null) {
        base.base.value = 'this';
      }
      ref = 'this';
      if (((_ref2 = o.scope.method) != null ? _ref2.klass : void 0) != null) {
      ...
      code = "function() {\n";
      code += ("" + this.tab + "  return ") + this.variable.compile(o, LEVEL_ACCESS) + (".apply(" + ref + ", [" + args + "].concat(" + (utility('slice')) + ".call(arguments)));\n");

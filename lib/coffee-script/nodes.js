    ...
    TameRequire.prototype.compileNode = function(o) {
      ...
      inc = (function() {
        switch (v) {
          case "inline":
          case "window":
            return InlineDeferral.generate(v === "window" ? v : null);
          case "node":

  ...
  exports.Code = Code = (function(superClass1) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      for (i = j = 0, len1 = ref4.length; j < len1; i = ++j) {
        ...
        if (param.splat || param instanceof Expansion) {
          ...
          if (!haveSplatParam) {
            ...
            exprs.push(new Assign(param.name, new Value(new IdentifierLiteral(splatParamName), [new Index(new Op('-', new Value(new IdentifierLiteral(splatParamName), [new Access(new PropertyName('length'))]), new NumberLiteral(this.params.length - i)))])));
            if (param.value) {
      ...
      if (paramsAfterSplat !== 0) {
        ...
        val = new Call(new Value(ref, [new Access(new PropertyName('slice'))]), [new NumberLiteral(0), new Op('-', new Value(new IdentifierLiteral(splatParamName), [new Access(new PropertyName('length'))]), new NumberLiteral(paramsAfterSplat))]);

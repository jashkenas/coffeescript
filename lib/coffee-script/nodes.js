...
(function() {
  ...
  exports.Code = Code = (function(_super) {
    ...
    function Code(params, body, tag) {
      ...
      this.bound = tag === 'boundfunc' || tag === 'boundprocedure';
      this.noReturn = tag === 'procedure' || tag === 'boundprocedure';
      if (this.bound) {
        this.context = '_this';
      }
    }
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, lit, name, p, param, params, ref, returnExpr, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;

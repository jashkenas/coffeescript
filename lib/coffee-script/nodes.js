(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileCps = function(o) {
      ...
      if ((l = this.tamePrequelBlocks.length)) {
        console.log("yo");
    ...
    Base.prototype.tamePrequelBlocks = [];
    ...
    Base.prototype.tameHasContinuation = function() {
      return !!this.tameContinuationBlock || this.tamePrequelBlocks.length;
    };
    ...
    Base.prototype.tameNestPrequelBlock = function(bb) {
      ...
      this.tamePrequelBlocks.push({
        block: bb,
        retval: rv
      });
      console.log("call done " + bb);
      console.log("len: " + this.tamePrequelBlocks.length + " " + (bb.toString()));
      return rv;
    };

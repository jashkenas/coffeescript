(function() {
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.tameCpsRotate = function() {
      ...
      if ((v = this.tameCpsExprRotate(this.variable))) return this.variable = v;
    };
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileTame = function(o, d) {
      var a1, a2, a3, a4, a5, b, body, condition, empty_arr, init, ival, key, key_lit, key_val, keys, keys_access, keys_len, keys_val, len, len_rhs, len_val, loop_body, loop_keys, loop_source, ref, ref_val, ref_val_copy, rvar, scope, source_access, step;
      if (!this.tameNodeFlag) return null;
      body = d.body;
      condition = null;
      init = [];

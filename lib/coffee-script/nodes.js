...
(function() {
  ...
  exports.PartialApplication = PartialApplication = (function(_super) {
    ...
    PartialApplication.prototype.compileNode = function(o) {
      ...
      return "(function() { return " + this.variable.compile(o, LEVEL_ACCESS) + (".apply(" + ref + ", [" + args + "].concat(" + (utility('slice')) + ".call(arguments))); })");
    };

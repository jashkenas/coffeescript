(function() {
  ...
  TameTailCall = (function(_super) {
    ...
    TameTailCall.prototype.compileNode = function(o) {
      var args, f, out;
      f = new Literal(this.func);
      out = o.level === LEVEL_TOP ? new Block([this.value, new Call(f)]) : (args = this.value ? [this.value] : [], new Call(f, args));
  ...
  TameReturnValue = (function(_super) {
    ...
    TameReturnValue.prototype.bindName = function(o) {
      var l;
      l = o.scope.freeVariable(tame["const"].param, false);

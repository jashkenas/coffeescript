(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.tameNeedsDummyContinuation = function() {
      ...
      if (!this.tameGotCpsSplitFlag) {
        rhs = this.tameHasAutocbFlag ? new Value(new Literal(tame["const"].autocb)) : new Code([], new Block([]));
        k_id = new Value(new Literal(tame["const"].k));
        return new Assign(k_id, rhs);
      }
    };
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.tameMarkAutocbs = function(found) {
      ...
      if (found && this.body.endsInAwait() && false) {
        this.body.push(new Return(null, true));
      }

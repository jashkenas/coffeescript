...
(function() {
    ...
    Block.prototype.makeReturn = function(res) {
      ...
      while (len--) {
        ...
        if (!(expr instanceof Comment)) {
          ...
          this.hasReturn = !(expr instanceof Return && !expr.expression);
          if (!this.hasReturn)  
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.compileStatement = function(o) {
      var body, child, cond, exeq, hasReturn, ifPart, oneline, unbody;
      ...
      oneline = body.expressions.length === 1 && !hasReturn && !this.elseBody && (unbody instanceof Assign || unbody instanceof Call || unbody instanceof Return);
      ifPart = "if (" + cond + ") ";
      ifPart += (oneline ? " \n" + (body.compile(o)) : "{\n" + (body.compile(o)) + " \n" + this.tab + "}");
      if (!child)  

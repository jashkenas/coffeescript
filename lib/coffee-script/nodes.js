...
(function() {
  ...
  exports.Assign = Assign = (function(superClass1) {
    ...
    Assign.prototype.compileSpecialMath = function(o) {
      var left, ref3, right, value;
      ref3 = this.variable.cacheReference(o), left = ref3[0], right = ref3[1];
      value = this.context === '//=' ? new Parens(this.value) : this.value;
      return new Assign(left, new Op(this.context.slice(0, -1), right, value)).compileToFragments(o);
    };

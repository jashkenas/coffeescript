...
(function() {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, code, exprs, haveSplatParam, i, j, k, len1, len2, lit, param, params, paramsAfterSplat, ref, ref3, ref4, ref5, splatParamName, uniqs, val, wasEmpty;
      if (this.bound) {
      ...
      for (i = j = 0, len1 = ref4.length; j < len1; i = ++j) {
        ...
        if (param.splat || param instanceof Expansion) {
          ...
          if (param.name.value != null) {
            ...
            exprs.push(new Assign(new Value(param.name), splatParamName, '=', {
              param: true
            }));
      ...
      if (exprs.length) {
        (ref5 = this.body.expressions).unshift.apply(ref5, exprs);
      }

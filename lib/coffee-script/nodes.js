(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.isCpsPivot = function() {
      return this.tameNodeFlag || (this.cpsNodeFlag && this.isJump());
    };
  ...
  exports.While = While = (function() {
    ...
    While.prototype.compileTame = function(o) {
      var block, break_assign, break_id, cond, continue_assign, continue_body, continue_id, inner_k_assign, inner_k_id, k_id, outStatements, top_assign, top_body, top_call, top_func, top_id;
      ...
      cond = new If(this.condition, this.body);

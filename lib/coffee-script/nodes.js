...
(function() {
  ...
  exports.JsxElement = JsxElement = (function(superClass1) {
    ...
    JsxElement.prototype.children = ['children'];

    function JsxElement(options) {
      this.name = options.name, this.children = options.children;
    }

    JsxElement.prototype.compileNode = function(o) {
      var child, compiledChildren, endTag, startTag;
      startTag = [this.makeCode('<'), this.makeCode(this.name), this.makeCode('>')];

...
(function() {
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.superReference = function(o) {
      ...
      } else if ((method != null) && (method.ctor || method.asyncCtor)) {
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.addProperties = function(node, name, o) {
      var assign, base, exprs, external, func, props;
  ...
  exports.Code = Code = (function(_super) {
    ...
    function Code(params, body, tag) {
      ...
      this.isGenerator = !!this.body.contains(function(node) {
        return node instanceof Op && node.isYield();
      });
      this.isAsync = !!this.body.contains(function(node) {
        return node instanceof Op && node.isAwait();
      });
      if (this.isAsync && this.isGenerator) {
        this.err("funtion can be a generator or async, but not both");
      }
    }

    Code.prototype.children = ['params', 'body'];

    Code.prototype.purify = function() {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, asyncify, boundfunc, code, exprs, i, lit, p, param, params, ref, splats, uniqs, val, wasEmpty, wrapper, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      ...
      asyncify = this.isAsync && this.wrap;
      code = '';
      if (asyncify) {
        code += (utility('async', o)) + "(";
      }
      code += 'function';
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.isAwait = function() {
      return this.originalOperator === 'await';
    };

    Op.prototype.isYield = function() {
      var _ref2;
      return (_ref2 = this.originalOperator) === 'yield' || _ref2 === 'yieldfrom';
    };
    ...
    Op.prototype.compileContinuation = function(o) {
      ...
      if (o.scope.parent == null) {
        this.error(this.originalOperator + " statements must occur within a function body.");
      }
  ...
  UTILITIES = {
    async: function() {
      return "(function(){ var async = function(generator) { return function() { var args = arguments, self = this; return new Promise(function(win, fail){ var tracker = new Tracker(); tracker.iterator = generator.apply(self, args); tracker.win = win; tracker.fail = fail; tracker.tick(); }); }; }; function Tracker() { var self = this; this.thenHandle = function(value) { self.result = value; self.tick(); }; this.failHandle = function(err) { self.result = err; self.throw = true; self.tick(); }; this.throw    = false; this.result   = undefined; this.iterator = undefined; this.win      = undefined; this.fail     = undefined; }; Tracker.prototype = { tick: function() { var next; if (this.throw) { next = this.iterator.throw(this.result); this.throw = false; } else { next = this.iterator.next(this.result); } if (next.done) { this.win(next.value); } else { next.value.then(this.thenHandle, this.failHandle); } } }; return async; }())";
    },
    "extends": function(o) {

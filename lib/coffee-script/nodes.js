...
(function() {
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      compileNode(o) {
        ...
        fragments = [];
        if (this instanceof SuperCall) {
          fragments.push(this.makeCode(this.superReference(o)), this.makeCode('('));
        } else {
          if (this.isNew) {
  ...
  exports.SuperCall = SuperCall = (function() {
    class SuperCall extends Call {
      ...
      compileNode(o) {
        ...
        superCall = new Literal(fragmentsToText(super.compileNode(...arguments)));
      ...
      superReference(o) {
        ...
        if (method != null ? method.ctor : void 0) {
          ...
          return (new Value(new Literal('super'), [nref != null ? new Index(nref) : name])).compile(o);
        } else {
  ...
  exports.ExecutableClassBody = ExecutableClassBody = (function() {
    class ExecutableClassBody extends Base {
      ...
      compileNode(o) {
        var args, argumentsNode, directives, externalCtor, ident, jumpNode, klass, params, ref3, wrapper;

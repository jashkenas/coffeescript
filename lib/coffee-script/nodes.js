...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, CompilerError, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, last, locationDataToString, merge, multident, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.superReference = function(o) {
      ...
      if (!method) {
        this.error('cannot call super outside of a function');
      }
      name = method.name;
      if (name == null) {
        this.error('cannot call super on an anonymous function');
      }
      if (method.klass) {
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.ensureConstructor = function(name) {
      ...
      return this.ctor.body.traverseChildren(false, function(node) {
        if (node instanceof Return && node.expression) {
          return node.expression.error("cannot return a value from a constructor");
        }
      });
    };
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, lit, p, param, params, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref2, _ref3, _ref4, _ref5, _ref6;
  ...
  exports.Try = Try = (function(_super) {
    ...
    Try.prototype.compileNode = function(o) {
      ...
      catchPart = this.recovery ? ((typeof (_base = this.errorVariable).isObject === "function" ? _base.isObject() : void 0) ? (placeholder = new Literal('_error'), this.recovery.unshift(new Assign(this.errorVariable, placeholder)), this.errorVariable = placeholder) : void 0, (_ref2 = this.errorVariable.value, __indexOf.call(STRICT_PROSCRIBED, _ref2) >= 0) ? this.errorVariable.error("catch variable may not be \"" + this.errorVariable.value + "\"") : void 0, !o.scope.check(this.errorVariable.value) ? o.scope.add(this.errorVariable.value, 'param') : void 0, " catch (" + (this.errorVariable.compile(o)) + ") {\n" + (this.recovery.compile(o, LEVEL_TOP)) + "\n" + this.tab + "}") : !(this.ensure || this.recovery) ? ' catch (_error) {}' : void 0;

...
(function() {
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.superReference = function(o) {
      ...
      } else if ((method != null ? method.ctor : void 0) || (method != null ? method.asynctor : void 0)) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    function Code(params, body, tag) {
      ...
      if (tag != null) {
        this.bound = tag.bound;
        this.async = tag.async;
      } else {
        this.bound = false;
        this.async = false;
      }
      this.isGenerator = this.async || !!this.body.contains(function(node) {
        var _ref2;
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (this.asynctor) {
        this.body.expressions.push(new Return(new Literal('this')));
      }
      ...
      code = this.async ? (utility('async', o)) + "(" : '';
      code += 'function';
      if (this.isGenerator) {
        code += '*';
      }
  ...
  UTILITIES = {
    ...
    async: function() {
      return "function (fn) { return function () { var gen = fn.apply(this, arguments); try { return resolved(); } catch (e) { return Promise.reject(e); } function resolved(res) { return next(gen.next(res)); } function rejected(err) { return next(gen.throw(err)); } function next(ret) { var val = ret.value; if (ret.done) { return Promise.resolve(val); } else try { return val.then(resolved, rejected); } catch (_) { throw new Error('Expected Promise/A+'); } } }; }";
    }
  };

...
(function() {
  ...
  exports.Yield = Yield = (function(_super) {
    ...
    Yield.prototype.children = ['expression'];

    Yield.prototype.compileNode = function(o) {
      return "yield" + [this.expression ? " " + (this.expression.compile(o, LEVEL_PAREN)) : void 0];
    };
  ...
  exports.YieldFrom = YieldFrom = (function(_super) {

    __extends(YieldFrom, _super);

    function YieldFrom(expr) {
      if (expr && !expr.unwrap().isUndefined) {
        this.expression = expr;
      }
    }

    YieldFrom.prototype.children = ['expression'];

    YieldFrom.prototype.compileNode = function(o) {
      var code, refvar, resvar, sendvar;
      sendvar = o.scope.freeVariable('send');
      resvar = o.scope.freeVariable('result');
      refvar = o.scope.freeVariable('ref');
      code = "var " + refvar + " = " + [this.expression ? " " + (this.expression.compile(o, LEVEL_PAREN)) : void 0] + ";\n";
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, isGenerator, lit, name, p, param, params, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      idt = o.indent;
      isGenerator = this.body.containsType(Yield);
      code = 'function';
      if (isGenerator) {
        code += '*';
      }
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      var assign, body, defPart, forPart, forVarPart, guardPart, idt1, index, ivar, kvar, kvarAssign, lastJumps, loopType, lvar, name, namePart, ref, resultPart, resultvar, returnResult, rvar, scope, source, stepPart, stepvar, svar, topPart, varPart, _ref2;
      ...
      ivar = ((this.object || this.generator) && index) || scope.freeVariable('i');
      ...
      if (this.range) {
        ...
        if (name && !this.pattern && !this.generator) {
          namePart = "" + name + " = " + svar + "[" + kvar + "]";
        }
        if (!(this.object || this.generator)) {
      ...
      if (this.pattern && !this.generator) {
      ...
      if (this.generator) {
        ...
        defPart += "" + this.tab + "var " + resultvar + " = {};\n";
        forPart = "!" + resultvar + ".done";
        assign = (new Assign(this.name, new Literal("" + resultvar + ".value"))).compile(o, LEVEL_TOP);
        topPart = "\n" + (this.tab + TAB) + resultvar + " = " + svar + ".next();\n" + (this.tab + TAB) + assign + ";";
      } else if (this.object) {
      ...
      return "" + defPart + (resultPart || '') + this.tab + loopType + " (" + forPart + ") {" + topPart + guardPart + varPart + body + this.tab + "}" + (returnResult || '');
    };

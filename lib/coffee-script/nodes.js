...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, ObjectAccessWithDefault, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref, _ref2,
  ...
  exports.ObjectAccessWithDefault = ObjectAccessWithDefault = (function(_super) {

    __extends(ObjectAccessWithDefault, _super);

    ObjectAccessWithDefault.name = 'ObjectAccessWithDefault';

    function ObjectAccessWithDefault(obj, key, _default) {
      this.obj = obj;
      this.key = key;
      this["default"] = _default;
    }

    ObjectAccessWithDefault.prototype.children = ['obj', 'key', 'default'];

    ObjectAccessWithDefault.prototype.compileNode = function(o) {
      var keyC, keyVar, objC, objVar, _ref3, _ref4;
      _ref3 = this.obj.cache(o, LEVEL_COND), objC = _ref3[0], objVar = _ref3[1];
      _ref4 = this.key.cache(o, LEVEL_OP), keyC = _ref4[0], keyVar = _ref4[1];
      return "" + keyC + " in " + objC + " ? " + objVar + "[" + keyVar + "] : " + (this["default"].compile(o, LEVEL_TOP));
    };

    ObjectAccessWithDefault.prototype.isComplex = function() {
      return this.obj.isComplex() || this.key.isComplex();
    };

    return ObjectAccessWithDefault;

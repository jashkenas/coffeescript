...
(function() {
  ...
  exports.Return = Return = (function(_super) {
    _extends(Return, _super);

    function Return(_expression) {
  ...
  exports.Comment = Comment = (function(_super) {
    ...
    Comment.prototype.compileNode = function(o, level) {
      ...
      code = "/*" + (multident(comment, this.tab)) + (_indexOf.call(comment, '\n') >= 0 ? "\n" + this.tab : '') + " */";
  ...
  exports.Call = Call = (function(_super) {
    _extends(Call, _super);

    function Call(variable, _args, _soak) {
      this.args = _args != null ? _args : [];
      this.soak = _soak;
      this.isNew = false;
  ...
  exports.Extends = Extends = (function(_super) {
    _extends(Extends, _super);

    function Extends(_child, _parent) {
      this.child = _child;
      this.parent = _parent;
    }
  ...
  exports.Access = Access = (function(_super) {
    _extends(Access, _super);

    function Access(_name, tag) {
      this.name = _name;
  ...
  exports.Range = Range = (function(_super) {
    _extends(Range, _super);

    Range.prototype.children = ['from', 'to'];

    function Range(_from, _to, tag) {
      this.from = _from;
      this.to = _to;
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    function Obj(props, _generated) {
      this.generated = _generated != null ? _generated : false;
  ...
  exports.Class = Class = (function(_super) {
    _extends(Class, _super);

    function Class(_variable, _parent, _body) {
      this.variable = _variable;
      this.parent = _parent;
      this.body = _body != null ? _body : new Block;
      this.boundFuncs = [];
    ...
    Class.prototype.determineName = function() {
      ...
      if (_indexOf.call(STRICT_PROSCRIBED, decl) >= 0) {
  ...
  exports.Assign = Assign = (function(_super) {
    _extends(Assign, _super);

    function Assign(_variable, _value, _context, options) {
      ...
      forbidden = (_ref2 = (name = this.variable.unwrapAll().value), _indexOf.call(STRICT_PROSCRIBED, _ref2) >= 0);
    ...
    Assign.prototype.isStatement = function(o) {
      return (o != null ? o.level : void 0) === LEVEL_TOP && (this.context != null) && _indexOf.call(this.context, "?") >= 0;
    };
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        ...
        if (_ref4 = obj.unwrap().value, _indexOf.call(RESERVED, _ref4) >= 0) {
      ...
      if (!IDENTIFIER.test(vvarText) || this.variable.assigns(vvarText)) {
        assigns.push([this.makeCode((ref = o.scope.freeVariable('ref')) + " = ")].concat(_slice.call(vvar)));
      ...
      for (i = _i = 0, _len = objects.length; _i < _len; i = ++_i) {
        ...
        if ((name != null) && _indexOf.call(RESERVED, name) >= 0) {
          obj.error("assignment to a reserved word: " + (obj.compile(o)));
        }
    ...
    Assign.prototype.compileConditional = function(o) {
      ...
      if (_indexOf.call(this.context, "?") >= 0) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      answer.push(this.makeCode('}'));
      if (this.ctor) {
        return [this.makeCode(this.tab)].concat(_slice.call(answer));
      }
  ...
  exports.Param = Param = (function(_super) {
    _extends(Param, _super);

    function Param(_name, _value, _splat) {
      var name, _ref2;
      this.name = _name;
      this.value = _value;
      this.splat = _splat;
      if (_ref2 = (name = this.name.unwrapAll().value), _indexOf.call(STRICT_PROSCRIBED, _ref2) >= 0) {
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.addBody = function(_body) {
      this.body = _body;
      return this;
    };
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.compileNode = function(o) {
      ...
      if (((_ref2 = this.operator) === '--' || _ref2 === '++') && (_ref3 = this.first.unwrapAll().value, _indexOf.call(STRICT_PROSCRIBED, _ref3) >= 0)) {
    ...
    Op.prototype.compileYield = function(o) {
      ...
      if (_indexOf.call(Object.keys(this.first), 'expression') >= 0) {
  ...
  exports.Try = Try = (function(_super) {
    ...
    function Try(_attempt, _errorVariable, _recovery, _ensure) {
  ...
  exports.Throw = Throw = (function(_super) {
    _extends(Throw, _super);

    function Throw(_expression) {
      this.expression = _expression;
    }
  ...
  exports.Existence = Existence = (function(_super) {
    _extends(Existence, _super);

    function Existence(_expression) {
      this.expression = _expression;
    }
  ...
  exports.Parens = Parens = (function(_super) {
    _extends(Parens, _super);

    function Parens(_body) {
      this.body = _body;
    }
  ...
  exports.Switch = Switch = (function(_super) {
    _extends(Switch, _super);

    function Switch(_subject, _cases, _otherwise) {
    ...
    Switch.prototype.compileNode = function(o) {
      ...
      if (this.otherwise && this.otherwise.expressions.length) {
        fragments.push.apply(fragments, [this.makeCode(idt1 + "default:\n")].concat(_slice.call(this.otherwise.compileToFragments(o, LEVEL_TOP)), [this.makeCode("\n")]));
      }
  ...
  exports.If = If = (function(_super) {
    ...
    function If(condition, _body, options) {
      this.body = _body;
      if (options == null) {
        options = {};
      }

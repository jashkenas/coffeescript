...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.matchJsxElement = function(opts) {
      var allowLeadingWhitespace, alreadyStarted, close, column, consumed, consumedWhitespace, content, contentLength, elementName, elementRegex, equals, expression, followsNewline, full, hasIndentedBody, index, line, match, matchedParenthesizedAttributes, nested, numOutdents, openingTag, popLevels, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, restOfLine;
      if (opts == null) {
        opts = {};
      }
      ...
      if (hasIndentedBody) {
        ...
        if (match) {
          ...
          ref3 = this.getLineAndColumnFromChunk(0), line = ref3[0], column = ref3[1];
        ...
        while (true) {
          ...
          if (match = JSX_ELEMENT_INLINE_CONTENT.exec(this.chunk)) {
            ...
            alreadyStarted = true;
            restOfLine = match[0];
            ref6 = this.getLineAndColumnFromChunk(0), line = ref6[0], column = ref6[1];
            ref7 = new Lexer().tokenize(restOfLine, {
              line: line,
              column: column,
              untilBalanced: true
            }), nested = ref7.tokens, index = ref7.index;
    ...
    Lexer.prototype.matchJsxParenthesizedAttributes = function() {
      var close, column, doubleQuotedStringValue, full, index, line, match, name, nested, postEqualsSpace, preEqualsSpace, ref2, ref3, ref4, ref5, singleQuotedStringValue, startExpressionValue, stringValue;

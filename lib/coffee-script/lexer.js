...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      } else if (tag === 'IDENTIFIER' && this.seenFor && id === 'from' && fromIsKeywordInForDeclaration(prev)) {
        tag = 'FORFROM';
        this.seenFor = false;
      }
  ...
  fromIsKeywordInForDeclaration = function(prev) {
    var ref2;

...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.matchJsxElement = function(opts) {
      var allowLeadingWhitespace, close, column, consumed, consumedWhitespace, content, contentLength, doubleQuotedStringValue, elementName, elementRegex, equals, expression, followsNewline, full, hasBody, hasIndentedBody, index, line, match, name, nested, numOutdents, openingTag, popLevels, postEqualsSpace, preEqualsSpace, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, restOfLine, singleQuotedStringValue, startExpressionValue, stringValue;
      if (opts == null) {
        opts = {};
      }
    ...
    Lexer.prototype.matchJsxElementIndentedExpression = function(arg) {
      var close, column, endOfExpressionOffset, followsNewline, index, line, match, nested, offsetOfNextOutdent, ref2, ref3, ref4, ref5, ref6, ref7, ref8, token;
      ...
      if (followsNewline && (match = JSX_ELEMENT_INDENTED_EQUALS_EXPRESSION_START.exec(this.chunk))) {
        ...
        if (((function() {
          ...
          for (j = 0, len = nested.length; j < len; j++) {
            token = nested[j];
            if ((ref4 = token[0]) === 'FOR' || ref4 === 'SWITCH' || ref4 === 'WHILE' || ref4 === 'UNTIL') {
              results.push(token);
            }
          }
          return results;
      ...
      if (match = JSX_ELEMENT_INDENTED_EXPRESSION_START.exec(this.chunk)) {
        ...
        if (((function() {
          var j, len, ref8, results;
          results = [];
          for (j = 0, len = nested.length; j < len; j++) {
            token = nested[j];
            if ((ref8 = token[0]) === 'FOR' || ref8 === 'SWITCH' || ref8 === 'WHILE' || ref8 === 'UNTIL') {
              results.push(token);
            }
          }
          return results;

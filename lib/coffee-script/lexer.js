  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      while (this.chunk = code.slice(i)) {
        consumed = this.identifierToken() || this.commentToken() || this.whitespaceToken() || this.lineToken() || this.stringToken() || this.symbolToken() || this.numberToken() || this.regexToken() || this.jsToken() || this.literalToken();
    ...
    Lexer.prototype.symbolToken = function() {
      var match, ref2, symbol;
      ref2 = /^:([_$\-a-zA-Z0-9]+)/.exec(this.chunk) || [], match = ref2[0], symbol = ref2[1];
      if (!symbol) {
        return 0;
      }
      this.token('STRING', "\"" + symbol + "\"", 0, match.length);
      return match.length;
    };

...
(function() {
  var BOM, BOOL, CALLABLE, CODE, COFFEE_ALIASES, COFFEE_ALIAS_MAP, COFFEE_KEYWORDS, COMMENT, COMPARE, COMPOUND_ASSIGN, HERECOMMENT_ILLEGAL, HEREDOC_DOUBLE, HEREDOC_INDENT, HEREDOC_SINGLE, HEREGEX, HEREGEX_OMIT, HERE_JSTOKEN, IDENTIFIER, INDENTABLE_CLOSERS, INDEXABLE, INVERSES, JSTOKEN, JSX_ELEMENT, JSX_ELEMENT_INDENTED_CONTENT_LINE, JSX_ELEMENT_INDENTED_EQUALS_EXPRESSION_START, JSX_ELEMENT_INLINE_CONTENT, JSX_ELEMENT_INLINE_EQUALS_EXPRESSION, JSX_ELEMENT_INLINE_EXPRESSION_START, JSX_ELEMENT_LEADING_WHITESPACE, JSX_PARENTHESIZED_ATTRIBUTE, JSX_PARENTHESIZED_ATTRIBUTES_END, JSX_PARENTHESIZED_ATTRIBUTES_START, JS_KEYWORDS, LEADING_BLANK_LINE, LINE_BREAK, LINE_CONTINUER, Lexer, MATH, MULTI_DENT, NOT_REGEX, NUMBER, OPERATOR, POSSIBLY_DIVISION, REGEX, REGEX_FLAGS, REGEX_ILLEGAL, REGEX_INVALID_ESCAPE, RELATION, RESERVED, Rewriter, SHIFT, SIMPLE_STRING_OMIT, STRICT_PROSCRIBED, STRING_DOUBLE, STRING_INVALID_ESCAPE, STRING_OMIT, STRING_SINGLE, STRING_START, TRAILING_BLANK_LINE, TRAILING_SPACES, UNARY, UNARY_MATH, UNICODE_CODE_POINT_ESCAPE, VALID_FLAGS, WHITESPACE, compact, count, invertLiterate, isForFrom, isUnassignable, key, locationDataToString, ref, ref1, repeat, starts, throwSyntaxError,
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.matchJsxElement = function(opts) {
      var allowLeadingWhitespace, close, column, consumed, content, contentLength, doubleQuotedStringValue, elementName, elementRegex, equals, expression, full, hasBody, hasIndentedBody, index, line, match, name, nested, numOutdents, openingTag, popLevels, postEqualsSpace, preEqualsSpace, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, restOfLine, singleQuotedStringValue, startExpressionValue, stringValue;
      if (opts == null) {
        opts = {};
      }
      allowLeadingWhitespace = opts.allowLeadingWhitespace;
      ...
      if (hasIndentedBody) {
        ...
        while (true) {
          popLevels = this.matchJsxElementIndentedChild().popLevels;
          if (popLevels) {
            return {
          ...
          if (!this.chunk || 'outdent' === this.lineToken({
            ...
            }), numOutdents = ref6.numOutdents, consumed = ref6.consumed;
        ...
        if (match) {
          ...
          ref7 = this.getLineAndColumnFromChunk(0), line = ref7[0], column = ref7[1];
          nested = new Lexer().tokenize(expression, {
            line: line,
            column: column
          });
          if (((ref8 = nested[1]) != null ? ref8[0] : void 0) === 'TERMINATOR') {
            nested.splice(1, 1);
          }
          (ref9 = this.tokens).push.apply(ref9, nested);
        ...
        while (true) {
          ...
          if (match = JSX_ELEMENT_INLINE_CONTENT.exec(this.chunk)) {
            ...
            hasBody = true;
            restOfLine = match[0];
            ref10 = this.getLineAndColumnFromChunk(0), line = ref10[0], column = ref10[1];
            ref11 = new Lexer().tokenize(restOfLine, {
              line: line,
              column: column,
              untilBalanced: true
            }), nested = ref11.tokens, index = ref11.index;
            if (((ref12 = nested[1]) != null ? ref12[0] : void 0) === 'TERMINATOR') {
              nested.splice(1, 1);
            }
            close = nested[nested.length - 1];
            close.origin = ['', 'end of inline expression', close[2]];
            (ref13 = this.tokens).push.apply(ref13, nested);
            this.consumeChunk(index);
          } else {
            break;
          }
    ...
    Lexer.prototype.matchJsxElementIndentedChild = function() {
      var ref2, ref3;
      return (ref2 = (ref3 = this.matchJsxElementIndentedExpression()) != null ? ref3 : this.matchJsxElement({
        allowLeadingWhitespace: true
      })) != null ? ref2 : this.matchJsxElementIndentedContentLine();
    };

    Lexer.prototype.matchJsxElementIndentedExpression = function() {
      var close, column, endOfExpressionOffset, lastToken, line, match, nested, offsetOfNextOutdent, ref2, ref3, ref4, ref5, ref6, token;
      offsetOfNextOutdent = (function(_this) {
        return function() {
          var match;
          match = RegExp("\\n" + ' ' + "{0," + _this.indent + "}\\S").exec(_this.chunk);
          if (!match) {
      ...
      ref2 = this.tokens, lastToken = ref2[ref2.length - 1];
      if ((ref3 = lastToken != null ? lastToken[0] : void 0) === 'TERMINATOR' || ref3 === 'INDENT' || ref3 === 'OUTDENT') {
        if (match = JSX_ELEMENT_INDENTED_EQUALS_EXPRESSION_START.exec(this.chunk)) {
          this.token('{', '=', 0, 0);
          this.consumeChunk('='.length);
          endOfExpressionOffset = offsetOfNextOutdent();
          ref4 = this.getLineAndColumnFromChunk(0), line = ref4[0], column = ref4[1];
          nested = new Lexer().tokenize(this.chunk.slice(0, endOfExpressionOffset), {
            line: line,
            column: column
          });
          if (((ref5 = nested[1]) != null ? ref5[0] : void 0) === 'TERMINATOR') {
            nested.splice(1, 1);
          }
          if (((function() {
            ...
            for (j = 0, len = nested.length; j < len; j++) {
              token = nested[j];
              if ((ref6 = token[0]) === 'FOR' || ref6 === 'SWITCH' || ref6 === 'WHILE' || ref6 === 'UNTIL') {
                results.push(token);
              }
            }
            return results;
          })()).length) {
            this.token('IDENTIFIER', 'FORCE_EXPRESSION', 0, 0);
            this.token('=', '=', 0, 0);
          }
          (ref6 = this.tokens).push.apply(ref6, nested);
    ...
    Lexer.prototype.matchJsxElementIndentedContentLine = function() {
      var content, match, ref2;
      ref2 = JSX_ELEMENT_INDENTED_CONTENT_LINE.exec(this.chunk), match = ref2[0], content = ref2[1];
      this.token('JSX_ELEMENT_CONTENT', content, 0, match.length);
    ...
    Lexer.prototype.lineToken = function(opts) {
      ...
      dry = opts.dry, returnNumOutdents = opts.returnNumOutdents;

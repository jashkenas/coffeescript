(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.bumpLine = function(label, delta) {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      while (this.chunk = code.slice(i)) {
        lexedCode = code.slice(0, i);
        this.tokenLine = count(lexedCode, '\n');
        this.tokenColumn = lexedCode.length - lexedCode.lastIndexOf('\n');
    ...
    Lexer.prototype.stringToken = function() {
      ...
      this.bumpLine("stringToken", count(string, '\n'));
    ...
    Lexer.prototype.heredocToken = function() {
      ...
      this.bumpLine("heredocToken", count(heredoc, '\n'));
    ...
    Lexer.prototype.commentToken = function() {
      ...
      this.bumpLine("commentToken", count(comment, '\n'));
    ...
    Lexer.prototype.regexToken = function() {
      ...
      if (match = HEREGEX.exec(this.chunk)) {
        ...
        this.bumpLine("regexToken", count(match[0], '\n'));
        return length;
      }
    ...
    Lexer.prototype.lineToken = function() {
      ...
      indent = match[0];
      this.bumpLine("lineToken", count(indent, '\n'));
      this.seenFor = false;
    ...
    Lexer.prototype.token = function(tag, value) {
      this.tokens.push([tag, value, this.tokenLine, this.tokenColumn]);

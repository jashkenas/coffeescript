  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      while (this.chunk = code.slice(i)) {
        consumed = this.identifierToken() || this.commentToken() || this.whitespaceToken() || this.lineToken() || this.stringToken() || this.numberToken() || this.regexToken() || this.jsToken() || this.ctToken() || this.literalToken();
    ...
    Lexer.prototype.stringToken = function() {
      ...
      regex = (function() {
        switch (quote) {
          ...
          case '<*>':
            return HERETAG_DOUBLE;
        }
      })();
      heredoc = quote.length === 3;
      ref2 = this.matchWithInterpolations(regex, quote), tokens = ref2.tokens, end = ref2.index;
      $ = tokens.length - 1;
      delimiter = quote.charAt(0) === '<' ? '"' : quote.charAt(0);
      if (heredoc) {
        indent = null;
        doc = ((function() {
          var j, len, results;
    ...
    Lexer.prototype.ctToken = function() {
      var ct, match;
      if (!(this.chunk.charAt(0) === '<' && (match = CTTOKEN.exec(this.chunk)))) {
        return 0;
      }
      this.token('CT', (ct = match[0]).slice(1, -1), 0, ct.length);
      return ct.length;
    };

  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      while (this.chunk = code.slice(i)) {
        consumed = this.identifierToken() || this.commentToken() || this.whitespaceToken() || this.lineToken() || this.stringToken() || this.numberToken() || this.regexToken() || this.jsToken() || this.csxToken() || this.literalToken();
    ...
    Lexer.prototype.csxToken = function() {
      var csx, full, match;
      if (!(this.chunk.charAt(0) === '<' && (match = CSXTOKEN.exec(this.chunk)))) {
        return 0;
      }
      full = match[0], csx = match[1];
      this.token('CSX', csx, 0, full.length);
      return full.length;
    };

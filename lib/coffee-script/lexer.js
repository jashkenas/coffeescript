...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      this.tokens = [];
      this.seenFor = false;
      this.tokens.push = (function(_this) {
        return function() {
          var args, firstToken, ref2;
          args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
          if (_this.annotation) {
            firstToken = args[0];
            firstToken[2].annotation = _this.annotation;
            _this.annotation = void 0;
          }
          return (ref2 = [].push).call.apply(ref2, [_this.tokens].concat(slice.call(args)));
        };
      })(this);
    ...
    Lexer.prototype.commentToken = function() {
      var annotate, comment, here, match;
      if (!(match = this.chunk.match(COMMENT))) {
        return 0;
      }
      comment = match[0], here = match[1], annotate = match[2];
      if (here) {
      ...
      if (annotate) {
        this.annotation = annotate.trim().slice(2, -1);
      }
    ...
    Lexer.prototype.token = function(tag, value, offsetInChunk, length, origin, originalToken) {
      var annotation, locationData, ref2, token;
      if (originalToken == null) {
        originalToken = void 0;
      }
      token = this.makeToken(tag, value, offsetInChunk, length);
      if (origin) {
        token.origin = origin;
      }
      if (annotation = this.annotation || (originalToken != null ? (ref2 = originalToken[2]) != null ? ref2.annotation : void 0 : void 0)) {
        locationData = token[token.length - 1];
        locationData.annotation = this.annotation;

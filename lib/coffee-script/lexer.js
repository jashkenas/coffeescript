...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
      ...
      switch (false) {
        ...
        default:
          ...
          this.mergeInterpolationTokens(tokens, {
            ...
            return function(str) {
              return _this.formatHeregex(str, {
                delimiter: '///'
              });
            };
          })(this));
    ...
    Lexer.prototype.formatHeregex = function(str, options) {
      return this.formatRegex(str.replace(HEREGEX_OMIT, '$1$2'), options);
    };
    ...
    Lexer.prototype.replaceUnicodeCodePointEscapes = function(str, options) {
      return str.replace(UNICODE_CODE_POINT_ESCAPE, (function(_this) {
        return function(match, before, codePointHex, offset) {
          var codePointDecimal, firstUnicodeEscape, lastUnicodeEscape, strippedHex, toUnicodeEscape;
          codePointDecimal = parseInt(codePointHex, 16);
          if (codePointDecimal > 1114111) {
            _this.error("Unicode code point escapes greater than 1114111 are not allowed", {
          ...
          lastUnicodeEscape = toUnicodeEscape(strippedHex.slice(-4));
          if (!(strippedHex.length > 4)) {
            return "" + before + lastUnicodeEscape;
          }
          firstUnicodeEscape = toUnicodeEscape(strippedHex.slice(0, strippedHex.length - 4));
          return "" + before + firstUnicodeEscape + lastUnicodeEscape;
        };
      })(this));
    };

...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      var colon, colonOffset, forcedIdentifier, id, idLength, input, match, poppedToken, prev, switchToken, tag, tagToken, _ref2, _ref3, _ref4, _ref5;
      ...
      if (!forcedIdentifier && (__indexOf.call(JS_KEYWORDS, id) >= 0 || __indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
        ...
        if (tag === 'WHEN' && (_ref3 = this.tag(), __indexOf.call(LINE_BREAK, _ref3) >= 0)) {
          tag = 'LEADING_WHEN';
          if (_ref4 = this.tag(1), __indexOf.call(FUNCTION_DECLARATIONS, _ref4) >= 0) {
            switchToken = ['SWITCH', 'switch', 0, 6];
            this.tokens.splice(this.tokens.length - 1, 0, switchToken);
          }
        } else if (tag === 'FOR') {
          this.seenFor = true;
        } else if (tag === 'UNLESS') {

  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      while (this.chunk = code.slice(i)) {
        consumed = this.moduleToken() || this.identifierToken() || this.commentToken() || this.whitespaceToken() || this.lineToken() || this.stringToken() || this.numberToken() || this.regexToken() || this.jsToken() || this.literalToken();
    ...
    Lexer.prototype.moduleToken = function() {
      var match, script;
      if (!(match = MODULETOKEN.exec(this.chunk))) {
        return 0;
      }
      this.token('JS', (script = match[0]), 0, script.length);
      return script.length;
    };

...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.matchJsxElement = function(opts) {
      var allowLeadingWhitespace, consumed, content, contentLength, elementName, elementRegex, hasIndentedBody, match, numOutdents, openingTag, popLevels, ref2, ref3;
      if (opts == null) {
        opts = {};
      }
      ...
      if (hasIndentedBody) {
        this.token('JSX_ELEMENT_INDENTED_BODY_START', '');
        ...
        content = ((ref3 = JSX_ELEMENT_INLINE_CONTENT.exec(this.chunk)) != null ? ref3 : [])[0];
        if (content) {

(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.stringToken = function() {
      var i, indentString, length, match, start, string, _ref2;
      length = 0;
      switch (this.chunk.charAt(0)) {
        ...
        case '<':
          ...
          start = 3;
          if (this.chunk[3].match(/\s/)) start = 4;
          string = this.getStringUntilLevel(this.chunk.substr(start));
          length = string.length + start;
          string = string.replace(RegExp("^" + indentString), '');

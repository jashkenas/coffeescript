...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      if (id === 'as' && (this.seenImport || this.seenExport) && ((ref2 = this.tokens[this.tokens.length - 1][0]) === 'IDENTIFIER' || ref2 === 'IMPORT_ALL')) {
        this.token('AS', id);
        return id.length;
      }
    ...
    Lexer.prototype.stringToken = function() {
      ...
      if (this.tokens.length && this.tokens[this.tokens.length - 1][1] === 'from' && (this.seenImport || this.seenExport)) {
    ...
    Lexer.prototype.literalToken = function() {
      ...
      if (value === ';') {
        ...
        tag = 'TERMINATOR';
      } else if (value === '*' && (this.seenImport || this.seenExport) && this.indent === 0) {
        tag = 'IMPORT_ALL';

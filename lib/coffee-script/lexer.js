...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.matchJsxElement = function(opts) {
      var allowLeadingWhitespace, close, column, consumed, content, contentLength, doubleQuotedStringValue, elementName, elementRegex, full, hasIndentedBody, index, line, match, name, nested, numOutdents, openingTag, popLevels, postEqualsSpace, preEqualsSpace, ref2, ref3, ref4, ref5, ref6, ref7, singleQuotedStringValue, startExpressionValue, stringValue;
      if (opts == null) {
        opts = {};
      }
      ...
      if (hasIndentedBody) {
        ...
        content = ((ref7 = JSX_ELEMENT_INLINE_CONTENT.exec(this.chunk)) != null ? ref7 : [])[0];
        if (content) {

...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      if (tag === 'IDENTIFIER') {
        if (this.seenFor && id === 'from') {
          tag = 'FORFROM';
          this.seenFor = false;
        } else if ((indexOf.call(JS_KEYWORDS, id) >= 0 || indexOf.call(COFFEE_KEYWORDS, id) >= 0) && !(this.exportSpecifierList && indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
          tag = id.toUpperCase();

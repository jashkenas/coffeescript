...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tagGenerator = function() {
      var stack, tok, tokens, _i;
      stack = [];
      tokens = this.tokens;
      for (_i = tokens.length - 1; _i >= 0; _i += -1) {
        tok = tokens[_i];
        switch (tok[0]) {
          case '->':
          case 'GENERATOR':
            ...
            return this;
          case '=>':
          case 'BOUND_GENERATOR':
            tok[0] = 'BOUND_GENERATOR';
            return this;
        }
      }
      this.error('yield operations must occur within a generator function.');
      return this;
    };

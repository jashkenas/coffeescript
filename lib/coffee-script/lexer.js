...
(function() {
  var BOM, BOOL, CALLABLE, CODE, COFFEE_ALIASES, COFFEE_ALIAS_MAP, COFFEE_KEYWORDS, COMMENT, COMPARE, COMPOUND_ASSIGN, HEREDOC, HEREDOC_ILLEGAL, HEREDOC_INDENT, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, INVERSES, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_BREAK, LINE_CONTINUER, LOGIC, Lexer, MATH, MULTILINER, MULTI_DENT, NOT_REGEX, NOT_SPACED_REGEX, NUMBER, OPERATOR, REGEX, RELATION, RESERVED, Rewriter, SHIFT, SIMPLESTR, STRICT_PROSCRIBED, SYMBOLSTR, TRAILING_SPACES, UNARY, WHITESPACE, compact, count, invertLiterate, key, last, locationDataToString, starts, throwSyntaxError, _ref, _ref1,
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.stringToken = function() {
      var lexedLength, match, octalEsc, string, symbol;
      lexedLength = null;
      switch (this.chunk.charAt(0)) {
        ...
        case ':':
          ...
          symbol = match[0];
          string = "'" + symbol.slice(1) + "'";
          lexedLength = symbol.length;
          this.token('STRING', string, 0, lexedLength);
          break;
        default:
          return 0;
      }
      ...
      return lexedLength != null ? lexedLength : string.length;
    };

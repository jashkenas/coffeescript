...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, historyFile, merge, nodeREPL, path, prettyErrorMessage, replDefaults, vm, _ref;
  ...
  historyFile = process.env.HOME ? path.join(process.env.HOME, '.coffee_history') : '';

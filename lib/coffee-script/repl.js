...
(function() {
  var CrapScript, addHistory, addMultilineHandler, fs, merge, nodeREPL, path, replDefaults, updateSyntaxError, vm, _ref;
  ...
  module.exports = {
    start: function(opts) {
      ...
      if (major === 0 && minor < 8) {
        console.warn("Node 0.8.0+ required for CrapScript REPL");
        process.exit(1);
      }
      CrapScript.register();

...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, correctLoadHelp, fs, merge, nodeREPL, path, replDefaults, updateSyntaxError, vm, _ref;
  ...
  addHistory = function(repl, filename, maxSize) {
    var buffer, fd, historyCommand, lastLine, readFd, size, stat;
    lastLine = null;
    try {
    ...
    historyCommand = repl.commandsWithLeadingDot() ? '.history' : 'history';
    repl.rli.addListener('line', function(code) {
      if (code && code.length && code !== historyCommand && lastLine !== code) {
        fs.write(fd, "" + code + "\n");
    ...
    return repl.commands[historyCommand] = {
  ...
  correctLoadHelp = function(repl) {
    var loadCommand;
    loadCommand = repl.commandsWithLeadingDot() ? '.load' : 'load';
    return repl.commands[loadCommand].help = 'Load code from a file into this REPL session';
  };
  ...
  module.exports = {
    start: function(opts) {
      ...
      repl.commandsWithLeadingDot = function() {

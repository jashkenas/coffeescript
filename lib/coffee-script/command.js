...
(function() {
  ...
  ADD_GLOBAL_PATHS = "process.env.NODE_PATH = (process.env.NODE_PATH || '') + require('path').delimiter + require('path').resolve(process.execPath, '..', '..', 'lib', 'node_modules'); require('module')._initPaths();";

  makePrelude = function(requires) {
    return ADD_GLOBAL_PATHS + requires.map(function(module) {
      var _, match, name;

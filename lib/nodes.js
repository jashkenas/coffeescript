(function() {
  ...
  exports.For = For = (function() {
    ...
    function For(body, source) {
      var _ref, _ref2;
      this.source = source.source, this.guard = source.guard, this.step = source.step, this.name = source.name, this.indexes = source.indexes;
      this.index = this.indexes && this.indexes[this.indexes.length - 1];
      ...
      if (((_ref2 = this.indexes) != null ? _ref2.length : void 0) > 1 && this.object) {
        throw SyntaxError('no multidimensionality for objects');
      }
      this.returns = false;
    }
    ...
    For.prototype.compileNode = function(o) {
      var body, defPart, forPart, guardPart, idt1, index, ivar, lastJumps, lvar, name, namePart, outername, ref, resultPart, returnResult, rvar, scope, source, stepPart, svar, varPart, _ref, _ref2;
      if (((_ref = this.indexes) != null ? _ref.length : void 0) > 1) {
        outername = new Literal(o.scope.freeVariable('ref'));
        this.body = new For(this.body, {
          source: outername,
          guard: this.guard,
          step: this.step,
          name: this.name,
          indexes: this.indexes.slice(0, -1)
        });
        this.name = outername;
      }

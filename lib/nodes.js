(function() {
  ...
  exports.Slice = Slice = function() {
    ...
    Slice.prototype.compileNode = function(o) {
      var definition, from, ref, to, _ref;
      from = this.range.from ? this.range.from.compile(o) : '0';
      if (this.range.to && +this.range.to.unwrap().value !== -1) {
        to = ', ' + (this.range.exclusive ? this.range.to.compile(o) : !this.range.to.isComplex() ? new Literal(+this.range.to.unwrap().value + 1).compile(o) : ((_ref = this.range.to.cache(o), definition = _ref[0], ref = _ref[1], _ref), '(' + definition.compile(o, LEVEL_PAREN) + ' + 1) ? ' + ref.compile(o) + ' : 1/0'));
      }

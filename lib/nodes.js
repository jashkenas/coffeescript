(function() {
  ...
  exports.For = For = (function() {
    ...
    function For(body, source) {
      var indexes, _ref;
      this.source = source.source, this.guard = source.guard, this.step = source.step, this.name = source.name, indexes = source.indexes;
      this.index = indexes ? indexes[0] : void 0;

(function(){
  ...
  exports.CallNode = (function() {
    CallNode = function(variable, args) {
      ...
      this.args = (args || []);
      this.compile_splat_arguments = function(o) {
        return SplatNode.compile_mixed_array.call(this, this.args, o);
      };
      return this;
    };
  ...
  exports.ArrayNode = (function() {
    ArrayNode = function(objects) {
      ...
      this.compile_splat_literal = function(o) {
        return SplatNode.compile_mixed_array.call(this, this.objects, o);
      };
      return this;
    };
  ...
  exports.CodeNode = (function() {
    ...
    CodeNode.prototype.compile_node = function(o) {
      var _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, code, func, i, inner, param, params, shared_scope, splat, top;

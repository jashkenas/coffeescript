(function() {
  ...
  wrapDefaulted = function(o, undefaulted, standard) {
    var assignment, condition, conditional, ref, _ref;
    _ref = undefaulted.cache(o), assignment = _ref[0], ref = _ref[1];
  ...
  exports.Value = Value = (function() {
    ...
    function Value(base, props, tag, options) {
      if (!props && base instanceof Value) {
        if ((options != null ? options["default"] : void 0) != null) {
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (this["default"] != null) {
        val = "" + name + " !== null ? " + val + " : " + (this["default"].compile(o));
      }
      if (this.context === 'object') {
        return "" + name + ": " + val;
      }
      if (!this.variable.isAssignable()) {
        throw SyntaxError("\"" + (this.variable.compile(o)) + "\" (a " + (typeof this.variable) + ") cannot be assigned.");
      }
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      var acc, assigns, code, i, idx, isObject, ivar, obj, objects, olen, origobj, ref, rest, splat, top, val, value, vvar, _len, _ref, _ref2, _ref3, _ref4;
      top = o.level === LEVEL_TOP;
      value = this.value;
      ...
      for (i = 0, _len = objects.length; i < _len; i++) {
        ...
        idx = i;
        if (isObject) {
          if (obj instanceof Assign && !(obj.value != null)) {
            obj = obj.variable;
          }
          origobj = obj;
          if (obj instanceof Assign) {
        ...
        if (!splat && obj instanceof Splat) {
          ...
          if ((origobj != null ? origobj["default"] : void 0) != null) {
  ...
  exports.Op = Op = (function() {
    ...
    __extends(Op, Base);
    function Op(op, first, second, flip, dontConvert) {
      var call;
      if (op === 'in') {
      ...
      this.operator = dontConvert ? op : CONVERSIONS[op] || op;
      this.first = first;
      this.second = second;
      this.flip = !!flip;
      return this;

(function() {
  ...
  exports.Value = Value = (function() {
    ...
    Value.prototype.compileNode = function(o) {
      ...
      if ((this.base instanceof Parens || props.length) && SIMPLENUM.test(code)) code = "" + code + ".";
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.superReference = function(o) {
      ...
      name = method.name;
      if (name == null) throw SyntaxError('cannot call super on an anonymous function.');
      if (method.klass) {
    ...
    Call.prototype.compileNode = function(o) {
      ...
      if (code = Splat.compileSplattedArray(o, this.args, true)) return this.compileSplat(o, code);
    ...
    Call.prototype.compileSplat = function(o, splatArgs) {
      ...
      if (this.isSuper) return "" + (this.superReference(o)) + ".apply(this, " + splatArgs + ")";
      if (this.isNew) {
        idt = this.tab + TAB;
  ...
  exports.Class = Class = (function() {
        ...
        while (assign = props.shift()) {
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              if (func.bound) throw new Error('cannot define a constructor as a bound function');
    ...
    Class.prototype.compileNode = function(o) {
      ...
      if (this.parent) this.body.expressions.unshift(new Extends(lname, this.parent));
  ...
  exports.Code = Code = (function() {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (exprs.length) (_ref5 = this.body.expressions).unshift.apply(_ref5, exprs);
      if (!splats) {
      ...
      code += '(' + vars.join(', ') + ') {';
      if (!this.body.isEmpty()) code += "\n" + (this.body.compileWithDeclarations(o)) + "\n" + this.tab;
      code += '}';
      if (this.ctor) return this.tab + code;
      if (this.bound) return utility('bind') + ("(" + code + ", " + this.context + ")");
    ...
    Code.prototype.traverseChildren = function(crossScope, func) {
      if (crossScope) return Code.__super__.traverseChildren.call(this, crossScope, func);
    };
    return Code;
  })();
  ...
  exports.Splat = Splat = (function() {
    ...
    Splat.compileSplattedArray = function(o, list, apply) {
      ...
      if (index === 0) return args[0] + (".concat(" + (args.slice(1).join(', ')) + ")");
      base = (function() {
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.compileNode = function(o) {
      ...
      if (this.isChainable() && this.first.isChainable()) return this.compileChain(o);
  ...
  exports.For = For = (function() {
    ...
    For.prototype.compileNode = function(o) {
      ...
      if (this.range) {
        ...
        if (name && !this.pattern) namePart = "" + name + " = " + svar + "[" + ivar + "]";
        if (!this.object) {

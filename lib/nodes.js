(function() {
  ...
  exports.Param = Param = (function() {
    ...
    Param.prototype.checkUnique = function(o) {
      var name, _i, _len, _ref2, _results;
      _ref2 = this.collectNames();
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        name = _ref2[_i];
        if (o.uniqs.hasOwnProperty(name)) {
          throw SyntaxError("parameter names must be unique; a parameter '" + name + "' already exists.");
        }
        _results.push(o.uniqs[name] = true);
      }
      return _results;
    };
    Param.prototype.collectNames = function(node) {
      var names, obj, _i, _len, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (node == null) {
        node = this.name;
      }
      names = [];
      if (!node.objects) {
        if ((_ref2 = node.properties) != null ? _ref2.length : void 0) {
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        } else if ((_ref4 = obj.base) != null ? (_ref5 = _ref4.objects) != null ? _ref5.length : void 0 : void 0) {
          names = names.concat(this.collectNames(obj.base));
        } else if (!((_ref6 = obj.properties) != null ? _ref6.length : void 0)) {

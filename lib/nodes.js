(function() {
  ...
  exports.For = For = function() {
    ...
    For.prototype.compileNode = function(o) {
      var body, defPart, forPart, guardPart, hasPure, hasPureLast, idt1, index, ivar, lvar, name, namePart, ref, resultPart, returnResult, rvar, scope, source, stepPart, svar, varPart, _ref;
      body = Expressions.wrap([this.body]);
      hasPure = body.containsPureStatement();
      hasPureLast = (_ref = last(body.expressions)) != null ? _ref.containsPureStatement() : void 0;

(function() {
  ...
  exports.Slice = Slice = function() {
    ...
    Slice.prototype.compileNode = function(o) {
      var compiled, definition, from, fromStr, ref, reference, to, toStr, _ref, _ref2;
      ...
      if (to && !(!this.range.exclusive && +compiled === -1)) {
        toStr = ', ' + (this.range.exclusive ? to.compile(o) : /^[+-]?\d+$/.test(compiled) ? '' + (+compiled + 1) : ((_ref2 = (function() {
          var _i, _len, _ref, _results;
          _ref = to.cache(o);
          _results = [];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ref = _ref[_i];
            _results.push(ref.compile(o, LEVEL_PAREN));
          }
          return _results;
        }()), definition = _ref2[0], reference = _ref2[1], _ref2), reference === definition ? reference + ' + 1 ? ' + reference + ' + 1 : 9e9' : '(' + definition + ' + 1) ? ' + reference + ' : 9e9'));
      }

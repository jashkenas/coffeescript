(function() {
  ...
  exports.For = For = function() {
    ...
    For.prototype.compileNode = function(o) {
      var body, defPart, forPart, guardPart, hasPure, idt1, index, ivar, lvar, name, namePart, ref, resultPart, returnResult, rvar, scope, source, stepPart, svar, varPart, _ref;
      ...
      defPart = '';
      idt1 = this.tab + TAB;
      if (this.scoped && this.containsPureStatement()) {

    ...
    while (true) {
        ...
        switch (action[0]) {
            ...
            case 2: // reduce
                ...
                lstacklen=lstack.length;

                // perform semantic action
                yyval.$ = vstack[vstack.length-len]; // default to $$ = $1
                // default location, uses first token for firsts, last for lasts
                yyval._$ = {
                    first_line: lstack[lstacklen-(len||1)].first_line,
                    last_line: lstack[lstacklen-1].last_line,
                    first_column: lstack[lstacklen-(len||1)].first_column,
                    last_column: lstack[lstacklen-1].last_column
                };
                ...
                if (len) {
                    lenm = -1*len;
                    stack = stack.slice(0,lenm<<1);
                    vstack = vstack.slice(0, lenm);
                    lstack = lstack.slice(0, lenm);
                }
                ...
                newState = table[stack[stacklen-2]][stack[stacklen-1]];
                stack.push(newState);
                break;

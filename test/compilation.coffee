...
test "--import-helpers", ->
  # in bare mode with "--import-helpers", the "modulo" helper should be a reference,
  # therefore no 'function' keywords should exist in the output
  eq -1, CoffeeScript.compile('5 %% 3', importHelpers: on, bare: on).indexOf 'function'
  ok 2 is CoffeeScript.eval '5 %% 3', importHelpers: on, bare: on, filename: 'test'

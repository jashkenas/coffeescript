...
test "header is disabled by options.generated", ->
  header = "// Generated by CoffeeScript #{CoffeeScript.VERSION}\n"
  eq -1, CoffeeScript.compile('x = y', generated: true).indexOf header

test "header is customizable", ->
  header = "Custom header, compiled with CoffeeScript"
  formatter = (js, version) -> "// #{header} #{version}\n#{js}"
  compiled = CoffeeScript.compile('x = y', generated: formatter)
  eq (3 + header.length + 1), compiled.indexOf CoffeeScript.VERSION

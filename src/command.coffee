...
SWITCHES = [
  ...
  [null, '--nodejsmap',       'add the entry point for node.js sourcemap']
  ...
  try
    ...
    if o.tokens
      ...
      if o.print
        ...
        writeJs base, t.file, t.output, options.jsPath, t.sourceMap, t.sourceNodejsMap
  catch err
...
writeJs = (base, sourcePath, js, jsPath, generatedSourceMap = null, generatedNodeSourceMap = null) ->
  ...
  compile = ->
    if opts.compile
      ...
      if generatedNodeSourceMap then js = "//# sourceMappingURL=#{helpers.baseFileName sourceMapPath, no, useWinPathSep}\nrequire('source-map-support').install();\n#{js}\n"

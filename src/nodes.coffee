...
exports.TaggedTemplateCall = class TaggedTemplateCall extends Call
  constructor: (variable, arg, soak) ->
    ...
    #TODO: We convert a StringLiteral into a StringWithInterpolations form (as generated by grammer). Nicer way to do this?

    interpolatedString = if arg instanceof StringLiteral
      new StringWithInterpolations Block.wrap([ new Value arg ])
    else
      arg

    super variable, [ interpolatedString ], soak
